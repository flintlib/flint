...
looper:
    ...
    if (delta_org != 0)
    {
        ...
        fmpz_mpoly_pow_si(u, v, delta_org, ctx);
                                                    ...
                                                    const fmpz_mpoly_ctx_t ctx)
{
    ...
    fmpz_mpoly_pow_si(s, polyQ->coeffs + 0, polyP->exps[0] - polyQ->exps[0], ctx);
...
looper:
    ...
    if (d - e > 1)
    {
        fmpz_mpoly_pow_si(u, B->coeffs + 0, d - e - 1, ctx);
        fmpz_mpoly_pow_si(v, s, d - e - 1, ctx);

...
*/
void _fmpz_mpoly_emplacebackterm_fmpz_fmpz(fmpz_mpoly_t poly,
...
void fmpz_mpoly_pushterm_fmpz_fmpz(fmpz_mpoly_t poly,
                const fmpz_t c, fmpz * const * exp, const fmpz_mpoly_ctx_t ctx)
{
    fmpz_t C;
    fmpz_init_set(C, c);
    _fmpz_mpoly_emplacebackterm_fmpz_fmpz(poly, C, exp, ctx);    
}

void fmpz_mpoly_pushterm_ui_fmpz(fmpz_mpoly_t poly,
...
void fmpz_mpoly_pushterm_si_fmpz(fmpz_mpoly_t poly,

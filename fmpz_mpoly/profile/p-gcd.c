...
int main(int argc, char *argv[])
{
    ...
    if (strcmp(name, "dense2") == 0)
    {
        ...
        fmpz_mpoly_set_str_pretty(a, "1+x+2*y+x*y", vars, ctx);
        fmpz_mpoly_set_str_pretty(b, "1+x+y+2*x*y", vars, ctx);
        ...
        flint_printf("starting dense2 gcd (%wu, %wd), (%wd, %wd):\n", m1, n1, m2, n2);
    ...
    else if (strcmp(name, "semisparse2") == 0)
    {
        ...
        fmpz_mpoly_set_str_pretty(a, "1+x+2*y", vars, ctx);
        fmpz_mpoly_set_str_pretty(b, "1+x+y", vars, ctx);
        fmpz_mpoly_pow_ui(A, a, m1, ctx);
        fmpz_mpoly_pow_ui(t, b, n1, ctx);
        fmpz_mpoly_mul(A, A, t, ctx);
        fmpz_mpoly_pow_ui(B, a, m2, ctx);
        ...
        flint_printf("starting semisparse2 gcd (%wu, %wd), (%wd, %wd):\n", m1, n1, m2, n2);
        profile_gcd(G, A, B, ctx, max_threads);
    ...
    else if (strcmp(name, "dense3") == 0)
    {
        ...
        flint_printf("starting dense3 gcd (%wu, %wd), (%wd, %wd):\n", m1, n1, m2, n2);
        profile_gcd(G, A, B, ctx, max_threads);
    ...
    else if (strcmp(name, "semisparse3") == 0)
    {
        ...
        fmpz_mpoly_set_str_pretty(a, "1 + 2*x + 3*y - z", vars, ctx);
        fmpz_mpoly_set_str_pretty(b, "1 + x + y + z", vars, ctx);
        fmpz_mpoly_pow_ui(A, a, m1, ctx);
        fmpz_mpoly_pow_ui(t, b, n1, ctx);
        fmpz_mpoly_mul(A, A, t, ctx);
        fmpz_mpoly_pow_ui(B, a, m2, ctx);
        ...
        flint_printf("starting semisparse3 gcd (%wu, %wd), (%wd, %wd):\n", m1, n1, m2, n2);
        profile_gcd(G, A, B, ctx, max_threads);
    ...
    else if (strcmp(name, "semisparse5") == 0)
    {
        ...
        fmpz_mpoly_set_str_pretty(a, "1 + 2*x + 3*y - z - 2*t - 3*u", vars, ctx);
        fmpz_mpoly_set_str_pretty(b, "1 + x + y + z + t + u", vars, ctx);
        fmpz_mpoly_pow_ui(A, a, m1, ctx);
        fmpz_mpoly_pow_ui(t, b, n1, ctx);
        fmpz_mpoly_mul(A, A, t, ctx);
        fmpz_mpoly_pow_ui(B, a, m2, ctx);
        ...
        flint_printf("starting semisparse5 gcd (%wu, %wd), (%wd, %wd):\n", m1, n1, m2, n2);
        profile_gcd(G, A, B, ctx, max_threads);
    ...
    else if (strcmp(name, "boldsparse4") == 0)
    {
        ...
        fmpz_mpoly_set_str_pretty(a, "1 + x + y^2 + z^3 + t^4", vars, ctx);
        fmpz_mpoly_set_str_pretty(b, "1 + x^4 + y^3 + z^2 + t", vars, ctx);
        fmpz_mpoly_pow_ui(A, a, m1, ctx);
        fmpz_mpoly_pow_ui(t, b, n1, ctx);
        fmpz_mpoly_mul(A, A, t, ctx);
        fmpz_mpoly_pow_ui(B, a, m2, ctx);
        ...
        flint_printf("starting boldsparse4 gcd (%wu, %wd), (%wd, %wd):\n", m1, n1, m2, n2);
        profile_gcd(G, A, B, ctx, max_threads);
    ...
    else if (strcmp(name, "sparse3") == 0)
    {
        ...
        fmpz_mpoly_set_str_pretty(a, "1 + x^2 + y^20 + z^33", vars, ctx);
        fmpz_mpoly_set_str_pretty(b, "1 + x^21 + y^11 + z^7", vars, ctx);
        fmpz_mpoly_pow_ui(A, a, m1, ctx);
        fmpz_mpoly_pow_ui(t, b, n1, ctx);
        fmpz_mpoly_mul(A, A, t, ctx);
        fmpz_mpoly_pow_ui(B, a, m2, ctx);
        ...
        flint_printf("starting sparse3 gcd (%wu, %wd), (%wd, %wd):\n", m1, n1, m2, n2);
        profile_gcd(G, A, B, ctx, max_threads);
    ...
    else if (strcmp(name, "boldsparse5") == 0)
    {
        ...
        fmpz_mpoly_set_str_pretty(a, "1 + x^1 + y^2 + z^3 + t^4 + u^5", vars, ctx);
        fmpz_mpoly_set_str_pretty(b, "1 + x^5 + y^2 + z^3 + t^2 + u^1", vars, ctx);
        fmpz_mpoly_pow_ui(A, a, m1, ctx);
        fmpz_mpoly_pow_ui(t, b, n1, ctx);
        fmpz_mpoly_mul(A, A, t, ctx);
        fmpz_mpoly_pow_ui(B, a, m2, ctx);
        ...
        flint_printf("starting boldsparse5 gcd (%wu, %wd), (%wd, %wd):\n", m1, n1, m2, n2);
        profile_gcd(G, A, B, ctx, max_threads);
    ...
    else
    {
        ...
        fmpz_mpoly_set_str_pretty(a, "1+x^1+y^2+z^6+t^4+u^9", vars, ctx);
        fmpz_mpoly_set_str_pretty(b, "1+x^9+y^4+z^3+t^7+u^1", vars, ctx);
        fmpz_mpoly_pow_ui(A, a, m1, ctx);
        fmpz_mpoly_pow_ui(t, b, n1, ctx);
        fmpz_mpoly_mul(A, A, t, ctx);
        fmpz_mpoly_pow_ui(B, a, m2, ctx);
        ...
        flint_printf("starting sparse gcd (%wu, %wd), (%wd, %wd):\n", m1, n1, m2, n2);
        profile_gcd(G, A, B, ctx, max_threads);

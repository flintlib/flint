...
slong _fmpz_mpoly_quasidivrem_heapV1(fmpz_t scale, slong * lenr,
...
void fmpz_mpoly_quasidivrem_heapV1(fmpz_t scale, fmpz_mpoly_t q, fmpz_mpoly_t r,
                                                    ...
                                                    const fmpz_mpoly_ctx_t ctx)
{
   ...
   while ((lenq = _fmpz_mpoly_quasidivrem_heapV1(scale, &lenr, &tq->coeffs, &tq->exps,

...
FLINT_DLL void fq_nmod_mpoly_to_mpolyun_perm_deflate(
    fq_nmod_mpolyun_t A,
...
FLINT_DLL void fq_nmod_mpoly_from_mpolyun_perm_inflate(
    fq_nmod_mpoly_t A,
    mp_bitcnt_t Abits,
    fq_nmod_mpolyun_t B,
    const slong * perm,
...
FLINT_DLL slong fq_nmod_mpolyun_lastdeg(
    fq_nmod_mpolyun_t A,
    const fq_nmod_mpoly_ctx_t ctx);
...
FLINT_DLL void nmod_mpolyun_reduce_last_fq_nmod_poly(
    fq_nmod_poly_t E,
    const fq_nmod_ctx_t fqctx,
    const nmod_mpolyun_t A,
    const nmod_mpoly_ctx_t ctx);

FLINT_DLL void nmod_mpolyun_startinterp_fq_nmod_poly(
    slong * lastdeg_,
    nmod_mpolyun_t A,
    const nmod_mpoly_ctx_t ctx,
...
FLINT_DLL int nmod_mpolyun_addinterp_fq_nmod_poly(
    slong * lastdeg_,
    nmod_mpolyun_t F,
    nmod_mpolyun_t T,
    nmod_poly_t modulus,
...
FLINT_DLL void nmod_mpolyun_redto_fq_nmod_mpolyun(
    fq_nmod_mpolyun_t E,
...
FLINT_DLL void nmod_mpolyun_startinterp_fq_nmod_mpolyun(
    slong * lastdeg,
    nmod_mpolyun_t A,
    slong var,
    const nmod_mpoly_ctx_t ctx,
...
FLINT_DLL int nmod_mpolyun_addinterp_fq_nmod_mpolyun(
    slong * lastdeg,
    nmod_mpolyun_t F,
    nmod_mpolyun_t T,
    nmod_poly_t modulus,
...
FLINT_DLL void nmod_mpolyun_redto_fq_nmod_mpolyu(
    fq_nmod_mpolyu_t A,
    nmod_mpolyun_t B,
...
FLINT_DLL int nmod_mpolyun_addinterp_fq_nmod_mpolyu(
    slong * lastdeg,
    nmod_mpolyun_t F,
    nmod_mpolyun_t T,
    nmod_poly_t m,
...
FLINT_DLL void fq_nmod_mpolyun_eval_last_bivar(
    fq_nmod_poly_t E,
    const fq_nmod_mpolyun_t A,
    const fq_nmod_t alpha,
    const fq_nmod_mpoly_ctx_t ctx);

FLINT_DLL void fq_nmod_mpolyun_startinterp_bivar(
    fq_nmod_mpolyun_t A,
    const fq_nmod_poly_t B,
    const fq_nmod_mpoly_ctx_t ctx);

FLINT_DLL int fq_nmod_mpolyun_addinterp_bivar(
    slong * lastdeg_,
    fq_nmod_mpolyun_t F,
    fq_nmod_mpolyun_t T,
...
FLINT_DLL void fq_nmod_mpolyun_eval_last_un(
    fq_nmod_mpolyun_t E,
    fq_nmod_mpolyun_t A,
    slong var,
    fq_nmod_t alpha,
...
FLINT_DLL void fq_nmod_mpolyun_startinterp_un(
    fq_nmod_mpolyun_t A,
    fq_nmod_mpolyun_t B,
    slong var,
    const fq_nmod_mpoly_ctx_t ctx);

FLINT_DLL int fq_nmod_mpolyun_addinterp_un(
    slong * lastdeg,
    fq_nmod_mpolyun_t F,
    fq_nmod_mpolyun_t T,
    fq_nmod_mpolyun_t A,
...
FLINT_DLL void fq_nmod_mpolyun_redto_fq_nmod_poly(
    fq_nmod_poly_t E,
    const fq_nmod_mpoly_ctx_t ectx,
    fq_nmod_mpolyun_t A,
    const fq_nmod_mpoly_ctx_t ctx,
...
FLINT_DLL void fq_nmod_mpolyun_startinterp_fq_nmod_poly(
    slong * lastdeg_,
    fq_nmod_mpolyun_t A,
    const fq_nmod_mpoly_ctx_t ctx,
    fq_nmod_poly_t B,
...
FLINT_DLL int fq_nmod_mpolyun_addinterp_fq_nmod_poly(
    slong * lastdeg_,
    fq_nmod_mpolyun_t F,
    fq_nmod_mpolyun_t T,
    fq_nmod_poly_t modulus,
...
FLINT_DLL void fq_nmod_mpolyun_redto_fq_nmod_mpolyun(
    fq_nmod_mpolyun_t E,
    const fq_nmod_mpoly_ctx_t ectx,
    fq_nmod_mpolyun_t A,
    slong var,
...
FLINT_DLL void fq_nmod_mpolyun_startinterp_un_lgprime(
    slong * lastdeg,
    fq_nmod_mpolyun_t A,
    slong var,
    const fq_nmod_mpoly_ctx_t ctx,
...
FLINT_DLL int fq_nmod_mpolyun_addinterp_un_lgprime(
    slong * lastdeg,
    fq_nmod_mpolyun_t F,
    fq_nmod_mpolyun_t T,
    fq_nmod_poly_t modulus,
...
FLINT_DLL void fq_nmod_mpolyun_eval_last(
    fq_nmod_mpolyu_t B,
    fq_nmod_mpolyun_t A,
    fq_nmod_t alpha,
    const fq_nmod_mpoly_ctx_t ctx);

FLINT_DLL void fq_nmod_mpolyun_set_mpolyu(
    fq_nmod_mpolyun_t A,
    const fq_nmod_mpolyu_t B,
    const fq_nmod_mpoly_ctx_t ctx);

FLINT_DLL int fq_nmod_mpolyun_addinterp(
    slong * lastdeg,
    fq_nmod_mpolyun_t F,
    fq_nmod_mpolyun_t T,
    fq_nmod_mpolyu_t A,
...
FLINT_DLL void fq_nmod_mpolyun_redto_fq_nmod_mpolyu(
    fq_nmod_mpolyu_t A,
    fq_nmod_mpolyun_t B,
    const fq_nmod_mpoly_ctx_t ectx,
    const fq_nmod_mpoly_ctx_t ctx,
...
FLINT_DLL int fq_nmod_mpolyun_CRT_fq_nmod_mpolyu(
    slong * lastdeg,
    fq_nmod_mpolyun_t H,
    const fq_nmod_mpoly_ctx_t ctx,
    fq_nmod_poly_t m,
...
FLINT_DLL int fq_nmod_mpolyun_addinterp_lgprime(
    slong * lastdeg,
    fq_nmod_mpolyun_t F,
    fq_nmod_mpolyun_t T,
    fq_nmod_poly_t m,

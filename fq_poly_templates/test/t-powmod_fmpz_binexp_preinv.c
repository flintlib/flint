...
main(void)
{
    ...
    for (i = 0; i < 25; i++)
    {
        ...
        TEMPLATE(T, poly_powmod_fmpz_binexp_preinv)(res, a, expz, f, finv, ctx);
    ...
    for (i = 0; i < 50; i++)
    {
        ...
        TEMPLATE(T, poly_powmod_fmpz_binexp_preinv)(res1, a, exp1, f, finv, ctx);
        TEMPLATE(T, poly_powmod_fmpz_binexp_preinv)(res2, a, exp2, f, finv, ctx);
        TEMPLATE(T, poly_mulmod)(res4, res1, res2, f, ctx);
        fmpz_init(exp3);
        fmpz_add(exp3, exp1, exp2);
        TEMPLATE(T, poly_powmod_fmpz_binexp_preinv)(res3, a, exp3, f, finv, ctx);

...
main(void)
{
    ...
    for (i = 0; i < 50; i++)
    {
        ...
        TEMPLATE(T, poly_compose_horner)(h, f, g, ctx);
        TEMPLATE(T, poly_compose_horner)(f, f, g, ctx);
    ...
    for (i = 0; i < 50; i++)
    {
        ...
        TEMPLATE(T, poly_compose_horner)(h, f, g, ctx);
        TEMPLATE(T, poly_compose_horner)(g, f, g, ctx);
    ...
    for (i = 0; i < 50; i++)
    {
        ...
        TEMPLATE(T, poly_compose_horner)(f, g, h, ctx);

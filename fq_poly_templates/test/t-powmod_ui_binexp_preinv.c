...
main(void)
{
    ...
    for (i = 0; i < 50; i++)
    {
        ...
        TEMPLATE(T, poly_powmod_ui_binexp_preinv)(res1, a, exp1, f, finv, ctx);
        TEMPLATE(T, poly_powmod_ui_binexp_preinv)(res2, a, exp2, f, finv, ctx);
        
        TEMPLATE(T, poly_mulmod_preinv)(res4, res1, res2, f, finv, ctx);
        exp3 = exp1 + exp2;
        TEMPLATE(T, poly_powmod_ui_binexp_preinv)(res3, a, exp3, f, finv, ctx);

...
main(void)
{
    ...
    for (i = 0; i < 50; i++)
    {
        ...
        TEMPLATE(T, poly_compose_divconquer)(h, f, g, ctx);
        TEMPLATE(T, poly_compose_divconquer)(f, f, g, ctx);
    ...
    for (i = 0; i < 50; i++)
    {
        ...
        TEMPLATE(T, poly_compose_divconquer)(h, f, g, ctx);
        TEMPLATE(T, poly_compose_divconquer)(g, f, g, ctx);
    ...
    for (i = 0; i < 50; i++)
    {
        ...
        {
            TEMPLATE(T, TEMPLATE(poly_scalar_addmul, T))(s, t, g->coeffs + k, ctx);
            TEMPLATE(T, poly_mul)(t, t, h, ctx);
        }

        TEMPLATE(T, poly_compose_divconquer)(f, g, h, ctx);

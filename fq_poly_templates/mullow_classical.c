                          ...
                          const TEMPLATE(T, ctx_t) ctx)
{
    ...
    else
    {
        ...
        if (n > len1)
            _TEMPLATE(T, TEMPLATE(poly_scalar_mul, T))(rop + len1,
                         ...
                         const TEMPLATE(T, ctx_t) ctx)
{
    ...
    if (rop == op1 || rop == op2)
    {
        ...
        _TEMPLATE(T, poly_mullow_classical)(t->coeffs, op1->coeffs, op1->length,
    ...
    else
    {
        ...
        _TEMPLATE(T, poly_mullow_classical)(rop->coeffs, op1->coeffs, op1->length,
                                  op2->coeffs, op2->length, n, ctx);
    }

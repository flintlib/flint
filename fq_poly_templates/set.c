...
void
_TEMPLATE(T, poly_set)(TEMPLATE(T, struct) * rop, const TEMPLATE(T, struct) * op, slong len,
...
void
TEMPLATE(T, poly_set)(TEMPLATE(T, poly_t) rop, const TEMPLATE(T, poly_t) op, const TEMPLATE(T, ctx_t) ctx)
{

...
void
_TEMPLATE(T, poly_divrem_divconquer_recursive)(TEMPLATE(T, struct) * Q, TEMPLATE(T, struct) * BQ,
                                     TEMPLATE(T, struct) * W, const TEMPLATE(T, struct) * A,
                                     ...
                                     const TEMPLATE(T, t) invB, const TEMPLATE(T, ctx_t) ctx)
{
    if (lenB <= TEMPLATE(CAP_T, POLY_DIVREM_DIVCONQUER_CUTOFF))
    {
        ...
        _TEMPLATE(T, poly_divrem_basecase)(Q, BQ, BQ, 2 * lenB - 1, B, lenB, invB, ctx);
    ...
    else
    {
        ...
        _TEMPLATE(T, poly_add)(dq1 + n2, dq1 + n2, n1 - 1, d2q1 + n2, n1 - 1, ctx);
        ...
        t = BQ;
        _TEMPLATE(T, poly_sub)(t, A + n2 + (n1 - 1), n2, dq1 + (n1 - 1), n2, ctx);
        p2 = t - (n2 - 1);
        ...
        _TEMPLATE(T, poly_add)(BQ + n2, BQ + n2, n1 - 1, d4q2 + n2, n1 - 1, ctx);
        _TEMPLATE(T, poly_add)(BQ + n1, BQ + n1, 2 * n2 - 1, d3q2, 2 * n2 - 1, ctx);

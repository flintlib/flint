                                ...
                                const TEMPLATE(T, ctx_t) ctx)
{
    ...
    for (i = 2; i < m; i++)
    {
        _TEMPLATE(T, poly_mulmod)(tmp, A->rows[i - 1], n, poly2, n, poly3, len3, ctx);
    ...
    _TEMPLATE(T, poly_mulmod)(h, A->rows[m - 1], n, poly2, n, poly3, len3, ctx);
                               ...
                               const TEMPLATE(T, ctx_t) ctx)
{
    ...
    if (res == poly3 || res == poly1)
    {
        ...
        TEMPLATE(T, poly_compose_mod_brent_kung)(tmp, poly1, poly2, poly3, ctx);
    ...
    _TEMPLATE(T, poly_compose_mod_brent_kung)(res->coeffs, poly1->coeffs, len1,

                      ...
                      const TEMPLATE(T, t) invB, const TEMPLATE(T, ctx_t) ctx)
{
    ...
    for (iQ = lenA - lenB; iQ >= 0; iQ--)
    {
        ...
        else
        {
            ...
            _TEMPLATE(T, TEMPLATE(vec_scalar_submul, T))(R + lenA - lenR - 1, B, lenR, Q + iQ,
                                     ctx);
        }
...
void
TEMPLATE(T, poly_div_basecase)(TEMPLATE(T, poly_t) Q, const TEMPLATE(T, poly_t) A, const TEMPLATE(T, poly_t) B,

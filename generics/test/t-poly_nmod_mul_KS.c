...
int main()
{
    ...
    for (iter = 0; iter < 10000; iter++)
    {
        ...
        elem_poly_nmod_mul_KS(C, A, B, ring);
        elem_poly_nmod_mul_KS(A, A, B, ring);
        ...
        elem_randtest(B, state, size, ring);
        elem_poly_nmod_mul_KS(C, A, B, ring);
        elem_poly_nmod_mul_KS(B, A, B, ring);
        ...
        elem_set(B, A, ring);
        elem_poly_nmod_mul_KS(C, A, B, ring);
        elem_poly_nmod_mul_KS(D, A, A, ring);
        ...
        elem_randtest(A, state, size, ring);
        elem_poly_nmod_mul_KS(B, A, A, ring);
        elem_poly_nmod_mul_KS(A, A, A, ring);
        ...
        elem_poly_nmod_mul_KS(D, A, B, ring);
        elem_poly_nmod_mul_KS(D, D, C, ring);
        elem_poly_nmod_mul_KS(E, B, C, ring);
        elem_poly_nmod_mul_KS(E, A, E, ring);
        ...
        elem_randtest(C, state, size, ring);
        elem_poly_nmod_mul_KS(D, A, B, ring);
        elem_poly_nmod_mul_KS(E, A, C, ring);
        elem_add(E, D, E, ring);
        elem_add(D, B, C, ring);
        elem_poly_nmod_mul_KS(D, A, D, ring);

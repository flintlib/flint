...
int main()
{
    ...
    /* polynomials over (fmpz) integers */
    {
        ...
        test_add(state, Z, size, 1000);
        test_add(state, Zx, size, 1000);
        test_add(state, Zxy, size, 1000);
        test_add(state, Zxyz, size, 1000);
    ...
    for (i = 0; i < 100; i++)
    {
        ...
        test_add(state, Zn, size, 10);
        test_add(state, Znx, size, 10);
        test_add(state, Znxy, size, 10);
        test_add(state, Znxyz, size, 10);
    ...
    /* polynomials over (fmpz) integer fractions */
    {
        ...
        test_add(state, Zq, size, 1000);
        test_add(state, Zqx, size, 1000);
        test_add(state, Zxq, size, 1000);
        test_add(state, Zqxy, size, 1000);
        test_add(state, Zxqy, size, 1000);
        test_add(state, Zxyq, size, 1000);
    ...
    /* Complex numbers */
    {
        ...
        test_add(state, Zi, size, 1000);
        test_add(state, Zxi, size, 1000);
        test_add(state, Zix, size, 1000);
        test_add(state, Zqi, size, 1000);

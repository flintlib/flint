...
void
FLINT_DLL fmpz_mat_multi_mod_ui_precomp(nmod_mat_t * residues, slong nres, 
    const fmpz_mat_t mat, const fmpz_comb_t comb, fmpz_comb_temp_t temp);

void
FLINT_DLL fmpz_mat_multi_mod_ui(nmod_mat_t * residues, slong nres, const fmpz_mat_t mat);

void
FLINT_DLL fmpz_mat_multi_CRT_ui_precomp(fmpz_mat_t mat,

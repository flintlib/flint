...
main(void)
{
    ...
    for (i = 0; i < 5000; i++)
    {
        ...
        fmpz_mod_poly_randtest(a, state, n_randint(state, 5));
        fmpz_mod_poly_randtest_not_zero(b, state, n_randint(state, 4) + 1);
        ...
        fmpz_mod_poly_powers_precompute(pre, b);
        fmpz_mod_poly_rem_powers_precomp(t, a, b, pre);
    ...
    for (i = 0; i < 500; i++)
    {
        ...
        fmpz_mod_poly_powers_precompute(pre, b);
        fmpz_mod_poly_rem_powers_precomp(r, a, b, pre);
        fmpz_mod_poly_rem_powers_precomp(b, a, b, pre);
    ...
    for (i = 0; i < 500; i++)
    {
        ...
        fmpz_mod_poly_powers_precompute(pre, b);
        fmpz_mod_poly_rem_powers_precomp(r, a, b, pre);
        fmpz_mod_poly_rem_powers_precomp(a, a, b, pre);

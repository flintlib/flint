...
main(void)
{
    ...
    flint_printf("powmod_fmpz_binexp_powers_precomp....");
    fflush(stdout);

    /* Aliasing of res and a */
    for (i = 0; i < 250; i++)
    {
        fmpz_mod_poly_t a, res, f;
        fmpz_t p;
        ulong exp;
        fmpz_t expz;
        ...
        fmpz_mod_poly_powmod_fmpz_binexp_powers_precomp(res, a, expz, f, pre);
        fmpz_mod_poly_powmod_fmpz_binexp_powers_precomp(a, a, expz, f, pre);
    ...
    for (i = 0; i < 250; i++)
    {
        ...
        fmpz_mod_poly_powers_precompute(pre, f);
        fmpz_mod_poly_powmod_fmpz_binexp_powers_precomp(res, a, expz, f, pre);
        fmpz_mod_poly_powmod_fmpz_binexp_powers_precomp(f, a, expz, f, pre);
    ...
    for (i = 0; i < 500; i++)
    {
        fmpz_mod_poly_t a, res1, res2, res3, res4, f;
        fmpz_t p;
        ...
        fmpz_mod_poly_powers_precompute(pre, f);
        fmpz_mod_poly_powmod_fmpz_binexp_powers_precomp(res1, a, exp1, f, pre);
        fmpz_mod_poly_powmod_fmpz_binexp_powers_precomp(res2, a, exp2, f, pre);
        fmpz_mod_poly_mulmod(res4, res1, res2, f);
        fmpz_init(exp3);
        fmpz_add(exp3, exp1, exp2);
        fmpz_mod_poly_powmod_fmpz_binexp_powers_precomp(res3, a, exp3, f, pre);

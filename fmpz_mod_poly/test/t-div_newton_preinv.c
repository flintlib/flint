...
main(void)
{
    ...
    for (i = 0; i < 500 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_mod_poly_div_newton_preinv(q, a, b, binv);
        fmpz_mod_poly_divrem (test, r, a, b);

        result = (fmpz_mod_poly_equal(q, test));
        if (!result)
        {
            printf("FAIL:\n");
    ...
    for (i = 0; i < 500 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_mod_poly_div_newton_preinv(q, a, b, binv);
        fmpz_mod_poly_div_newton_preinv(a, a, b, binv);
    ...
    for (i = 0; i < 500 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_mod_poly_div_newton_preinv(q, a, b, binv);
        fmpz_mod_poly_div_newton_preinv(b, a, b, binv);
    ...
    for (i = 0; i < 500 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_mod_poly_div_newton_preinv(q, a, b, binv);
        fmpz_mod_poly_div_newton_preinv(binv, a, b, binv);

...
const fexpr_symbol_info fexpr_builtin_table[FEXPR_BUILTIN_LENGTH] = {
    ...
    { FEXPR_AiryAi, "AiryAi", "\\operatorname{Ai}", NULL, },
    { FEXPR_AiryAiZero, "AiryAiZero", "a", fexpr_write_latex_subscript, },
    { FEXPR_AiryBi, "AiryBi", "\\operatorname{Bi}", NULL, },
    ...
    { FEXPR_DirichletLZero, "DirichletLZero", "", fexpr_write_latex_subscript, },
    ...
    { FEXPR_GaussLegendreWeight, "GaussLegendreWeight", "", fexpr_write_latex_subscript, },
    ...
    { FEXPR_GeneralizedBernoulliB, "GeneralizedBernoulliB", "", fexpr_write_latex_subscript, },
    ...
    { FEXPR_JacobiTheta, "JacobiTheta", "\\theta", fexpr_write_latex_subscript_call, },
    ...
    { FEXPR_LegendrePolynomialZero, "LegendrePolynomialZero", "", fexpr_write_latex_subscript, },

...
main(void)
{
    ...
    for (i = 0; i < 1000; i++)
    {
        ...
        fq_poly_compose_mod_horner(d, a, b, c, ctx);
    ...
    for (i = 0; i < 1000; i++)
    {
        ...
        fq_poly_compose_mod_horner(d, a, b, c, ctx);
        fq_poly_compose_mod_horner(a, a, b, c, ctx);
    ...
    for (i = 0; i < 1000; i++)
    {
        ...
        fq_poly_compose_mod_horner(d, a, b, c, ctx);
        fq_poly_compose_mod_horner(b, a, b, c, ctx);
    ...
    for (i = 0; i < 1000; i++)
    {
        ...
        fq_poly_compose_mod_horner(d, a, b, c, ctx);
        fq_poly_compose_mod_horner(c, a, b, c, ctx);

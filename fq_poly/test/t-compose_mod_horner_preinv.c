...
main(void)
{
    ...
    for (i = 0; i < 20 * flint_test_multiplier(); i++)
    {
        ...
        fq_poly_compose_mod_horner_preinv(d, a, b, c, cinv, ctx);
    ...
    for (i = 0; i < 20 * flint_test_multiplier(); i++)
    {
        ...
        fq_poly_rem(a, a, c, ctx);
        fq_poly_compose_mod_horner_preinv(d, a, b, c, cinv, ctx);
        fq_poly_compose_mod_horner_preinv(a, a, b, c, cinv, ctx);
    ...
    for (i = 0; i < 20 * flint_test_multiplier(); i++)
    {
        ...
        fq_poly_rem(a, a, c, ctx);
        fq_poly_compose_mod_horner_preinv(d, a, b, c, cinv, ctx);
        fq_poly_compose_mod_horner_preinv(b, a, b, c, cinv, ctx);
    ...
    for (i = 0; i < 20 * flint_test_multiplier(); i++)
    {
        ...
        fq_poly_rem(a, a, c, ctx);
        fq_poly_compose_mod_horner_preinv(d, a, b, c, cinv, ctx);
        fq_poly_compose_mod_horner_preinv(c, a, b, c, cinv, ctx);

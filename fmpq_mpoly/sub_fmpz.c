...
void fmpq_mpoly_sub_fmpz(fmpq_mpoly_t poly1, const fmpq_mpoly_t poly2,
...
void fmpq_mpoly_sub_ui(fmpq_mpoly_t poly1, const fmpq_mpoly_t poly2,
                                           ulong x, const fmpq_mpoly_ctx_t ctx)
{
    fmpz_t X;
    fmpz_init_set_ui(X, x);
    fmpq_mpoly_sub_fmpz(poly1, poly2, X, ctx);
    fmpz_clear(X);
}

void fmpq_mpoly_sub_si(fmpq_mpoly_t poly1, const fmpq_mpoly_t poly2,

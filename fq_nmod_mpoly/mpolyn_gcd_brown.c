...
successful:
    ...
    leadG = fq_nmod_mpolyn_leadcoeff_poly(G, ctx);
...
successful:
    ...
    Glead = fq_nmod_mpolyn_leadcoeff_poly(G, ctx);
    fq_nmod_mpolyn_divexact_poly(Abar, Abar, Glead, ctx, tquo, trem);
    fq_nmod_mpolyn_divexact_poly(Bbar, Bbar, Glead, ctx, tquo, trem);

...
len_t fmpz_get_si(const fmpz_t f);

ulong fmpz_get_ui(const fmpz_t f);

static __inline__ void
fmpz_set_si(fmpz_t f, len_t val)
{
...
int fmpz_cmp_si(const fmpz_t f, len_t g);
...
void fmpz_mul_si(fmpz_t f, const fmpz_t g, len_t x);
...
len_t fmpz_flog(const fmpz_t x, const fmpz_t b);
len_t fmpz_flog_ui(const fmpz_t x, ulong b);
len_t fmpz_clog(const fmpz_t x, const fmpz_t b);
len_t fmpz_clog_ui(const fmpz_t x, ulong b);
...
void fmpz_root(fmpz_t r, fmpz_t f, len_t n);
...
int fmpz_divisible_si(const fmpz_t f, len_t g);

void fmpz_cdiv_q(fmpz_t f, const fmpz_t g, const fmpz_t h);

void fmpz_cdiv_q_si(fmpz_t f, const fmpz_t g, len_t h);
...
void fmpz_fdiv_q_si(fmpz_t f, const fmpz_t g, len_t h);
...
void fmpz_tdiv_q_si(fmpz_t f, const fmpz_t g, len_t h);

ulong fmpz_tdiv_ui(const fmpz_t g, ulong h);

void fmpz_tdiv_q_2exp(fmpz_t f, const fmpz_t g, ulong exp);

double fmpz_get_d_2exp(len_t * exp, const fmpz_t f);
...
void fmpz_mul_si_tdiv_q_2exp(fmpz_t f, const fmpz_t g, len_t x, ulong exp);
...
typedef struct
{
    mp_limb_t * primes;
    len_t num_primes;
    len_t n;         /* we have 2^n >= num_primes > 2^(n-1) */
...
void fmpz_comb_init(fmpz_comb_t comb, mp_limb_t * primes, len_t num_primes);
...
mp_limb_t fmpz_abs_ubound_ui_2exp(len_t * exp, const fmpz_t x, int bits);

mp_limb_t fmpz_abs_lbound_ui_2exp(len_t * exp, const fmpz_t x, int bits);

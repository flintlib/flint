...
FLINT_DLL void fmpz_init_set(fmpz_t f, const fmpz_t g);
...
fmpz_get_uiui(ulong * hi, ulong * low, const fmpz_t f)
{
    ...
    {
        mpz_mock_ptr mpz = COEFF_TO_PTR(*f);
        *low = mpz->_mp_d[0];
...
FLINT_DLL int fmpz_get_mpn(ulong_ptr *n, fmpz_t n_in);
#endif
...
FLINT_DLL int fmpz_bit_pack(ulong * arr, flint_bitcnt_t shift, flint_bitcnt_t bits, 
                  const fmpz_t coeff, int negate, int borrow);

FLINT_DLL int fmpz_bit_unpack(fmpz_t coeff, const ulong * arr, flint_bitcnt_t shift, 
                    flint_bitcnt_t bits, int negate, int borrow);

FLINT_DLL void fmpz_bit_unpack_unsigned(fmpz_t coeff, const ulong * arr, 
                              flint_bitcnt_t shift, flint_bitcnt_t bits);

/* crt ***********************************************************************/

FLINT_DLL void _fmpz_CRT_ui_precomp(fmpz_t out, const fmpz_t r1, const fmpz_t m1,
    ulong r2, ulong m2, ulong m2inv, const fmpz_t m1m2, ulong c,
        int sign);
...
FLINT_DLL void fmpz_comb_init(fmpz_comb_t C, const ulong * primes, slong num_primes);

FLINT_DLL void fmpz_comb_clear(fmpz_comb_t C);

FLINT_DLL void fmpz_multi_mod_ui(ulong * out, const fmpz_t in,
                                     const fmpz_comb_t C, fmpz_comb_temp_t CT);

FLINT_DLL void fmpz_multi_CRT_ui(fmpz_t output, const ulong * residues,
                      const fmpz_comb_t comb, fmpz_comb_temp_t temp, int sign);

/*****************************************************************************/

FLINT_DLL ulong fmpz_abs_ubound_ui_2exp(slong * exp, const fmpz_t x, int bits);

FLINT_DLL ulong fmpz_abs_lbound_ui_2exp(slong * exp, const fmpz_t x, int bits);
...
FLINT_DLL void _fmpz_nm1_trial_factors(const fmpz_t n, ulong * pm1, 
                                                 slong * num_pm1, ulong limit);

FLINT_DLL int fmpz_is_prime_pocklington(fmpz_t F, fmpz_t R, 
                                    const fmpz_t n, ulong * pm1, slong num_pm1);

FLINT_DLL void _fmpz_np1_trial_factors(const fmpz_t n, 
                                     ulong * pp1, slong * num_pp1, ulong limit);

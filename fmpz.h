...
static inline
void fmpz_CRT_ui_precomp(fmpz_t out, fmpz_t r1, fmpz_t m1, ulong r2, ulong m2, ulong c, double pre)
{
   ...
   ulong s = n_submod(r2, r1mod, m2);
   s = n_mulmod_precomp(s, c, m2, pre);
   fmpz_t sm1; 
   fmpz_init2(sm1, fmpz_size(m1));
...
static inline
void fmpz_CRT_ui2_precomp(fmpz_t out, fmpz_t r1, fmpz_t m1, ulong r2, ulong m2, ulong c, double pre)
{
   ulong r1mod;
   fmpz_t r1modd; 
   fmpz_init(r1modd);

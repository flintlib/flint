                         ...
                         const padic_ctx_t ctx)
{
    ...
    else if (val2 >= 0)
    {
        ...
        else
        {
            ...
            alloc = _padic_ctx_pow_ui(pow, ctx->N - val1, ctx);
    ...
    else  /* val2 < 0 */
    {
        ...
        else
        {
            ...
            alloc = _padic_ctx_pow_ui(pow, ctx->N - val1 - n*val2, ctx);
                        ...
                        const padic_ctx_t ctx)
{
    ...
    else
    {
        ...
        if (rop != op1 && rop != op2)
        {
            ...
            _padic_poly_compose(rop->coeffs, &(rop->val), 

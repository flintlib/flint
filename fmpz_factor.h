...
FLINT_DLL int fmpz_factor_pollard_brent_single(fmpz_t p_factor, const fmpz_t n, 
                                               const fmpz_t ai, const fmpz_t xi, 
                                               mp_limb_t max_iters);

FLINT_DLL int fmpz_factor_pollard_brent(fmpz_t p_factor, flint_rand_t state, 

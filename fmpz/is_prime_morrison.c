...
void _fmpz_np1_trial_factors(const fmpz_t n, ulong_ptr pp1, slong * num_pp1, ulong limit)
{
   slong i, num;
   ulong ppi, p;
   const ulong * primes;
...
int fmpz_is_prime_morrison(fmpz_t F, fmpz_t R, const fmpz_t n, ulong_ptr pp1, slong num_pp1)
{
   slong i, d, bits;
   ulong a, b;

...
void _fmpz_nm1_trial_factors(const fmpz_t n, ulong_ptr pm1, slong * num_pm1, ulong limit)
{
   slong i, num;
   ulong ppi, p;
   const ulong * primes;
...
int fmpz_is_prime_pocklington(fmpz_t F, fmpz_t R, const fmpz_t n, ulong_ptr pm1, slong num_pm1)
{
   slong i, d, bits;
   ulong a;

...
unity_zp_mul5(unity_zp f, const unity_zp g, const unity_zp h, fmpz_t * t)
{
    ...
    */
    ...
    fmpz_mod_poly_get_coeff_fmpz(t[2], g->poly, 2); /* set x2        */
    fmpz_mod_poly_get_coeff_fmpz(t[3], g->poly, 3); /* set x3        */

    fmpz_mod_poly_get_coeff_fmpz(t[4], h->poly, 0); /* set y0        */
    fmpz_mod_poly_get_coeff_fmpz(t[5], h->poly, 1); /* set y1        */
    fmpz_mod_poly_get_coeff_fmpz(t[6], h->poly, 2); /* set y2        */
    fmpz_mod_poly_get_coeff_fmpz(t[7], h->poly, 3); /* set y3        */

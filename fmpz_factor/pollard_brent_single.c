...
/* Sets y to (y^2 + a) % n */
void
flint_mpn_sqr_and_add_a(ulong_ptr y, ulong_ptr a, ulong_ptr n, ulong n_size, ulong_ptr ninv, 
              ulong normbits)
{
    ulong cy;
...
int
flint_mpn_factor_pollard_brent_single(ulong_ptr factor, ulong_ptr n, ulong_ptr ninv, ulong_ptr a, ulong_ptr y,

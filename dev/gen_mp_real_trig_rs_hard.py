#!/usr/bin/env python3
"""Regenerate src/mp_real/trig_rs_hard.inc (run from the top-level
FLINT directory: python3 dev/gen_mp_real_trig_rs_hard.py > src/mp_real/trig_rs_hard.inc)."""
...
# ===========================================================================
# Driver for the mp_real module: regenerate src/mp_real/trig_rs_hard.inc.
#
...
if __name__ == "__main__":
    ...
    out = ("/* Generated by dev/gen_mp_real_trig_rs_hard.py -- private static\n"
           "   Taylor series routines for the mp_real module -- do not edit"
           " by hand. */\n\n"
           "typedef void (*odd_series_fn)(nn_ptr, nn_srcptr);\n"
           "typedef void (*odd_even_series_fn)(nn_ptr, nn_ptr, nn_srcptr);\n\n"
           + _statify(f64) + "\n" + _statify(f32))
    out = _drop_err_tabs(out)
    for a, b in [('mpn_atanh_series16_', '_mp_real_atanh_rs16_'),
                 ('mpn_atan_series16_', '_mp_real_atan_rs16_'),
                 ('mpn_sin_cos_series16_', '_mp_real_sin_cos_rs16_'),
                 ('mpn_atan_series32_', '_mp_real_atan_rs32_'),
                 ('mpn_atanh_series32_', '_mp_real_atanh_rs32_'),
                 ('mpn_sin_cos_series32_', '_mp_real_sin_cos_rs32_'),
                 ('mpn_sinh_cosh_series32_', '_mp_real_sinh_cosh_rs32_'),
                 ('mpn_atan_series_', '_mp_real_atan_rs_'),
                 ('mpn_atanh_series_', '_mp_real_atanh_rs_'),
                 ('mpn_sin_cos_series_', '_mp_real_sin_cos_rs_'),
                 ('mpn_sinh_cosh_series_', '_mp_real_sinh_cosh_rs_')]:
        out = out.replace(a, b)

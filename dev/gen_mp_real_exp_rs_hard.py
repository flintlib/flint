#!/usr/bin/env python3
"""Regenerate src/mp_real/exp_rs_hard.inc (run from the top-level
FLINT directory: python3 dev/gen_mp_real_exp_rs_hard.py > src/mp_real/exp_rs_hard.inc)."""
...
# ===========================================================================
# Driver for the mp_real module: regenerate src/mp_real/exp_rs_hard.inc.
#
...
# dev/gen_mp_real_exp_bitwise_small.py) and N is the smallest number of
...
# needs, so they are hand-written in dev/exp_series_hand.inc (with N
...
if __name__ == "__main__":
    ...
    # dev/tune_mp_real.py) in place of the latter.  Only the 2^-64 and
    ...
    out = ("/* Generated by dev/gen_mp_real_exp_rs_hard.py -- private static\n"
    ...
    out = out.replace('mpn_exp_series32_', '_mp_real_exp_rs32_')
    out = out.replace('mpn_exp_series_', '_mp_real_exp_rs_')

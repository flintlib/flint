    ...
    flint_rand_t randstate)
{
    ...
    nmod_poly_factor_fit_length(r, r->num +
                                    nmod_poly_degree(a) + nmod_poly_degree(b));
    ...
    while (sp > 0)
    {
        ...
        else
        {
            ...
            _nmod_poly_split_rabin(stack + sp + 0, stack + sp + 1, T, f,
                                                                    randstate);
                                                         ...
                                                         int with_multiplicity)
{
    slong i;
    flint_rand_t randstate;
    nmod_poly_struct t[FLINT_BITS + 2];
    ...
    else
    {
        ...
        _nmod_poly_push_roots(r, t + 0, 1, t + 1, t + 2, randstate);
    }

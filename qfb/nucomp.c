...
void qfb_nucomp(qfb_t r, qfb_t f, qfb_t g, fmpz_t L)
{
   ...
   fmpz_init(cx); fmpz_init(cy); fmpz_init(dx);
   ...
   fmpz_clear(cx); fmpz_clear(cy); fmpz_clear(dx);

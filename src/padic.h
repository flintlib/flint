...
PADIC_INLINE fmpz * padic_unit(const padic_t x) { return (fmpz *) &(x->u); }
PADIC_INLINE slong padic_get_val(const padic_t x) { return padic_val(x); }
PADIC_INLINE slong padic_get_prec(const padic_t x) { return padic_prec(x); }

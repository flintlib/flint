...
test_struct tests[] =
{
    TEST_FUNCTION(fq_nmod_mat_add_sub),
    TEST_FUNCTION(fq_nmod_mat_can_solve),
    TEST_FUNCTION(fq_nmod_mat_charpoly),
    TEST_FUNCTION(fq_nmod_mat_concat_horizontal),
    TEST_FUNCTION(fq_nmod_mat_concat_vertical),
    TEST_FUNCTION(fq_nmod_mat_equal),
    ...
    TEST_FUNCTION(fq_nmod_mat_mul_vec),
    TEST_FUNCTION(fq_nmod_mat_nullspace),
    TEST_FUNCTION(fq_nmod_mat_one),
    TEST_FUNCTION(fq_nmod_mat_rank),
    TEST_FUNCTION(fq_nmod_mat_rref),
    TEST_FUNCTION(fq_nmod_mat_scalar_mul),
    TEST_FUNCTION(fq_nmod_mat_scalar_mul_fmpz),
    TEST_FUNCTION(fq_nmod_mat_scalar_mul_si),
    TEST_FUNCTION(fq_nmod_mat_scalar_mul_ui),
    TEST_FUNCTION(fq_nmod_mat_set_fmpz_mod_mat),

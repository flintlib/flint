...
{
    f->constant = 1; f->poly = NULL; f->exp = NULL; f->num   = 0; f->alloc = 0;
}
void nmod_mpoly_factor_init2(
    nmod_mpoly_factor_t f,
    slong alloc,
    const nmod_mpoly_ctx_t ctx);
void nmod_mpoly_factor_realloc(
    nmod_mpoly_factor_t f,
    slong alloc,
    const nmod_mpoly_ctx_t ctx);
void nmod_mpoly_factor_clear(nmod_mpoly_factor_t f, const nmod_mpoly_ctx_t ctx);

void nmod_mpoly_factor_fit_length(
    nmod_mpoly_factor_t f,
    slong len,
    const nmod_mpoly_ctx_t ctx);
...
{
    FLINT_ASSERT(i < (ulong) f->num); nmod_mpoly_set(p, f->poly + i, ctx);
}

NMOD_MPOLY_FACTOR_INLINE
void nmod_mpoly_factor_swap_base(nmod_mpoly_t p, nmod_mpoly_factor_t f, slong i, const nmod_mpoly_ctx_t ctx)
{
    FLINT_ASSERT(i < (ulong) f->num); nmod_mpoly_swap(p, f->poly + i, ctx);
}
...
void nmod_mpoly_factor_set(
    nmod_mpoly_factor_t f,
    const nmod_mpoly_factor_t g,
    const nmod_mpoly_ctx_t ctx);

void nmod_mpoly_factor_print_pretty(
...
NMOD_MPOLY_FACTOR_INLINE
void nmod_mpolyv_swap(nmod_mpolyv_t A, nmod_mpolyv_t B, const nmod_mpoly_ctx_t ctx)
{
    FLINT_SWAP(nmod_mpolyv_struct, *A, *B);
}

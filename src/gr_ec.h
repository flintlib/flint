...
WARN_UNUSED_RESULT int _gr_ec_point_neg_long_weierstrass(gr_ec_point_t res, const gr_ec_point_t P, gr_ec_ctx_t ctx);
WARN_UNUSED_RESULT int _gr_ec_point_neg_short_weierstrass(gr_ec_point_t res, const gr_ec_point_t P, gr_ec_ctx_t ctx);

...
FLINT_INLINE ulong n_pow2(int k) { return UWORD(1) << k; }

FLINT_INLINE ulong n_min(ulong a, ulong b) { return FLINT_MIN(a, b); }
FLINT_INLINE ulong n_max(ulong a, ulong b) { return FLINT_MAX(a, b); }

/* not technically correct because the addition can overflow */
FLINT_INLINE ulong n_cdiv(ulong a, ulong b) { return (a + b - 1) / b; }

FLINT_INLINE ulong n_round_up(ulong a, ulong b) { return n_cdiv(a, b) * b; }
FLINT_INLINE ulong n_round_down(ulong a, ulong b) { return a / b * b; }
...
FLINT_INLINE
void sd_fft_lctx_fft_trunc(sd_fft_lctx_t Q, double * d, ulong depth, ulong itrunc, ulong otrunc)
{
...
FLINT_INLINE
void sd_fft_lctx_ifft_trunc(sd_fft_lctx_t Q, double * d, ulong depth, ulong trunc)
{
    FLINT_ASSERT(depth >= LG_BLK_SZ);
...
FLINT_INLINE
void sd_fft_ctx_fft_trunc(sd_fft_ctx_t Q, double * d, ulong depth, ulong itrunc, ulong otrunc)
{
    sd_fft_lctx_t QL;
...
FLINT_INLINE
void sd_fft_ctx_ifft_trunc(sd_fft_ctx_t Q, double * d, ulong depth, ulong trunc)
{
    sd_fft_lctx_t QL;
    sd_fft_lctx_init(QL, Q, depth);
...
/* look up w[2*j] */
FLINT_INLINE
double sd_fft_lctx_w2(const sd_fft_lctx_t Q, ulong j)
{
    ulong j_bits, j_r;
...
/* look up -w[2*j]^-1 */
FLINT_INLINE
double sd_fft_lctx_w2inv(const sd_fft_lctx_t Q, ulong j)
{
    ulong j_bits, j_mr;
...
/* look up w[jj] */
FLINT_INLINE
double sd_fft_ctx_w(const sd_fft_ctx_t Q, ulong jj)
{

...
/* GENERATED by dev/tune_mp_real.py (atan, n = 2, r = 6) -- do not
   edit directly; retune or re-emit with
       python3 dev/tune_mp_real.py atan 2 --pin 6 --emit */
...
static void
_mp_real_atan_series_2(nn_ptr res, nn_srcptr x)
{
...
void
_mp_real_atan_opt_2(nn_ptr res, nn_srcptr x)
{
    const int r = 6;
    ulong x0, x1;
    ulong y0, y1;

...
/* GENERATED by dev/tune_mp_real.py (log1p, n = 2, r = 16) -- do not
   edit directly; retune or re-emit with
       python3 dev/tune_mp_real.py log1p 2 --pin 16 --emit */
...
static void
_mp_real_log1p_series_2(nn_ptr res, nn_srcptr x)
{
...
void
_mp_real_log1p_opt_2(nn_ptr res, nn_srcptr x)
{
    const int r = 16;

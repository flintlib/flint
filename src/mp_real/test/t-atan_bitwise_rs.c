...
TEST_FUNCTION_START(mp_real_atan_bitwise_rs, state)
{
    slong iter;
    ...
    for (iter = 0; iter < 200 * flint_test_multiplier(); iter++)
    {
        ...
        _mp_real_atan_bitwise_rs(res, &test_err_out, x, n, r);
        ...
        if (u > TEST_ERR(DOC_ATAN_BITWISE_RS_MAX_ERR(n, r)))
       ...
       leaves cold */
    {
        ...
        for (n = 1; n <= 7; n++)
        {
            for (k = 0; k < 24; k++)
            {
                ...
                _mp_real_atan_bitwise_rs(res, &test_err_out, x, n, 0);
                ...
                if (u > TEST_ERR(DOC_ATAN_BITWISE_RS_MAX_ERR(n,
                    _mp_real_atan_bitwise_rs_default_r(n))))

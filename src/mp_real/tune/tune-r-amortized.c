...
eval_once(which_t w, nn_ptr y, nn_ptr y2, nn_srcptr x, slong n, int r)
{
    switch (w)
    {
        case F_EXP:    _mp_real_exp_bitwise_rs(y, NULL, x, n, r); break;
        case F_LOG1P:  _mp_real_log1p_bitwise_rs(y, NULL, x, n, r); break;
        case F_ATAN:   _mp_real_atan_bitwise_rs(y, NULL, x, n, r); break;
        case F_SINCOS: _mp_real_sin_cos_bitwise_rs(y, y2, NULL, x, n, r); break;
        case F_TAN:    _mp_real_tan_bitwise_rs(y, NULL, x, n, r); break;
    }
}
...
time_precomp(which_t w, slong n, int r)
{
    ...
    for (pass = 0; pass < passes; pass++)
    {
        ...
        timeit_start(tm);
        if (w == F_EXP || w == F_LOG1P)
            _mp_real_exp_logs_ensure(n, r);
        else
            _mp_real_atans_ensure(n, r);
        timeit_stop(tm);
...
int main(int argc, char ** argv)
{
    ...
    flint_printf("_mp_real_%s_bitwise_rs, n = %wd\n\n", names[w], n);
       ...
       from the smallest-total-at-N=1 candidate toward smaller E */
    {
        ...
        flint_printf("\n/* _mp_real_%s_bitwise_rs, n = %wd: smallest "

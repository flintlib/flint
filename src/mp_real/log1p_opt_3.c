...
/* GENERATED by dev/tune_mp_real.py (log1p, n = 3, r = 10) -- do not
   edit directly; retune or re-emit with
       python3 dev/tune_mp_real.py log1p 3 --pin 10 --emit */
...
static void
_mp_real_log1p_series_3(nn_ptr res, nn_srcptr x)
{
...
void
_mp_real_log1p_opt_3(nn_ptr res, nn_srcptr x)
{
    const int r = 10;
    ulong d0, d1, d2;
    ulong p0, p1, p2;
...
#undef LP
    ...
    flint_mpn_zero(t, 3);
    if (d2 != 0 || d1 != 0 || d0 != 0)
        flint_mpn_tdiv_qr(t, nd, nd, 6, S, 4);

    _mp_real_log1p_series_3(y, t);

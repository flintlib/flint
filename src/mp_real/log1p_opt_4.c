...
/* GENERATED by dev/tune_mp_real.py (log1p, n = 4, r = 26) -- do not
   edit directly; retune or re-emit with
       python3 dev/tune_mp_real.py log1p 4 --pin 26 --emit */
...
static void
_mp_real_log1p_series_4(nn_ptr res, nn_srcptr x)
{
...
void
_mp_real_log1p_opt_4(nn_ptr res, nn_srcptr x)
{
    const int r = 26;
    ulong d0, d1, d2, d3;
    ulong p0, p1, p2, p3;

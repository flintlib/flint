...
/* GENERATED by dev/tune_mp_real.py (atan, n = 4, r = 20) -- do not
   edit directly; retune or re-emit with
       python3 dev/tune_mp_real.py atan 4 --pin 20 --emit */
...
static void
_mp_real_atan_series_4(nn_ptr res, nn_srcptr x)
{
...
void
_mp_real_atan_opt_4(nn_ptr res, nn_srcptr x)
{
    const int r = 20;
    ulong x0, x1, x2, x3;
    ulong y0, y1, y2, y3;
...
#undef AP
    ...
    if (nz)
    {
        ...
        nd[6] = y2;
        nd[7] = y3;
        flint_mpn_tdiv_qr(t, nd, nd, 8, S, 5);
    }
    else
    {
        t[0] = 0;

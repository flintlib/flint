...
TEST_FUNCTION_START(nmod_poly_divides, state)
{
    int i, result;
    ...
    for (i = 0; i < 1000 * flint_test_multiplier(); i++)
    {
        ...
        divides = nmod_poly_divides(q, a, b);
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        divides1 = nmod_poly_divides(q, a, b);
        divides2 = nmod_poly_divides(a, a, b);
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        divides1 = nmod_poly_divides(q, a, b);
        divides2 = nmod_poly_divides(b, a, b);

...
TEST_FUNCTION_START(nmod_poly_gcd_euclidean_redc_fast, state)
{
    int i, result;
    ...
    */
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        nmod_poly_gcd_euclidean_redc_fast(g, a, b);
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        nmod_poly_gcd_euclidean_redc_fast(g, a, b);
        nmod_poly_gcd_euclidean_redc_fast(a, a, b);
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        nmod_poly_gcd_euclidean_redc_fast(g, a, b);
        nmod_poly_gcd_euclidean_redc_fast(b, a, b);

...
TEST_TEMPLATE_FUNCTION_START(T, mat_scalar_mul, state)
{
    slong rep;
    ...
    for (rep = 0; rep < 1000 * flint_test_multiplier(); rep++)
    {
        ...
        TEMPLATE(T, mat_scalar_mul)(C, A, c, ctx);
        TEMPLATE(T, sub_one)(c, c, ctx);
        TEMPLATE(T, mat_scalar_mul)(D, A, c, ctx);
        ...
        /* Aliasing */
        TEMPLATE(T, mat_scalar_mul)(C, A, c, ctx);
        TEMPLATE(T, mat_scalar_mul)(A, A, c, ctx);

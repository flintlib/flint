...
TEST_FUNCTION_START(flint_mpn_fmmamod_preinvn, state)
{
    int i;
    slong n;

    mp_ptr a, b, a2, b2, d, dnormed, dinv, r1, r2, t, u;
    ulong norm;
    ...
    for (i = 0; i < 10000 * flint_test_multiplier(); i++)
    {
        ...
        if (n == 2 && n_randint(state, 2))
            flint_mpn_fmmamod_preinvn_2(r2, a, b, a2, b2, dnormed, dinv, norm);
        else
            flint_mpn_fmmamod_preinvn(r2, a, b, a2, b2, n, dnormed, dinv, norm);

...
TEST_FUNCTION_START(flint_mpn_fmmamod_precond_matrix, state)
{
    int i;
    slong n, npre;
    ...
    for (i = 0; i < 10000 * flint_test_multiplier(); i++)
    {
        ...
        flint_mpn_mulmod_precond_matrix_precompute(a2pre, a2, n, dnormed, dinv, norm);
        flint_mpn_fmmamod_precond_matrix(r2, apre, b, a2pre, b2, n, dnormed, dinv, norm);

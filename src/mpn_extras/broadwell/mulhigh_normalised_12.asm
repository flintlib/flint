...
.global	FUNC(flint_mpn_mulhigh_normalised_12)
.p2align	4, 0x90
TYPE(flint_mpn_mulhigh_normalised_12)
...
.Lcontinue:
	...
	ret
.flint_mpn_mulhigh_normalised_12_end:
SIZE(flint_mpn_mulhigh_normalised_12, .flint_mpn_mulhigh_normalised_12_end)
.cfi_endproc

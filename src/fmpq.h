...
{
    fmpz_clear(fmpq_numref(x)); fmpz_clear(fmpq_denref(x));
}
...
{
    fmpz_zero(fmpq_numref(res)); fmpz_one(fmpq_denref(res));
}
FMPQ_INLINE
void fmpq_one(fmpq_t res)
{
    fmpz_one(fmpq_numref(res)); fmpz_one(fmpq_denref(res));
}

FMPQ_INLINE
void fmpq_swap(fmpq_t op1, fmpq_t op2)
{
    fmpz_swap(fmpq_numref(op1), fmpq_numref(op2)); fmpz_swap(fmpq_denref(op1), fmpq_denref(op2));
}
...
{
    fmpz_set(fmpq_numref(q), n); fmpz_one(fmpq_denref(q));
}
void fmpq_set_fmpz_frac(fmpq_t res, const fmpz_t p, const fmpz_t q);
FMPQ_INLINE
void fmpq_set(fmpq_t dest, const fmpq_t src)
{
    fmpz_set(fmpq_numref(dest), fmpq_numref(src)); fmpz_set(fmpq_denref(dest), fmpq_denref(src));
}

FMPQ_INLINE
void fmpq_set_mpq(fmpq_t dest, const mpq_t src)
{
    fmpz_set_mpz(fmpq_numref(dest), mpq_numref(src)); fmpz_set_mpz(fmpq_denref(dest), mpq_denref(src));
}
FMPQ_INLINE
void fmpq_get_mpq(mpq_t dest, const fmpq_t src)
{
    fmpz_get_mpz(mpq_numref(dest), fmpq_numref(src)); fmpz_get_mpz(mpq_denref(dest), fmpq_denref(src));
}
...
FMPQ_INLINE
int fmpq_is_pm1(const fmpq_t x)
{
    return fmpz_is_pm1(fmpq_numref(x)) && fmpz_is_one(fmpq_denref(x));
}

FMPQ_INLINE
int fmpq_equal_ui(fmpq_t q, ulong n)
{
    return fmpz_equal_ui(fmpq_numref(q), n) && fmpz_is_one(fmpq_denref(q));
}
FMPQ_INLINE
int fmpq_equal_si(fmpq_t q, slong n)
{
    return fmpz_equal_si(fmpq_numref(q), n) && fmpz_is_one(fmpq_denref(q));
}
...
{
    fmpz_neg(fmpq_numref(dest), fmpq_numref(src)); fmpz_set(fmpq_denref(dest), fmpq_denref(src));
}
FMPQ_INLINE
void fmpq_abs(fmpq_t dest, const fmpq_t src)
{
    fmpz_abs(fmpq_numref(dest), fmpq_numref(src)); fmpz_set(fmpq_denref(dest), fmpq_denref(src));
}
...
int _fmpq_reconstruct_fmpz_2_naive(
    fmpz_t n,
    fmpz_t d,
    const fmpz_t a,
    const fmpz_t m,
...
void _fmpq_next_signed_calkin_wilf(
    fmpz_t rnum,
    fmpz_t rden,
    const fmpz_t num,
    const fmpz_t den);
...
void _fmpq_next_signed_minimal(
    fmpz_t rnum,
    fmpz_t rden,
    const fmpz_t num,
    const fmpz_t den);

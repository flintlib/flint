...
PADIC_POLY_INLINE slong padic_poly_degree(const padic_poly_t poly) { return poly->length - 1; }
PADIC_POLY_INLINE slong padic_poly_length(const padic_poly_t poly) { return poly->length; }
PADIC_POLY_INLINE slong padic_poly_val(const padic_poly_t poly) { return poly->val; }
...
PADIC_POLY_INLINE void padic_poly_zero(padic_poly_t poly) { _padic_poly_set_length(poly, 0); poly->val = 0; }
...
PADIC_POLY_INLINE int padic_poly_is_zero(const padic_poly_t poly) { return poly->length == 0; }
PADIC_POLY_INLINE int padic_poly_is_one(const padic_poly_t poly) { return (poly->length == 1) && /* fmpz_is_one(poly->coeffs) */ *(poly->coeffs) == 1 && (poly->val == 0); }
...
void padic_poly_mul(padic_poly_t f, const padic_poly_t g, const padic_poly_t h, const padic_ctx_t ctx);
...
void padic_poly_inv_series(padic_poly_t Qinv, const padic_poly_t Q, slong n, const padic_ctx_t ctx);
...
void padic_poly_evaluate_padic(padic_t y, const padic_poly_t poly, const padic_t x, const padic_ctx_t ctx);

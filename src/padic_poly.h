...
void padic_poly_randtest(
    padic_poly_t f,
    flint_rand_t state,
    slong len,
    const padic_ctx_t ctx);
void padic_poly_randtest_not_zero(
    padic_poly_t f,
    flint_rand_t state,
    slong len,
    const padic_ctx_t ctx);
void padic_poly_randtest_val(
    padic_poly_t f,
    flint_rand_t state,
    slong val,
    slong len,
...
void padic_poly_set_fmpz_poly(
    padic_poly_t rop,
    const fmpz_poly_t op,
    const padic_ctx_t ctx);
void padic_poly_set_fmpq(padic_poly_t poly, const fmpq_t x, const padic_ctx_t ctx);
void padic_poly_set_fmpq_poly(
    padic_poly_t rop,
    const fmpq_poly_t op,
    const padic_ctx_t ctx);
void padic_poly_set_padic(padic_poly_t poly, const padic_t x, const padic_ctx_t ctx);
void padic_poly_set(padic_poly_t f, const padic_poly_t g, const padic_ctx_t ctx);

int padic_poly_get_fmpz_poly(
    fmpz_poly_t rop,
    const padic_poly_t op,
    const padic_ctx_t ctx);
void padic_poly_get_fmpq_poly(
    fmpq_poly_t rop,
    const padic_poly_t op,
    const padic_ctx_t ctx);
...
{
    _padic_poly_set_length(poly, 0); poly->val = 0;
}
...
void padic_poly_get_coeff_padic(
    padic_t c,
    const padic_poly_t poly,
    slong n,
    const padic_ctx_t ctx);
void padic_poly_set_coeff_padic(
    padic_poly_t f,
    slong n,
    const padic_t c,
    const padic_ctx_t ctx);
...
{
    return (poly->length == 1) && /* fmpz_is_one(poly->coeffs) */ *(poly->coeffs) == 1 && (poly->val == 0);
}

/*  Addition and subtraction  ************************************************/

void _padic_poly_add(
    fmpz * rop,
    slong * rval,
    slong N,
    const fmpz * op1,
...
void padic_poly_add(
    padic_poly_t f,
    const padic_poly_t g,
    const padic_poly_t h,
    const padic_ctx_t ctx);

void _padic_poly_sub(
    fmpz * rop,
    slong * rval,
    slong N,
    const fmpz * op1,
...
void _padic_poly_scalar_mul_padic(
    fmpz * rop,
    slong * rval,
    slong N,
    const fmpz * op,
    ...
    const padic_t c,
    const padic_ctx_t ctx);
void padic_poly_scalar_mul_padic(
    padic_poly_t rop,
    const padic_poly_t op,
    const padic_t c,
    const padic_ctx_t ctx);
...
void padic_poly_inv_series(
    padic_poly_t Qinv,
    const padic_poly_t Q,
    slong n,
    const padic_ctx_t ctx);

/*  Derivative  **************************************************************/

void _padic_poly_derivative(
    fmpz * rop,
    slong * rval,
    slong N,
    const fmpz * op,
...
void padic_poly_shift_left(
    padic_poly_t rop,
    const padic_poly_t op,
    slong n,
    const padic_ctx_t ctx);
void padic_poly_shift_right(
    padic_poly_t rop,
    const padic_poly_t op,
    slong n,
    const padic_ctx_t ctx);
...
void _padic_poly_evaluate_padic(
    ...
    slong b,
    const padic_ctx_t ctx);
void padic_poly_evaluate_padic(
    padic_t y,
    const padic_poly_t poly,
    const padic_t x,
    const padic_ctx_t ctx);
...
void _padic_poly_compose(
    ...
    slong len2,
    const padic_ctx_t ctx);
void padic_poly_compose(
    padic_poly_t rop,
    const padic_poly_t op1,
    const padic_poly_t op2,
    const padic_ctx_t ctx);

void _padic_poly_compose_pow(
    fmpz * rop,
    slong * rval,
    slong N,
    const fmpz * op,
...
int _padic_poly_print_pretty(
    const fmpz * poly,
    slong val,
    slong len,
    const char * var,
    const padic_ctx_t ctx);
int padic_poly_print_pretty(
    const padic_poly_t poly,
    const char * var,
    const padic_ctx_t ctx);

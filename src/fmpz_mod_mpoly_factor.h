...
void fmpz_mod_mpoly_factor_init2(
...
FMPZ_MOD_MPOLY_FACTOR_INLINE
void fmpz_mod_mpoly_factor_get_base(fmpz_mod_mpoly_t p, const fmpz_mod_mpoly_factor_t f, slong i, const fmpz_mod_mpoly_ctx_t ctx)
{
    FLINT_ASSERT(i < (ulong) f->num); fmpz_mod_mpoly_set(p, f->poly + i, ctx);
}

FMPZ_MOD_MPOLY_FACTOR_INLINE
void fmpz_mod_mpoly_factor_swap_base(fmpz_mod_mpoly_t p, fmpz_mod_mpoly_factor_t f, slong i, const fmpz_mod_mpoly_ctx_t ctx)
{
    FLINT_ASSERT(i < (ulong) f->num); fmpz_mod_mpoly_swap(p, f->poly + i, ctx);
}

FMPZ_MOD_MPOLY_FACTOR_INLINE
slong fmpz_mod_mpoly_factor_get_exp_si(fmpz_mod_mpoly_factor_t f, slong i, const fmpz_mod_mpoly_ctx_t ctx)
{
    FLINT_ASSERT(i < (ulong) f->num); return fmpz_get_si(f->exp + i);
}

FMPZ_MOD_MPOLY_FACTOR_INLINE
void fmpz_mod_mpoly_factor_swap(fmpz_mod_mpoly_factor_t f, fmpz_mod_mpoly_factor_t g, const fmpz_mod_mpoly_ctx_t ctx)
{
    FLINT_SWAP(fmpz_mod_mpoly_factor_struct, *f, *g);
}

void fmpz_mod_mpoly_factor_set(
    fmpz_mod_mpoly_factor_t f,
    const fmpz_mod_mpoly_factor_t g,
    const fmpz_mod_mpoly_ctx_t ctx);
...
void fmpz_mod_mat_init_nullspace_tr(
    fmpz_mod_mat_t X,
    fmpz_mod_mat_t tmp,
    const fmpz_mod_ctx_t ctx);
...
void fmpz_mod_mpolyn_stack_init(
...
slong _fmpz_mod_poly_vec_max_degree(
...
{
    FLINT_ASSERT(A->length > 0); FLINT_ASSERT(A->coeffs[0].length > 0); return A->coeffs[0].coeffs + A->coeffs[0].length - 1;
}

FMPZ_MOD_MPOLY_FACTOR_INLINE
void fmpz_mod_polyun_swap(fmpz_mod_polyun_t A, fmpz_mod_polyun_t B)
{
    FLINT_SWAP(fmpz_mod_polyun_struct, *A, *B);
}
...
{
    A->length = 0; A->alloc = 0; A->coeffs = NULL; A->exps = NULL;
}
...
{
    if (len > A->alloc) fmpz_mod_polyun_realloc(A, len, ctx);
}
...
FMPZ_MOD_MPOLY_FACTOR_INLINE
void fmpz_mod_mpolyn_swap(fmpz_mod_mpolyn_t A, fmpz_mod_mpolyn_t B, const fmpz_mod_mpoly_ctx_t ctx)
{
    FLINT_SWAP(fmpz_mod_mpolyn_struct, *A, *B);
}
...
FMPZ_MOD_MPOLY_FACTOR_INLINE
void fmpz_mod_polyu_swap(fmpz_mod_polyu_t A, fmpz_mod_polyu_t B)
{
    FLINT_SWAP(fmpz_mod_polyu_struct, *A, *B);
}

FMPZ_MOD_MPOLY_FACTOR_INLINE
void fmpz_mod_polyu_fit_length(fmpz_mod_polyu_t a, slong len, const fmpz_mod_ctx_t ctx)
{
    if (len > a->alloc) fmpz_mod_polyu_realloc(a, len);
}
...
void fmpz_mod_mpolyu3_print_pretty(
    const fmpz_mod_mpolyu_t A,
    const char * var0,
    const char * var1,
    const char * var2,
    const char ** vars,
...
{
    A->coeffs = NULL; A->alloc = 0; A->length = 0;
}
...
FMPZ_MOD_MPOLY_FACTOR_INLINE
void fmpz_mod_bpoly_swap(fmpz_mod_bpoly_t A, fmpz_mod_bpoly_t B, const fmpz_mod_ctx_t ctx)
{
    FLINT_SWAP(fmpz_mod_bpoly_struct, *A, *B);
}

FMPZ_MOD_MPOLY_FACTOR_INLINE
void fmpz_mod_bpoly_get_coeff(fmpz_t c, const fmpz_mod_bpoly_t A, slong e0, slong e1, const fmpz_mod_ctx_t ctx)
{
    if (e0 >= A->length) fmpz_zero(c); else fmpz_mod_poly_get_coeff_fmpz(c, A->coeffs + e0, e1, ctx);
}
...
{
    while (A->length > 0 && fmpz_mod_poly_is_zero(A->coeffs + A->length - 1, ctx)) A->length--;
}
...
FMPZ_MOD_MPOLY_FACTOR_INLINE
void fmpz_mod_tpoly_swap(fmpz_mod_tpoly_t A, fmpz_mod_tpoly_t B, const fmpz_mod_ctx_t ctx)
{
    FLINT_SWAP(fmpz_mod_tpoly_struct, *A, *B);
}
...
FMPZ_MOD_MPOLY_FACTOR_INLINE
void fmpz_mod_mpolyv_swap(fmpz_mod_mpolyv_t A, fmpz_mod_mpolyv_t B, const fmpz_mod_mpoly_ctx_t ctx)
{
    FLINT_SWAP(fmpz_mod_mpolyv_struct, *A, *B);
}
...
int fmpz_mod_mpoly_factor_irred_smprime_zassenhaus(
    ...
    const fmpz_mod_mpoly_ctx_t ctx,
    flint_rand_t state);
int fmpz_mod_mpoly_factor_irred_smprime_wang(
    fmpz_mod_mpolyv_t fac,
    const fmpz_mod_mpoly_t A,
    const fmpz_mod_mpoly_factor_t lcAfac,
...
void fmpz_mod_mpoly_compression_undo(
    fmpz_mod_mpoly_t A,
    flint_bitcnt_t Abits,
...
int fmpz_mod_bpoly_pfrac(
    slong r,
    fmpz_mod_bpoly_struct * C,
    slong * C_deg1_bound,
    fmpz_mod_bpoly_t A,
...
int _fmpz_mod_mpoly_evaluate_rest_fmpz_mod_poly(
    fmpz_mod_poly_struct * E, slong * starts,
    slong * ends,
    slong * stops,
    ulong * es,
    const fmpz * Acoeffs,

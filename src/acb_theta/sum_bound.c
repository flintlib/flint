...
static void
acb_theta_sum_bound_ci(arb_t c0, arb_t c1, arb_t c2, acb_srcptr z, const acb_mat_t tau)
{
...
void
acb_theta_sum_bound(arb_t c, arb_t rho, acb_srcptr z, const acb_mat_t tau, slong ord)
{
    slong lp = ACB_THETA_LOW_PREC;
    slong b = ord + 1;
    arb_t t, c0, c1, c2;
    ...
    /* Get ci */
    acb_theta_sum_bound_ci(c0, c1, c2, z, tau);

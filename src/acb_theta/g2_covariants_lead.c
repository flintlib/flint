...
acb_theta_g2_transvectants(acb_ptr res, const acb_poly_t r, slong prec)
{
    ...
    /* Get polynomials */
    acb_theta_g2_transvectant(r2, r, r, 6, 6, 4, prec);
    acb_theta_g2_transvectant(r3, r, r, 6, 6, 2, prec);
    acb_theta_g2_transvectant(r4, r, r2, 6, 4, 4, prec);
    acb_theta_g2_transvectant(r5, r, r2, 6, 4, 2, prec);
    acb_theta_g2_transvectant(r6, r, r2, 6, 4, 1, prec);

    /* Get leading coefficients of r, r2, ..., r6 */
    acb_poly_get_coeff_acb(&res[0], r, 6);
    ...
    acb_theta_g2_transvectant_lead(&res[1], r, r, 6, 6, 6, prec);
    acb_theta_g2_transvectant_lead(&res[7], r, r3, 6, 8, 1, prec);
    acb_theta_g2_transvectant_lead(&res[8], r2, r2, 4, 4, 4, prec);
    acb_theta_g2_transvectant_lead(&res[9], r, r4, 6, 2, 2, prec);
    acb_theta_g2_transvectant_lead(&res[10], r, r4, 6, 2, 1, prec);
    ...
    acb_theta_g2_transvectant_lead(&res[18], r, s, 6, 4, 4, prec);
    acb_theta_g2_transvectant_lead(&res[19], r, s, 6, 4, 3, prec);
    ...
    acb_theta_g2_transvectant_lead(&res[22], r, s, 6, 6, 6, prec);
    acb_theta_g2_transvectant_lead(&res[23], r, s, 6, 6, 5, prec);

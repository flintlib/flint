 ...
 * overwritten, and its element values do not matter.  It will contain dangling
 * pointers after returning, that is, the values `input[ix]' will be invalid
 * after returning.  Hence, we silence warnings about dangling pointers. */
#ifdef __GNUC__

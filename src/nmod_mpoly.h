...
NMOD_MPOLY_INLINE
n_poly_struct * evil_cast_nmod_poly_to_n_poly(nmod_poly_struct * a)
{
    return (n_poly_struct *) a;
}
NMOD_MPOLY_INLINE
const n_poly_struct * evil_const_cast_nmod_poly_to_n_poly(const nmod_poly_struct * a)
{
...
void nmod_mpoly_ctx_init(
    nmod_mpoly_ctx_t ctx,
    slong nvars,
    const ordering_t ord,
    mp_limb_t modulus);
void nmod_mpoly_ctx_init_rand(
    nmod_mpoly_ctx_t ctx,
    flint_rand_t state,
    slong max_nvars,
    mp_limb_t modulus);
...
int nmod_mpoly_set_str_pretty(
    nmod_mpoly_t A,
    const char * str,
    const char ** x,
    const nmod_mpoly_ctx_t ctx);

char * nmod_mpoly_get_str_pretty(
    const nmod_mpoly_t A,
    const char ** x,
    const nmod_mpoly_ctx_t ctx);

#ifdef FLINT_HAVE_FILE
int nmod_mpoly_fprint_pretty(
    FILE * file,
    const nmod_mpoly_t A,
    const char ** x,
    const nmod_mpoly_ctx_t ctx);
...
ulong nmod_mpoly_get_coeff_ui_ui(
    const nmod_mpoly_t A,
    const ulong * exp,
    const nmod_mpoly_ctx_t ctx);
void nmod_mpoly_set_coeff_ui_ui(
    nmod_mpoly_t A,
    ulong c,
    const ulong * exp,
    const nmod_mpoly_ctx_t ctx);

ulong nmod_mpoly_get_coeff_ui_fmpz(
    const nmod_mpoly_t A,
    fmpz * const * exp,
    const nmod_mpoly_ctx_t ctx);
...
ulong nmod_mpoly_get_coeff_ui_monomial(
    const nmod_mpoly_t A,
    const nmod_mpoly_t M,
    const nmod_mpoly_ctx_t ctx);
void nmod_mpoly_set_coeff_ui_monomial(
    nmod_mpoly_t A,
    ulong c,
    const nmod_mpoly_t M,
    const nmod_mpoly_ctx_t ctx);
...
NMOD_MPOLY_INLINE
mp_limb_t nmod_mpoly_leadcoeff(nmod_mpoly_t A, const nmod_mpoly_ctx_t ctx)
{
...
ulong nmod_mpoly_get_term_coeff_ui(
    const nmod_mpoly_t A,
    slong i,
    const nmod_mpoly_ctx_t ctx);
void nmod_mpoly_set_term_coeff_ui(
    nmod_mpoly_t A,
    slong i,
    ulong c,
    const nmod_mpoly_ctx_t ctx);
...
void nmod_mpoly_get_term_exp_si(
    slong * exp,
    const nmod_mpoly_t A,
    slong i,
    const nmod_mpoly_ctx_t ctx);
void nmod_mpoly_get_term_exp_ui(
    ulong * exp,
    const nmod_mpoly_t A,
    slong i,
    const nmod_mpoly_ctx_t ctx);
void nmod_mpoly_get_term_exp_fmpz(
    fmpz ** exp,
    const nmod_mpoly_t A,
    slong i,
    const nmod_mpoly_ctx_t ctx);

slong nmod_mpoly_get_term_var_exp_si(
    const nmod_mpoly_t A,
    slong i,
    slong var,
    const nmod_mpoly_ctx_t ctx);
...
void nmod_mpoly_set_term_exp_ui(
    nmod_mpoly_t A,
    slong i,
    const ulong * exp,
    const nmod_mpoly_ctx_t ctx);
void nmod_mpoly_set_term_exp_fmpz(
    nmod_mpoly_t A,
    slong i,
    fmpz * const * exp,
    const nmod_mpoly_ctx_t ctx);
...
void nmod_mpoly_get_term_monomial(
    nmod_mpoly_t M,
    const nmod_mpoly_t A,
    slong i,
    const nmod_mpoly_ctx_t ctx);
...
void nmod_mpoly_reverse(
    nmod_mpoly_t A,
    const nmod_mpoly_t B,
    const nmod_mpoly_ctx_t ctx);

void _nmod_mpoly_radix_sort1(
    nmod_mpoly_t A,
    slong left,
    slong right,
    flint_bitcnt_t pos,
...
void nmod_mpoly_randtest_bound(
    nmod_mpoly_t A,
    flint_rand_t state,
    slong length,
    ulong exp_bound,
    const nmod_mpoly_ctx_t ctx);
void nmod_mpoly_randtest_bounds(
    nmod_mpoly_t A,
    flint_rand_t state,
    slong length,
    ulong * exp_bounds,
...
ulong nmod_mpoly_get_term_ui_ui(
    const nmod_mpoly_t poly,
    const ulong * exp,
    const nmod_mpoly_ctx_t ctx);
ulong _nmod_mpoly_get_term_ui_fmpz(
    const nmod_mpoly_t poly,
    const fmpz * exp,
    const nmod_mpoly_ctx_t ctx);
ulong nmod_mpoly_get_term_ui_fmpz(
    const nmod_mpoly_t poly,
    fmpz * const * exp,
    const nmod_mpoly_ctx_t ctx);

void _nmod_mpoly_max_degrees(
    ulong * max_degs,
    const ulong * exps,
    slong len,
    slong bits,
...
ulong nmod_mpoly_get_coeff_ui(
    nmod_t x,
    const nmod_mpoly_t poly,
    slong n,
    const nmod_mpoly_ctx_t ctx);
void nmod_mpoly_set_coeff_ui(
    nmod_mpoly_t poly,
    slong n,
    ulong x,
    const nmod_mpoly_ctx_t ctx);

void nmod_mpoly_get_monomial(
    ulong * exps,
    const nmod_mpoly_t poly,
    slong n,
    const nmod_mpoly_ctx_t ctx);
void nmod_mpoly_set_monomial(
    nmod_mpoly_t poly,
    slong n,
    const ulong * exps,
    const nmod_mpoly_ctx_t ctx);
...
void nmod_mpoly_add_ui(
    nmod_mpoly_t A,
    const nmod_mpoly_t B,
    ulong c,
    const nmod_mpoly_ctx_t ctx);
void nmod_mpoly_sub_ui(
    nmod_mpoly_t A,
    const nmod_mpoly_t B,
    ulong c,
    const nmod_mpoly_ctx_t ctx);

slong _nmod_mpoly_add(
    mp_limb_t * coeff1,
    ulong * exp1,
    const mp_limb_t * coeff2,
    const ulong * exp2,
    slong len2,
    const mp_limb_t * coeff3,
    const ulong * exp3,
    slong len3,
    slong N,
    const ulong * cmpmask,
    nmod_t fctx);
slong _nmod_mpoly_sub(
    ulong * coeff1,
    ulong * exp1,
    const ulong * coeff2,
    const ulong * exp2,
...
void nmod_mpoly_make_monic(
    nmod_mpoly_t A,
    const nmod_mpoly_t B,
    const nmod_mpoly_ctx_t ctx);

void nmod_mpoly_scalar_mul_ui(
    nmod_mpoly_t A,
    const nmod_mpoly_t B,
    ulong c,
    const nmod_mpoly_ctx_t ctx);
...
mp_limb_t _nmod_mpoly_eval_all_ui(
    ...
    nmod_t mod);
ulong nmod_mpoly_evaluate_all_ui(
    const nmod_mpoly_t A,
    const ulong * vals,
    const nmod_mpoly_ctx_t ctx);

void nmod_mpoly_evaluate_one_ui(
    nmod_mpoly_t A,
    const nmod_mpoly_t B,
    slong var,
    ulong val,
...
int nmod_mpoly_compose_nmod_poly(
    nmod_poly_t A,
    const nmod_mpoly_t B,
    nmod_poly_struct * const * C,
    const nmod_mpoly_ctx_t ctx);
...
void nmod_mpoly_compose_nmod_mpoly_gen(
    nmod_mpoly_t A,
    const nmod_mpoly_t B,
    const slong * c,
    const nmod_mpoly_ctx_t ctxB,
...
int nmod_mpoly_compose_nmod_mpoly_geobucket(
    nmod_mpoly_t A,
    const nmod_mpoly_t B,
    nmod_mpoly_struct * const * C,
    const nmod_mpoly_ctx_t ctxB,
    const nmod_mpoly_ctx_t ctxAC);
int nmod_mpoly_compose_nmod_mpoly_horner(
    nmod_mpoly_t A,
    const nmod_mpoly_t B,
    nmod_mpoly_struct * const * C,
    const nmod_mpoly_ctx_t ctxB,
    const nmod_mpoly_ctx_t ctxAC);
int nmod_mpoly_compose_nmod_mpoly(
    nmod_mpoly_t A,
    const nmod_mpoly_t B,
    nmod_mpoly_struct * const * C,
    const nmod_mpoly_ctx_t ctxB,
...
int nmod_mpoly_mul_array_threaded(
    ...
    const nmod_mpoly_t C,
    const nmod_mpoly_ctx_t ctx);
int nmod_mpoly_mul_array(
    nmod_mpoly_t A,
    const nmod_mpoly_t B,
    const nmod_mpoly_t C,
    const nmod_mpoly_ctx_t ctx);

int _nmod_mpoly_mul_dense(
    nmod_mpoly_t P,
    const nmod_mpoly_t A,
    fmpz * maxAfields,
    const nmod_mpoly_t B,
...
void _nmod_mpoly_pow_rmul(
    ...
    nmod_t mod,
    nmod_mpoly_t T);
void nmod_mpoly_pow_rmul(
    nmod_mpoly_t A,
    const nmod_mpoly_t B,
    ulong k,
    const nmod_mpoly_ctx_t ctx);

int nmod_mpoly_pow_ui(
    nmod_mpoly_t A,
    const nmod_mpoly_t B,
    ulong k,
    const nmod_mpoly_ctx_t ctx);
int nmod_mpoly_pow_fmpz(
    nmod_mpoly_t A,
    const nmod_mpoly_t B,
    const fmpz_t k,
    const nmod_mpoly_ctx_t ctx);
...
NMOD_MPOLY_INLINE
void nmod_mpoly_divexact(nmod_mpoly_t Q, const nmod_mpoly_t A, const nmod_mpoly_t B, const nmod_mpoly_ctx_t ctx)
{
    if (nmod_mpoly_divides(Q, A, B, ctx)) return; flint_throw(FLINT_ERROR, "nmod_mpoly_divexact: nonexact division");
}

/* Square root ***************************************************************/

int nmod_mpoly_sqrt_heap(
    nmod_mpoly_t Q,
    const nmod_mpoly_t A,
    const nmod_mpoly_ctx_t ctx);
NMOD_MPOLY_INLINE
...
int _nmod_mpoly_gcd_algo_small(
    nmod_mpoly_t G,
    nmod_mpoly_t Abar /* can be NULL */,
    nmod_mpoly_t Bbar /* can be NULL */,
    const nmod_mpoly_t A,
    const nmod_mpoly_t B,
    const nmod_mpoly_ctx_t ctx,
    unsigned int algo);
...
void nmod_mpoly_univar_fit_length(
    nmod_mpoly_univar_t A,
    slong length,
    const nmod_mpoly_ctx_t ctx);

void nmod_mpoly_univar_print_pretty(
...
void nmod_mpoly_univar_set_coeff_ui(
    nmod_mpoly_univar_t A,
    ulong e,
    const nmod_mpoly_t c,
    const nmod_mpoly_ctx_t ctx);

void nmod_mpoly_to_univar(
    nmod_mpoly_univar_t A,
    const nmod_mpoly_t B,
    slong var,
    const nmod_mpoly_ctx_t ctx);

void _nmod_mpoly_from_univar(
    nmod_mpoly_t A,
    flint_bitcnt_t Abits,
...
{
    FLINT_ASSERT((ulong) i < (ulong) A->length); nmod_mpoly_set(c, A->coeffs + i, ctx);
}
NMOD_MPOLY_INLINE
void nmod_mpoly_univar_swap_term_coeff(nmod_mpoly_t c, nmod_mpoly_univar_t A, slong i, const nmod_mpoly_ctx_t ctx)
{
    FLINT_ASSERT((ulong) i < (ulong) A->length); nmod_mpoly_swap(c, A->coeffs + i, ctx);
}

int nmod_mpoly_univar_pseudo_gcd(
    nmod_mpoly_univar_t Gx,
    const nmod_mpoly_univar_t Ax,
    const nmod_mpoly_univar_t Bx,
    const nmod_mpoly_ctx_t ctx);

int nmod_mpoly_univar_discriminant(
    nmod_mpoly_t D,
    const nmod_mpoly_univar_t Fx,
    const nmod_mpoly_ctx_t ctx);
int nmod_mpoly_discriminant(
    nmod_mpoly_t R,
    const nmod_mpoly_t A,
    slong var,
    const nmod_mpoly_ctx_t ctx);

int nmod_mpoly_univar_resultant(
    nmod_mpoly_t R,
    const nmod_mpoly_univar_t Ax,
    const nmod_mpoly_univar_t Bx,
    const nmod_mpoly_ctx_t ctx);
int nmod_mpoly_resultant(
    nmod_mpoly_t R,
    const nmod_mpoly_t A,
    const nmod_mpoly_t B,
    slong var,
...
void _nmod_mpoly_addmul_array1_ulong1(
    ulong * poly1,
    const ulong * poly2,
    const ulong * exp2,
    slong len2,
    ...
    const ulong * exp3,
    slong len3);
void _nmod_mpoly_addmul_array1_ulong2(
    ulong * poly1,
    const ulong * poly2,
    const ulong * exp2,
    slong len2,
    ...
    const ulong * exp3,
    slong len3);
void _nmod_mpoly_addmul_array1_ulong3(
    ulong * poly1,
    const ulong * poly2,
    const ulong * exp2,
    slong len2,
...
slong nmod_mpoly_append_array_sm1_LEX(
    nmod_mpoly_t P,
    slong Plen,
    ulong * coeff_array,
    const ulong * mults,
    ...
    slong top,
    const nmod_mpoly_ctx_t ctx);
slong nmod_mpoly_append_array_sm2_LEX(
    nmod_mpoly_t P,
    slong Plen,
    ulong * coeff_array,
    const ulong * mults,
    ...
    slong top,
    const nmod_mpoly_ctx_t ctx);
slong nmod_mpoly_append_array_sm3_LEX(
    nmod_mpoly_t P,
    slong Plen,
    ulong * coeff_array,
    const ulong * mults,
...
slong nmod_mpoly_append_array_sm1_DEGLEX(
    nmod_mpoly_t P,
    slong Plen,
    ulong * coeff_array,
    slong top,
    ...
    slong degb,
    const nmod_mpoly_ctx_t ctx);
slong nmod_mpoly_append_array_sm2_DEGLEX(
    nmod_mpoly_t P,
    slong Plen,
    ulong * coeff_array,
    slong top,
    ...
    slong degb,
    const nmod_mpoly_ctx_t ctx);
slong nmod_mpoly_append_array_sm3_DEGLEX(
    nmod_mpoly_t P,
    slong Plen,
    ulong * coeff_array,
    slong top,
...
slong nmod_mpoly_append_array_sm1_DEGREVLEX(
    nmod_mpoly_t P,
    slong Plen,
    ulong * coeff_array,
    slong top,
    ...
    slong degb,
    const nmod_mpoly_ctx_t ctx);
slong nmod_mpoly_append_array_sm2_DEGREVLEX(
    nmod_mpoly_t P,
    slong Plen,
    ulong * coeff_array,
    slong top,
    ...
    slong degb,
    const nmod_mpoly_ctx_t ctx);
slong nmod_mpoly_append_array_sm3_DEGREVLEX(
    nmod_mpoly_t P,
    slong Plen,
    ulong * coeff_array,
    slong top,
...
int nmod_mpolyd_set_degbounds_perm(
    nmod_mpolyd_t A,
...
nmod_mpoly_struct * _nmod_mpolyu_get_coeff(
    nmod_mpolyu_t A,
    ulong pow,
...
void nmod_mpolyu_scalar_mul_nmod(
    nmod_mpolyu_t A,
    mp_limb_t c,
    const nmod_mpoly_ctx_t ctx);

void nmod_mpolyu_set(
    nmod_mpolyu_t A,
...
void nmod_mpolyu_divexact_mpoly_inplace(
    nmod_mpolyu_t A,
    nmod_mpoly_t c,
    const nmod_mpoly_ctx_t ctx);

void nmod_mpolyu_mul_mpoly_inplace(
    nmod_mpolyu_t A,
    nmod_mpoly_t c,
    const nmod_mpoly_ctx_t ctx);
...
NMOD_MPOLY_INLINE
mp_limb_t nmod_mpolyu_leadcoeff(nmod_mpolyu_t A, const nmod_mpoly_ctx_t ctx)
{
    FLINT_ASSERT(A->length > 0); return nmod_mpoly_leadcoeff(A->coeffs + 0, ctx);
}
...
NMOD_MPOLY_INLINE
mp_limb_t nmod_mpolyun_leadcoeff(nmod_mpolyun_t A, const nmod_mpoly_ctx_t ctx)
{
    FLINT_ASSERT(A->length > 0); return nmod_mpolyn_leadcoeff(A->coeffs + 0, ctx);
}
NMOD_MPOLY_INLINE
n_poly_struct * nmod_mpolyun_leadcoeff_poly(nmod_mpolyun_t A, const nmod_mpoly_ctx_t ctx)
{
    FLINT_ASSERT(A->length > 0); return nmod_mpolyn_leadcoeff_poly(A->coeffs + 0, ctx);
}
...
void nmod_mpolyu_setform_mpolyun(
    nmod_mpolyu_t A,
    nmod_mpolyun_t B,
    const nmod_mpoly_ctx_t ctx);
...
int nmod_mpolyl_gcd_zippel_smprime(
    nmod_mpoly_t rG,
    const slong * rGdegs /* guess at rG degrees,
    can be NULL */,
    nmod_mpoly_t rAbar,
    nmod_mpoly_t rBbar,
    const nmod_mpoly_t A,
...
void nmod_mpoly_geobucket_empty(
    nmod_mpoly_t p,
    nmod_mpoly_geobucket_t B,
    const nmod_mpoly_ctx_t ctx);

void nmod_mpoly_geobucket_fit_length(
    nmod_mpoly_geobucket_t B,
    slong i,
    const nmod_mpoly_ctx_t ctx);

void nmod_mpoly_geobucket_set(
    nmod_mpoly_geobucket_t B,
    nmod_mpoly_t p,
    const nmod_mpoly_ctx_t ctx);

void nmod_mpoly_geobucket_add(
    nmod_mpoly_geobucket_t B,
    nmod_mpoly_t p,
    const nmod_mpoly_ctx_t ctx);
void nmod_mpoly_geobucket_sub(
    nmod_mpoly_geobucket_t B,
    nmod_mpoly_t p,
    const nmod_mpoly_ctx_t ctx);
...
void nmod_mpoly_remainder_strongtest(
    const nmod_mpoly_t r,
    const nmod_mpoly_t g,
    const nmod_mpoly_ctx_t ctx);

...
void _nmod_vec_scalar_mul_nmod(
    mp_ptr res,
    mp_srcptr vec,
    slong len,
    mp_limb_t c,
    nmod_t mod);
void _nmod_vec_scalar_mul_nmod_shoup(
    mp_ptr res,
    mp_srcptr vec,
    slong len,
    mp_limb_t c,
...
void _nmod_vec_scalar_addmul_nmod(
    mp_ptr res,
    mp_srcptr vec,
    slong len,
    mp_limb_t c,
...
mp_limb_t _nmod_vec_dot(
    mp_srcptr vec1,
    mp_srcptr vec2,
    slong len,
    nmod_t mod,
    int nlimbs);
mp_limb_t _nmod_vec_dot_rev(
    mp_srcptr vec1,
    mp_srcptr vec2,
    slong len,
    nmod_t mod,
    int nlimbs);
mp_limb_t _nmod_vec_dot_ptr(
    mp_srcptr vec1,
    const mp_ptr * vec2,
    slong offset,
    slong len,

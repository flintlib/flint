...
TEST_TEMPLATE_FUNCTION_START(T, mul, state)
{
    int i, result;
    ...
    for (i = 0; i < 200 * flint_test_multiplier(); i++)
    {
        ...
        TEMPLATE(T, mul)(c1, a, b, ctx);
        TEMPLATE(T, mul)(c2, b, a, ctx);
    ...
    for (i = 0; i < 200 * flint_test_multiplier(); i++)
    {
        ...
        TEMPLATE(T, mul)(lhs, a, b, ctx);
        TEMPLATE(T, mul)(lhs, lhs, c, ctx);
        TEMPLATE(T, mul)(rhs, b, c, ctx);
        TEMPLATE(T, mul)(rhs, a, rhs, ctx);

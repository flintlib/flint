...
typedef enum {
    ORE_ALGEBRA_STANDARD_DERIVATIVE,
...
#define ORE_POLY_CTX(ring_ctx) ((_gr_ore_poly_ctx_struct *)((ring_ctx)))
#define ORE_POLY_ELEM_CTX(ring_ctx) (ORE_POLY_CTX(ring_ctx)->base_ring)
...
{
    return GR_ENTRY(poly->coeffs, i, ORE_POLY_ELEM_CTX(ctx)->sizeof_elem);
}

...
ore_poly_which_operator;

#define ORE_POLY_NUM_OPERATORS 2

GR_ORE_POLY_INLINE
ore_poly_which_operator ore_poly_which_operator_randtest(flint_rand_t state)
{
   return (ore_poly_which_operator) n_randint(state, ORE_POLY_NUM_OPERATORS);
}
...
typedef struct
{
    ...
    slong degree_limit;
    char * var;
    ore_poly_which_operator which_operator;
...
void gr_ctx_init_gr_ore_poly(gr_ctx_t ctx, gr_ctx_t base_ring, const ore_poly_which_operator operator);

void gr_ore_poly_ctx_init(gr_ore_poly_ctx_t ctx, gr_ctx_t base_ring, const ore_poly_which_operator operator);

...
void fmpq_poly_randtest_unsigned(
    ...
    slong len,
    flint_bitcnt_t bits_in);
void fmpq_poly_randtest_not_zero(
    fmpq_poly_t f,
    flint_rand_t state,
    slong len,
    flint_bitcnt_t bits_in);
...
char * _fmpq_poly_get_str_pretty(
    const fmpz * poly,
    const fmpz_t den,
    slong len,
    const char * var);
...
void _fmpq_poly_add_series(
    ...
    slong len2,
    slong n);
void fmpq_poly_add_series(
    fmpq_poly_t res,
    const fmpq_poly_t poly1,
    const fmpq_poly_t poly2,
    slong n);

void _fmpq_poly_add_can(
    fmpz * rpoly,
    fmpz_t rden,
    const fmpz * poly1,
    const fmpz_t den1,
...
void _fmpq_poly_add_series_can(
    fmpz * rpoly,
    fmpz_t rden,
    const fmpz * poly1,
    const fmpz_t den1,
...
void _fmpq_poly_sub_series(
    ...
    slong len2,
    slong n);
void fmpq_poly_sub_series(
    fmpq_poly_t res,
    const fmpq_poly_t poly1,
    const fmpq_poly_t poly2,
    slong n);

void _fmpq_poly_sub_can(
    fmpz * rpoly,
    fmpz_t rden,
    const fmpz * poly1,
    const fmpz_t den1,
...
void _fmpq_poly_sub_series_can(
    fmpz * rpoly,
    fmpz_t rden,
    const fmpz * poly1,
    const fmpz_t den1,
...
void _fmpq_poly_scalar_mul_fmpz(
    fmpz * rpoly,
    fmpz_t rden,
    const fmpz * poly,
    const fmpz_t den,
...
void _fmpq_poly_scalar_mul_fmpq(
    fmpz * rpoly,
    fmpz_t rden,
    const fmpz * poly,
    const fmpz_t den,
...
void _fmpq_poly_scalar_div_fmpz(
    fmpz * rpoly,
    fmpz_t rden,
    const fmpz * poly,
    const fmpz_t den,
...
void _fmpq_poly_scalar_div_fmpq(
    fmpz * rpoly,
    fmpz_t rden,
    const fmpz * poly,
    const fmpz_t den,
...
fmpq_poly_struct * _fmpq_poly_powers_precompute(
    const fmpz * B,
    const fmpz_t denB,
    slong len);
...
void _fmpq_poly_rem_powers_precomp(
    fmpz * A,
    fmpz_t denA,
    slong m,
    const fmpz * B,
...
void fmpq_poly_rem_powers_precomp(
    fmpq_poly_t R,
    const fmpq_poly_t A,
    const fmpq_poly_t B,
    const fmpq_poly_powers_precomp_t B_inv);

/* Divisibility testing ******************************************************/

int _fmpq_poly_divides(
    fmpz * qpoly,
    fmpz_t qden,
    const fmpz * poly1,
    const fmpz_t den1,
...
void _fmpq_poly_inv_series_newton(
    fmpz * Qinv,
    fmpz_t Qinvden,
    const fmpz * Q,
    const fmpz_t Qden,
...
FMPQ_POLY_INLINE
void _fmpq_poly_inv_series(fmpz * Qinv, fmpz_t Qinvden, const fmpz * Q, const fmpz_t Qden, slong Qlen, slong n)
{
    _fmpq_poly_inv_series_newton(Qinv, Qinvden, Q, Qden, Qlen, n);
}
FMPQ_POLY_INLINE
void fmpq_poly_inv_series(fmpq_poly_t Qinv, const fmpq_poly_t Q, slong n)
{
    fmpq_poly_inv_series_newton(Qinv, Q, n);
}

void _fmpq_poly_div_series(
    fmpz * Q,
    fmpz_t denQ,
    const fmpz * A,
    const fmpz_t denA,
...
void _fmpq_poly_nth_derivative(
    fmpz * rpoly,
    fmpz_t rden,
    const fmpz * poly,
    const fmpz_t den,
...
void  _fmpq_poly_invsqrt_series(
    fmpz * rpoly,
    fmpz_t rden,
    const fmpz * poly,
    const fmpz_t den,
...
void _fmpq_poly_power_sums_to_poly(
    fmpz * res,
    const fmpz * poly,
    const fmpz_t den,
    slong len);
...
void _fmpq_poly_exp_expinv_series(
    fmpz * g,
    fmpz_t gden,
    fmpz * r,
    fmpz_t rden,
    ...
    slong hlen,
    slong n);
void fmpq_poly_exp_expinv_series(
    fmpq_poly_t res1,
    fmpq_poly_t res2,
    const fmpq_poly_t poly,
    slong n);

void _fmpq_poly_atan_series(
    fmpz * g,
    fmpz_t gden,
    const fmpz * h,
    const fmpz_t hden,
...
void _fmpq_poly_sin_cos_series(
    fmpz * s,
    fmpz_t sden,
    fmpz * c,
    fmpz_t cden,
    ...
    slong hlen,
    slong n);
void fmpq_poly_sin_cos_series(
    fmpq_poly_t res1,
    fmpq_poly_t res2,
    const fmpq_poly_t poly,
    slong n);

void _fmpq_poly_sinh_series(
    fmpz * g,
    fmpz_t gden,
    const fmpz * h,
    const fmpz_t hden,
...
void _fmpq_poly_sinh_cosh_series(
    fmpz * s,
    fmpz_t sden,
    fmpz * c,
    fmpz_t cden,
    ...
    slong hlen,
    slong n);
void fmpq_poly_sinh_cosh_series(
    fmpq_poly_t res1,
    fmpq_poly_t res2,
    const fmpq_poly_t poly,
    slong n);

void _fmpq_poly_tanh_series(
    fmpz * g,
    fmpz_t gden,
    const fmpz * h,
    const fmpz_t hden,
...
void _fmpq_poly_interpolate_fmpz_vec(
    fmpz * poly,
    fmpz_t den,
    const fmpz * xs,
    const fmpz * ys,
    slong n);
void fmpq_poly_interpolate_fmpz_vec(
    fmpq_poly_t poly,
    const fmpz * xs,
    const fmpz * ys,
    slong n);
...
void _fmpq_poly_compose(
    ...
    const fmpz_t den2,
    slong len2);
void fmpq_poly_compose(
    fmpq_poly_t res,
    const fmpq_poly_t poly1,
    const fmpq_poly_t poly2);

void _fmpq_poly_rescale(
    fmpz * res,
    fmpz_t denr,
    const fmpz * poly,
    const fmpz_t den,
...
void _fmpq_poly_compose_series_horner(
    fmpz * res,
    fmpz_t den,
    const fmpz * poly1,
    const fmpz_t den1,
...
void _fmpq_poly_compose_series_brent_kung(
    fmpz * res,
    fmpz_t den,
    const fmpz * poly1,
    const fmpz_t den1,
    ...
    slong len2,
    slong n);
void fmpq_poly_compose_series_brent_kung(
    fmpq_poly_t res,
    const fmpq_poly_t poly1,
    const fmpq_poly_t poly2,
    slong n);

void _fmpq_poly_compose_series(
    fmpz * res,
    fmpz_t den,
    const fmpz * poly1,
    const fmpz_t den1,
...
void _fmpq_poly_revert_series_lagrange(
    fmpz * res,
    fmpz_t den,
    const fmpz * poly1,
    const fmpz_t den1,
...
void _fmpq_poly_revert_series_lagrange_fast(
    fmpz * res,
    fmpz_t den,
    const fmpz * poly1,
    const fmpz_t den1,
    slong len1,
    slong n);
void fmpq_poly_revert_series_lagrange_fast(
    fmpq_poly_t res,
    const fmpq_poly_t poly,
    slong n);

void _fmpq_poly_revert_series_newton(
    fmpz * res,
    fmpz_t den,
    const fmpz * poly1,
    const fmpz_t den1,
...
void _fmpq_poly_primitive_part(
    fmpz * rpoly,
    fmpz_t rden,
    const fmpz * poly,
    const fmpz_t den,

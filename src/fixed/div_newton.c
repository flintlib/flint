...
/* Precisions taking a third-order step (below); the others take the
   ...
   mix them freely. */
#ifndef FIXED_INV_NEWTON_3_LOW_MIN
#define FIXED_INV_NEWTON_3_LOW_MIN 24
#endif
#ifndef FIXED_INV_NEWTON_3_LOW_MAX
#define FIXED_INV_NEWTON_3_LOW_MAX 80
#endif
#ifndef FIXED_INV_NEWTON_3_MIN
#define FIXED_INV_NEWTON_3_MIN 1000
#endif

/* Second-order step: T ~= 1/A at m ~ n/2 limbs, Q = T + T (1 - A T). */
static void
_fixed_inv_newton_step2(nn_ptr Q, nn_srcptr A, slong An, slong n)
{
...
static void
_fixed_inv_newton_step3(nn_ptr Q, nn_srcptr A, slong An, slong n)
{
    nn_ptr U, V, T, Ug, SQ;
    nn_srcptr Ahigh;
...
fixed_inv_newton(nn_ptr Q, nn_srcptr A, slong An, slong n)
{
    ...
    else if ((n >= FIXED_INV_NEWTON_3_LOW_MIN && n <= FIXED_INV_NEWTON_3_LOW_MAX)
            || n >= FIXED_INV_NEWTON_3_MIN)
        _fixed_inv_newton_step3(Q, A, An, n);
    else
        _fixed_inv_newton_step2(Q, A, An, n);
}

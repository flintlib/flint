...
{
    return (poly->mod.n == 0) || (poly->length == 2 && poly->coeffs[0] == 0 && poly->coeffs[1] == 1);
}
NMOD_POLY_INLINE
...
NMOD_POLY_INLINE
void nmod_poly_randtest_not_zero(nmod_poly_t poly, flint_rand_t state, slong len) { do
{
    nmod_poly_randtest(poly, state, len); } while (nmod_poly_is_zero(poly));
}
...
void nmod_poly_randtest_monic_irreducible(
    nmod_poly_t poly,
    flint_rand_t state,
    slong len);
...
int nmod_poly_randtest_pentomial_irreducible(
    nmod_poly_t poly,
    flint_rand_t state,
    slong len,
    slong max_attempts);

void nmod_poly_randtest_sparse_irreducible(
    nmod_poly_t poly,
    flint_rand_t state,
    slong len);
...
void nmod_poly_add_series(
    nmod_poly_t res,
    const nmod_poly_t poly1,
...
void _nmod_poly_KS2_recover_reduce1(
    mp_ptr res,
    slong s,
    mp_srcptr op1,
    mp_srcptr op2,
    ...
    ulong b,
    nmod_t mod);
void _nmod_poly_KS2_recover_reduce2(
    mp_ptr res,
    slong s,
    mp_srcptr op1,
    mp_srcptr op2,
    ...
    ulong b,
    nmod_t mod);
void _nmod_poly_KS2_recover_reduce2b(
    mp_ptr res,
    slong s,
    mp_srcptr op1,
    mp_srcptr op2,
    ...
    ulong b,
    nmod_t mod);
void _nmod_poly_KS2_recover_reduce3(
    mp_ptr res,
    slong s,
    mp_srcptr op1,
    mp_srcptr op2,
    ...
    ulong b,
    nmod_t mod);
void _nmod_poly_KS2_recover_reduce(
    mp_ptr res,
    slong s,
    mp_srcptr op1,
    mp_srcptr op2,
...
void _nmod_poly_mul_classical(
    ...
    slong len2,
    nmod_t mod);
void nmod_poly_mul_classical(
    nmod_poly_t res,
    const nmod_poly_t poly1,
    const nmod_poly_t poly2);

void _nmod_poly_mullow_classical(
    mp_ptr res,
    mp_srcptr poly1,
    slong len1,
    mp_srcptr poly2,
    ...
    slong trunc,
    nmod_t mod);
void nmod_poly_mullow_classical(
    nmod_poly_t res,
    const nmod_poly_t poly1,
    const nmod_poly_t poly2,
    slong trunc);

void _nmod_poly_mulhigh_classical(
    mp_ptr res,
    mp_srcptr poly1,
    slong len1,
    mp_srcptr poly2,
    ...
    slong start,
    nmod_t mod);
void nmod_poly_mulhigh_classical(
    nmod_poly_t res,
    const nmod_poly_t poly1,
    const nmod_poly_t poly2,
    slong start);

void _nmod_poly_mul_KS(
    mp_ptr out,
    mp_srcptr in1,
    slong len1,
    mp_srcptr in2,
    ...
    flint_bitcnt_t bits,
    nmod_t mod);
void nmod_poly_mul_KS(
    nmod_poly_t res,
    const nmod_poly_t poly1,
    const nmod_poly_t poly2,
    flint_bitcnt_t bits);

void _nmod_poly_mul_KS2(
    mp_ptr res,
    mp_srcptr op1,
    slong n1,
    mp_srcptr op2,
    slong n2,
    nmod_t mod);
void nmod_poly_mul_KS2(
    nmod_poly_t res,
    const nmod_poly_t poly1,
    const nmod_poly_t poly2);

void _nmod_poly_mul_KS4(
    mp_ptr res,
    mp_srcptr op1,
    slong n1,
    mp_srcptr op2,
    slong n2,
    nmod_t mod);
void nmod_poly_mul_KS4(
    nmod_poly_t res,
    const nmod_poly_t poly1,
    const nmod_poly_t poly2);

void _nmod_poly_mullow_KS(
    mp_ptr out,
    mp_srcptr in1,
    slong len1,
    mp_srcptr in2,
...
void _nmod_poly_mullow(
    ...
    slong trunc,
    nmod_t mod);
void nmod_poly_mullow(
    nmod_poly_t res,
    const nmod_poly_t poly1,
    const nmod_poly_t poly2,
    slong trunc);

void _nmod_poly_mulhigh(
    mp_ptr res,
    mp_srcptr poly1,
    slong len1,
    mp_srcptr poly2,
    ...
    slong n,
    nmod_t mod);
void nmod_poly_mulhigh(
    nmod_poly_t res,
    const nmod_poly_t poly1,
    const nmod_poly_t poly2,
    slong n);

void _nmod_poly_mulmod(
    mp_ptr res,
    mp_srcptr poly1,
    slong len1,
    mp_srcptr poly2,
    ...
    slong lenf,
    nmod_t mod);
void nmod_poly_mulmod(
    nmod_poly_t res,
    const nmod_poly_t poly1,
    const nmod_poly_t poly2,
    const nmod_poly_t f);

void _nmod_poly_mulmod_preinv(
    mp_ptr res,
    mp_srcptr poly1,
    slong len1,
    mp_srcptr poly2,
...
void _nmod_poly_pow_trunc_binexp(
    mp_ptr res,
    mp_srcptr poly,
    ulong e,
    slong trunc,
    nmod_t mod);
void nmod_poly_pow_trunc_binexp(
    nmod_poly_t res,
...
void _nmod_poly_powmod_ui_binexp(
    mp_ptr res,
    mp_srcptr poly,
    ulong e,
    mp_srcptr f,
    slong lenf,
    nmod_t mod);
void nmod_poly_powmod_ui_binexp(
    nmod_poly_t res,
    const nmod_poly_t poly,
    ulong e,
    const nmod_poly_t f);

void _nmod_poly_powmod_fmpz_binexp(
    mp_ptr res,
    mp_srcptr poly,
    fmpz_t e,
    mp_srcptr f,
    slong lenf,
    nmod_t mod);
void nmod_poly_powmod_fmpz_binexp(
    nmod_poly_t res,
    const nmod_poly_t poly,
    fmpz_t e,
    const nmod_poly_t f);
...
void nmod_poly_powmod_ui_binexp_preinv(
    nmod_poly_t res,
    const nmod_poly_t poly,
    ulong e,
    const nmod_poly_t f,
...
void nmod_poly_powmod_fmpz_binexp_preinv(
    nmod_poly_t res,
    const nmod_poly_t poly,
    fmpz_t e,
    const nmod_poly_t f,
...
void nmod_poly_powmod_x_ui_preinv(
    nmod_poly_t res,
    ulong e,
    const nmod_poly_t f,
    const nmod_poly_t finv);
...
void nmod_poly_powmod_x_fmpz_preinv(
    nmod_poly_t res,
    fmpz_t e,
    const nmod_poly_t f,
    const nmod_poly_t finv);

void _nmod_poly_powers_mod_preinv_naive(
    mp_ptr * res,
    mp_srcptr f,
    slong flen,
    slong n,
...
void nmod_poly_powers_mod_naive(
    nmod_poly_struct * res,
    const nmod_poly_t f,
    slong n,
    const nmod_poly_t g);

void _nmod_poly_powers_mod_preinv_threaded_pool(
    mp_ptr * res,
    mp_srcptr f,
    slong flen,
    slong n,
...
void nmod_poly_powers_mod_bsgs(
    nmod_poly_struct * res,
    const nmod_poly_t f,
    slong n,
    const nmod_poly_t g);
...
void _nmod_poly_divrem_basecase_preinv1(
    mp_ptr Q,
    mp_ptr R,
    mp_srcptr A,
    slong A_len,
...
void _nmod_poly_divrem_basecase(
    ...
    slong B_len,
    nmod_t mod);
void nmod_poly_divrem_basecase(
    nmod_poly_t Q,
    nmod_poly_t R,
    const nmod_poly_t A,
    const nmod_poly_t B);

void _nmod_poly_divrem(
    mp_ptr Q,
    mp_ptr R,
    mp_srcptr A,
    slong lenA,
...
void _nmod_poly_inv_series_basecase(
    mp_ptr Qinv,
    mp_srcptr Q,
    slong Qlen,
    slong n,
...
void _nmod_poly_inv_series_newton(
    mp_ptr Qinv,
    mp_srcptr Q,
    slong Qlen,
    slong n,
...
void _nmod_poly_div_series_basecase(
    mp_ptr Q,
    mp_srcptr A,
    slong Alen,
    mp_srcptr B,
    ...
    slong n,
    nmod_t mod);
void nmod_poly_div_series_basecase(
    nmod_poly_t Q,
    const nmod_poly_t A,
    const nmod_poly_t B,
    slong n);
...
void _nmod_poly_div_series(
    ...
    slong n,
    nmod_t mod);
void nmod_poly_div_series(
    nmod_poly_t Q,
    const nmod_poly_t A,
    const nmod_poly_t B,
    slong n);

void _nmod_poly_div_newton_n_preinv(
    mp_ptr Q,
    mp_srcptr A,
    slong lenA,
    mp_srcptr B,
    ...
    slong lenBinv,
    nmod_t mod);
void nmod_poly_div_newton_n_preinv(
    nmod_poly_t Q,
    const nmod_poly_t A,
    const nmod_poly_t B,
...
void nmod_poly_divrem_newton_n_preinv(
    nmod_poly_t Q,
    nmod_poly_t R,
    const nmod_poly_t A,
    const nmod_poly_t B,
...
int _nmod_poly_divides_classical(
    mp_ptr Q,
    mp_srcptr A,
    slong lenA,
    mp_srcptr B,
...
void _nmod_poly_evaluate_nmod_vec(
    mp_ptr ys,
    mp_srcptr coeffs,
    slong len,
    mp_srcptr xs,
    slong n,
    nmod_t mod);
void nmod_poly_evaluate_nmod_vec(
    mp_ptr ys,
    const nmod_poly_t poly,
    mp_srcptr xs,
    slong n);
...
void _nmod_poly_evaluate_nmod_vec_iter(
    ...
    slong n,
    nmod_t mod);
void nmod_poly_evaluate_nmod_vec_iter(
    mp_ptr ys,
    const nmod_poly_t poly,
    mp_srcptr xs,
    slong n);

void _nmod_poly_evaluate_nmod_vec_fast_precomp(
    mp_ptr vs,
    mp_srcptr poly,
    slong plen,
    const mp_ptr * tree,
...
void _nmod_poly_evaluate_nmod_vec_fast(
    mp_ptr ys,
    mp_srcptr coeffs,
    slong len,
    mp_srcptr xs,
    slong n,
    nmod_t mod);
void nmod_poly_evaluate_nmod_vec_fast(
    mp_ptr ys,
    const nmod_poly_t poly,
    mp_srcptr xs,
    slong n);
...
void _nmod_poly_interpolate_nmod_vec_newton(
    mp_ptr poly,
    mp_srcptr xs,
    mp_srcptr ys,
    slong n,
    nmod_t mod);
void nmod_poly_interpolate_nmod_vec_newton(
    nmod_poly_t poly,
    mp_srcptr xs,
    mp_srcptr ys,
    slong n);

void _nmod_poly_interpolate_nmod_vec_barycentric(
    mp_ptr poly,
    mp_srcptr xs,
    mp_srcptr ys,
    slong n,
...
void _nmod_poly_interpolate_nmod_vec(
    mp_ptr poly,
    mp_srcptr xs,
    mp_srcptr ys,
    slong n,
    nmod_t mod);
void nmod_poly_interpolate_nmod_vec(
    nmod_poly_t poly,
    mp_srcptr xs,
    mp_srcptr ys,
    slong n);

void nmod_poly_interpolate_nmod_vec_fast(
    nmod_poly_t poly,
    mp_srcptr xs,
    mp_srcptr ys,
    slong n);
void _nmod_poly_interpolate_nmod_vec_fast(
    mp_ptr poly,
    mp_srcptr xs,
    mp_srcptr ys,
    slong len,
...
void _nmod_poly_interpolate_nmod_vec_fast_precomp(
    mp_ptr poly,
    mp_srcptr ys,
    const mp_ptr * tree,
    mp_srcptr weights,
...
void _nmod_poly_interpolation_weights(
    mp_ptr w,
    const mp_ptr * tree,
    slong len,
    nmod_t mod);
...
void _nmod_poly_compose_horner(
    mp_ptr res,
    mp_srcptr poly1,
    slong len1,
    mp_srcptr poly2,
    slong len2,
    nmod_t mod);
void nmod_poly_compose_horner(
    nmod_poly_t res,
    const nmod_poly_t poly1,
    const nmod_poly_t poly2);

void _nmod_poly_compose(
    mp_ptr res,
    mp_srcptr poly1,
    slong len1,
    mp_srcptr poly2,
...
void _nmod_poly_compose_mod_brent_kung(
    ...
    slong lenh,
    nmod_t mod);
void nmod_poly_compose_mod_brent_kung(
    nmod_poly_t res,
    const nmod_poly_t f,
    const nmod_poly_t g,
    const nmod_poly_t h);

void _nmod_poly_reduce_matrix_mod_poly(
    nmod_mat_t A,
    const nmod_mat_t B,
    const nmod_poly_t f);
...
void _nmod_poly_precompute_matrix(
    ...
    slong len2inv,
    nmod_t mod);
void nmod_poly_precompute_matrix(
    nmod_mat_t A,
    const nmod_poly_t poly1,
    const nmod_poly_t poly2,
    const nmod_poly_t poly2inv);

void _nmod_poly_compose_mod_brent_kung_precomp_preinv_worker(void * arg_ptr);
void _nmod_poly_compose_mod_brent_kung_precomp_preinv(
    mp_ptr res,
    mp_srcptr poly1,
    slong len1,
    const nmod_mat_t A,
    ...
    slong len3inv,
    nmod_t mod);
void nmod_poly_compose_mod_brent_kung_precomp_preinv(
    nmod_poly_t res,
    const nmod_poly_t poly1,
    const nmod_mat_t A,
    const nmod_poly_t poly3,
    const nmod_poly_t poly3inv);

void _nmod_poly_compose_mod_brent_kung_preinv(
    mp_ptr res,
    mp_srcptr poly1,
    slong len1,
    mp_srcptr poly2,
    ...
    slong len3inv,
    nmod_t mod);
void nmod_poly_compose_mod_brent_kung_preinv(
    nmod_poly_t res,
    const nmod_poly_t poly1,
    const nmod_poly_t poly2,
    const nmod_poly_t poly3,
...
void _nmod_poly_compose_mod_horner(
    mp_ptr res,
    mp_srcptr f,
    slong lenf,
    mp_srcptr g,
    ...
    slong lenh,
    nmod_t mod);
void nmod_poly_compose_mod_horner(
    nmod_poly_t res,
    const nmod_poly_t f,
    const nmod_poly_t g,
    const nmod_poly_t h);

void _nmod_poly_compose_mod(
    mp_ptr res,
    mp_srcptr f,
    slong lenf,
    mp_srcptr g,
...
void _nmod_poly_compose_series(
    mp_ptr res,
    mp_srcptr poly1,
    slong len1,
    mp_srcptr poly2,
...
NMOD_POLY_INLINE
slong nmod_poly_hamming_weight(const nmod_poly_t A)
{
...
slong _nmod_poly_gcd_euclidean(
    mp_ptr G,
    mp_srcptr A,
    slong lenA,
    mp_srcptr B,
...
slong _nmod_poly_hgcd_recursive(
    mp_ptr * M,
    slong * lenM,
    mp_ptr A,
    slong * lenA,
...
slong _nmod_poly_xgcd_euclidean(
    mp_ptr res,
    mp_ptr s,
    mp_ptr t,
    mp_srcptr poly1,
...
mp_limb_t _nmod_poly_resultant_euclidean(
    mp_srcptr poly1,
    slong len1,
    mp_srcptr poly2,
    slong len2,
...
mp_limb_t _nmod_poly_resultant_hgcd(
    mp_srcptr A,
    slong lenA,
    mp_srcptr B,
    slong lenB,
...
mp_limb_t _nmod_poly_resultant(
    mp_srcptr A,
    slong lenA,
    mp_srcptr B,
    slong lenB,
...
void _nmod_poly_power_sums_naive(
    mp_ptr res,
    mp_srcptr poly,
    slong len,
    slong n,
...
void _nmod_poly_power_sums_schoenhage(
    mp_ptr res,
    mp_srcptr poly,
    slong len,
    slong n,
...
void _nmod_poly_power_sums_to_poly_naive(
    mp_ptr res,
    mp_srcptr poly,
    slong len,
    nmod_t mod);
...
void _nmod_poly_power_sums_to_poly_schoenhage(
    mp_ptr res,
    mp_srcptr poly,
    slong len,
    nmod_t mod);
...
void  _nmod_poly_exp_expinv_series(
    mp_ptr f,
    mp_ptr g,
    mp_srcptr h,
    slong hlen,
...
void nmod_poly_multi_crt_precomp(
    nmod_poly_t output,
    const nmod_poly_multi_crt_t CRT,

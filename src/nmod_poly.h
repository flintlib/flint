...
ulong _nmod_poly_evaluate_nmod_shoup(nn_srcptr poly, slong len, ulong c, ulong c_precomp, nmod_t mod);
ulong _nmod_poly_evaluate_nmod_shoup_lazy(nn_srcptr poly, slong len, ulong c, ulong c_precomp, nmod_t mod);

...
void _nmod_poly_add(nn_ptr res, nn_srcptr poly1, slong len1,
...
void _nmod_poly_sub(nn_ptr res, nn_srcptr poly1, slong len1,
                                      nn_srcptr poly2, slong len2, nmod_t mod);
...
void _nmod_poly_KS2_pack1(nn_ptr res, nn_srcptr op, slong n, slong s,
                                                    ulong b, ulong k, slong r);

void _nmod_poly_KS2_pack(nn_ptr res, nn_srcptr op, slong n, slong s,
                                                    ulong b, ulong k, slong r);

void _nmod_poly_KS2_unpack1(nn_ptr res, nn_srcptr op, slong n, ulong b,
                                                                      ulong k);

void _nmod_poly_KS2_unpack2(nn_ptr res, nn_srcptr op, slong n, ulong b,
                                                                      ulong k);

void _nmod_poly_KS2_unpack3(nn_ptr res, nn_srcptr op, slong n, ulong b,
                                                                      ulong k);

void _nmod_poly_KS2_unpack(nn_ptr res, nn_srcptr op, slong n, ulong b,
                                                                      ulong k);

void _nmod_poly_KS2_reduce(nn_ptr res, slong s, nn_srcptr op,
                                                 slong n, ulong w, nmod_t mod);

void _nmod_poly_KS2_recover_reduce1(nn_ptr res, slong s, nn_srcptr op1,
                                  nn_srcptr op2, slong n, ulong b, nmod_t mod);

void _nmod_poly_KS2_recover_reduce2(nn_ptr res, slong s, nn_srcptr op1,
                                  nn_srcptr op2, slong n, ulong b, nmod_t mod);

void _nmod_poly_KS2_recover_reduce2b(nn_ptr res, slong s, nn_srcptr op1,
                                  nn_srcptr op2, slong n, ulong FLINT_UNUSED(b), nmod_t mod);

void _nmod_poly_KS2_recover_reduce3(nn_ptr res, slong s, nn_srcptr op1,
                                  nn_srcptr op2, slong n, ulong b, nmod_t mod);

void _nmod_poly_KS2_recover_reduce(nn_ptr res, slong s, nn_srcptr op1,
                                  nn_srcptr op2, slong n, ulong b, nmod_t mod);

void _nmod_poly_bit_pack(nn_ptr res, nn_srcptr poly,
                                                  slong len, flint_bitcnt_t bits);

void _nmod_poly_bit_unpack(nn_ptr res, slong len,
                                  nn_srcptr mpn, flint_bitcnt_t bits, nmod_t mod);
...
void _nmod_poly_mul_classical(nn_ptr res, nn_srcptr poly1, slong len1,
                                       nn_srcptr poly2, slong len2, nmod_t mod);

void nmod_poly_mul_classical(nmod_poly_t res,
                             const nmod_poly_t poly1, const nmod_poly_t poly2);

void _nmod_poly_mullow_classical(nn_ptr res, nn_srcptr poly1, slong len1,
                           nn_srcptr poly2, slong len2, slong trunc, nmod_t mod);

void nmod_poly_mullow_classical(nmod_poly_t res,
                  const nmod_poly_t poly1, const nmod_poly_t poly2, slong trunc);

void _nmod_poly_mulhigh_classical(nn_ptr res, nn_srcptr poly1, slong len1,
                           nn_srcptr poly2, slong len2, slong start, nmod_t mod);

void nmod_poly_mulhigh_classical(nmod_poly_t res,
                  const nmod_poly_t poly1, const nmod_poly_t poly2, slong start);

void _nmod_poly_mul_KS(nn_ptr out, nn_srcptr in1, slong len1,
...
void _nmod_poly_mul_KS2(nn_ptr res, nn_srcptr op1, slong n1,
                                            nn_srcptr op2, slong n2, nmod_t mod);

void nmod_poly_mul_KS2(nmod_poly_t res,
                               const nmod_poly_t poly1, const nmod_poly_t poly2);

void _nmod_poly_mul_KS4(nn_ptr res, nn_srcptr op1, slong n1,
                                            nn_srcptr op2, slong n2, nmod_t mod);

void nmod_poly_mul_KS4(nmod_poly_t res,
                               const nmod_poly_t poly1, const nmod_poly_t poly2);

void _nmod_poly_mullow_KS(nn_ptr out, nn_srcptr in1, slong len1,
               nn_srcptr in2, slong len2, flint_bitcnt_t bits, slong n, nmod_t mod);
...
void _nmod_poly_pow_binexp(nn_ptr res,
                              nn_srcptr poly, slong len, ulong e, nmod_t mod);
...
void _nmod_poly_powmod_ui_binexp(nn_ptr res, nn_srcptr poly,
...
void _nmod_poly_powmod_fmpz_binexp(nn_ptr res, nn_srcptr poly,
                                fmpz_t e, nn_srcptr f, slong lenf, nmod_t mod);

void _nmod_poly_powmod_ui_binexp_preinv (nn_ptr res, nn_srcptr poly,
                                    ulong e, nn_srcptr f, slong lenf,
...
void _nmod_poly_powmod_fmpz_binexp_preinv (nn_ptr res, nn_srcptr poly,
                                    fmpz_t e, nn_srcptr f, slong lenf,
                                    nn_srcptr finv, slong lenfinv, nmod_t mod);
...
void _nmod_poly_powmod_x_ui_preinv (nn_ptr res, ulong e, nn_srcptr f, slong lenf,
                               nn_srcptr finv, slong lenfinv, nmod_t mod);

void nmod_poly_powmod_x_ui_preinv(nmod_poly_t res, ulong e, const nmod_poly_t f,
                             const nmod_poly_t finv);

void _nmod_poly_powmod_x_fmpz_preinv (nn_ptr res, fmpz_t e, nn_srcptr f, slong lenf,
                               nn_srcptr finv, slong lenfinv, nmod_t mod);
...
void _nmod_poly_divrem_basecase_preinv1(nn_ptr Q, nn_ptr R,
               nn_srcptr A, slong A_len, nn_srcptr B, slong B_len, ulong invB, nmod_t mod);

void _nmod_poly_divrem_basecase(nn_ptr Q, nn_ptr R,
               nn_srcptr A, slong A_len, nn_srcptr B, slong B_len, nmod_t mod);

void nmod_poly_divrem_basecase(nmod_poly_t Q, nmod_poly_t R,
                                     const nmod_poly_t A, const nmod_poly_t B);

void _nmod_poly_divrem(nn_ptr Q, nn_ptr R, nn_srcptr A, slong lenA,
                                          nn_srcptr B, slong lenB, nmod_t mod);

void nmod_poly_divrem(nmod_poly_t Q, nmod_poly_t R,
                                     const nmod_poly_t A, const nmod_poly_t B);

void _nmod_poly_div(nn_ptr Q, nn_srcptr A, slong lenA,
                                          nn_srcptr B, slong lenB, nmod_t mod);
...
void _nmod_poly_divexact(nn_ptr Q, nn_srcptr A, slong lenA,
                                          nn_srcptr B, slong lenB, nmod_t mod);
...
void _nmod_poly_div_series_basecase(nn_ptr Q, nn_srcptr A,
                     slong Alen, nn_srcptr B, slong Blen, slong n, nmod_t mod);

void nmod_poly_div_series_basecase(nmod_poly_t Q,
                            const nmod_poly_t A, const nmod_poly_t B, slong n);

void _nmod_poly_div_series(nn_ptr Q, nn_srcptr A, slong Alen,
...
void _nmod_poly_divrem_newton_n_preinv (nn_ptr Q,
         nn_ptr R, nn_srcptr A, slong lenA, nn_srcptr B, slong lenB,
                                    nn_srcptr Binv, slong lenBinv, nmod_t mod);

void nmod_poly_divrem_newton_n_preinv(nmod_poly_t Q, nmod_poly_t R,
             const nmod_poly_t A, const nmod_poly_t B, const nmod_poly_t Binv);

ulong _nmod_poly_div_root(nn_ptr Q,
                              nn_srcptr A, slong len, ulong c, nmod_t mod);

ulong nmod_poly_div_root(nmod_poly_t Q,
...
void _nmod_poly_derivative(nn_ptr x_prime,
                                           nn_srcptr x, slong len, nmod_t mod);

void nmod_poly_derivative(nmod_poly_t x_prime, const nmod_poly_t x);

void _nmod_poly_integral(nn_ptr
                                    x_int, nn_srcptr x, slong len, nmod_t mod);

void nmod_poly_integral(nmod_poly_t x_int, const nmod_poly_t x);

/* Evaluation  ***************************************************************/

ulong _nmod_poly_evaluate_nmod(nn_srcptr poly,
                                           slong len, ulong c, nmod_t mod);

ulong nmod_poly_evaluate_nmod(const nmod_poly_t poly,
                                                                  ulong c);

void _nmod_poly_evaluate_nmod_vec(nn_ptr ys,
               nn_srcptr coeffs, slong len, nn_srcptr xs, slong n, nmod_t mod);

void nmod_poly_evaluate_nmod_vec(nn_ptr ys,
                                const nmod_poly_t poly, nn_srcptr xs, slong n);

void _nmod_poly_evaluate_nmod_vec_iter(nn_ptr ys,
               nn_srcptr coeffs, slong len, nn_srcptr xs, slong n, nmod_t mod);

void nmod_poly_evaluate_nmod_vec_iter(nn_ptr ys,
                                const nmod_poly_t poly, nn_srcptr xs, slong n);

void _nmod_poly_evaluate_nmod_vec_fast_precomp(nn_ptr vs,
       nn_srcptr poly, slong plen, const nn_ptr * tree, slong len, nmod_t mod);

void _nmod_poly_evaluate_nmod_vec_fast(nn_ptr ys,
               nn_srcptr coeffs, slong len, nn_srcptr xs, slong n, nmod_t mod);

void nmod_poly_evaluate_nmod_vec_fast(nn_ptr ys,
                                const nmod_poly_t poly, nn_srcptr xs, slong n);
...
void _nmod_poly_tree_build(nn_ptr * tree, nn_srcptr roots,
    slong len, nmod_t mod);

/* Interpolation  ************************************************************/

void _nmod_poly_interpolate_nmod_vec_newton(nn_ptr poly, nn_srcptr xs,
...
void _nmod_poly_interpolate_nmod_vec_barycentric(nn_ptr poly, nn_srcptr xs,
                        nn_srcptr ys, slong n, nmod_t mod);

void nmod_poly_interpolate_nmod_vec_barycentric(nmod_poly_t poly,
                        nn_srcptr xs, nn_srcptr ys, slong n);

void _nmod_poly_interpolate_nmod_vec(nn_ptr poly, nn_srcptr xs,
                        nn_srcptr ys, slong n, nmod_t mod);
...
void _nmod_poly_interpolate_nmod_vec_fast(nn_ptr poly,
...
void _nmod_poly_interpolation_weights(nn_ptr w, const nn_ptr * tree,
    slong len, nmod_t mod);

/* Composition  **************************************************************/

void _nmod_poly_compose_horner(nn_ptr res, nn_srcptr poly1,
                            slong len1, nn_srcptr poly2, slong len2, nmod_t mod);

void nmod_poly_compose_horner(nmod_poly_t res,
                             const nmod_poly_t poly1, const nmod_poly_t poly2);

void _nmod_poly_compose(nn_ptr res, nn_srcptr poly1, slong len1,
                                       nn_srcptr poly2, slong len2, nmod_t mod);
...
void _nmod_poly_taylor_shift_horner(nn_ptr poly, ulong c,
    slong len, nmod_t mod);

void nmod_poly_taylor_shift_horner(nmod_poly_t g,
    const nmod_poly_t f, ulong c);

void _nmod_poly_taylor_shift_convolution(nn_ptr poly, ulong c,
    slong len, nmod_t mod);
...
void _nmod_poly_compose_mod_brent_kung(nn_ptr res, nn_srcptr f, slong lenf,
                            nn_srcptr g, nn_srcptr h, slong lenh, nmod_t mod);
...
void _nmod_poly_compose_mod_horner(nn_ptr res,
...
void _nmod_poly_compose_mod(nn_ptr res, nn_srcptr f, slong lenf,
                            nn_srcptr g,
                            nn_srcptr h, slong lenh, nmod_t mod);
...
void _nmod_poly_compose_series(nn_ptr res, nn_srcptr poly1, slong len1,
                            nn_srcptr poly2, slong len2, slong n, nmod_t mod);
...
slong _nmod_poly_xgcd_euclidean(nn_ptr res, nn_ptr s, nn_ptr t,
           nn_srcptr poly1, slong len1, nn_srcptr poly2, slong len2, nmod_t mod);
...
ulong _nmod_poly_resultant_euclidean(nn_srcptr poly1, slong len1,
                               nn_srcptr poly2, slong len2, nmod_t mod);

ulong nmod_poly_resultant_euclidean(const nmod_poly_t f, const nmod_poly_t g);

ulong _nmod_poly_resultant_hgcd(nn_srcptr A, slong lenA,
                         nn_srcptr B, slong lenB, nmod_t mod);

ulong nmod_poly_resultant_hgcd(const nmod_poly_t A, const nmod_poly_t B);

ulong _nmod_poly_resultant(nn_srcptr A, slong lenA,
                         nn_srcptr B, slong lenB, nmod_t mod);
...
void _nmod_poly_product_roots_nmod_vec(nn_ptr poly,
...
int nmod_poly_find_distinct_nonzero_roots(ulong * roots,
                                                          const nmod_poly_t P);

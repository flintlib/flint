...
TEST_FUNCTION_START(gr_poly_xgcd_euclidean, state)
{
    ...
    for (i = 0; i < 1000 * flint_test_multiplier(); i++)
    {
        ...
        {
            case 0:
                status |= gr_poly_xgcd_euclidean(g, s, t, a, b, ctx);
                break;
            case 1:
                status |= gr_poly_set(g, a, ctx);
                status |= gr_poly_xgcd_euclidean(g, s, t, g, b, ctx);
                break;
            case 2:
                status |= gr_poly_set(s, a, ctx);
                status |= gr_poly_xgcd_euclidean(g, s, t, s, b, ctx);
                break;
            case 3:
                status |= gr_poly_set(t, a, ctx);
                status |= gr_poly_xgcd_euclidean(g, s, t, t, b, ctx);
                break;
            case 4:
                status |= gr_poly_set(g, b, ctx);
                status |= gr_poly_xgcd_euclidean(g, s, t, a, g, ctx);
                break;
            case 5:
                status |= gr_poly_set(s, b, ctx);
                status |= gr_poly_xgcd_euclidean(g, s, t, a, s, ctx);
                break;
            case 6:
                status |= gr_poly_set(t, b, ctx);
                status |= gr_poly_xgcd_euclidean(g, s, t, a, t, ctx);
                break;
            case 7:
                status |= gr_poly_set(b, a, ctx);
                status |= gr_poly_xgcd_euclidean(g, s, t, a, a, ctx);
                break;
            default:
                break;
        }

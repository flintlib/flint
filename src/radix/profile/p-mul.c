...
int main()
{
    ...
    flint_printf("    digits    limbs    limbs  flint_mpn_mul  radix_mul  time\n\n");
    ...
    for (nd = 1; nd <= 100000000; nd = FLINT_MAX(nd + 1, nd * 1.5))
    {
        ...
        flint_mpn_urandomb(a, state, n1);
        flint_mpn_urandomb(b, state, n1);

        flint_mpn_mul(c, a, n1, b, n1);
        TIMEIT_START;
        flint_mpn_mul(c, a, n1, b, n1);

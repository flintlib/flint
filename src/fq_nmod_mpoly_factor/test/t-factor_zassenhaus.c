...
TEST_FUNCTION_START(fq_nmod_mpoly_factor_zassenhaus, state)
{
    slong i, j, tmul = 15;
    ...
    for (i = 0; i < tmul * flint_test_multiplier(); i++)
    {
        ...
        check_omega(lower, WORD_MAX, a, ctx, fq_nmod_mpoly_factor_zassenhaus);

...
#define SIQS_INIT_ALLOC_SIZE (1 << 22) /* 4 MB */

    qs_inf->siqs = flint_malloc(sizeof(char) * SIQS_INIT_ALLOC_SIZE);
    qs_inf->siqs_cur = qs_inf->siqs;
    qs_inf->siqs_alloc = SIQS_INIT_ALLOC_SIZE;
    qs_inf->siqs_size = 0;

#undef SIQS_INIT_ALLOC_SIZE

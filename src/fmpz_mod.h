...
void fmpz_mod_assert_canonical(const fmpz_t a,
...
int fmpz_mod_equal_fmpz(const fmpz_t a, const fmpz_t b,
                                                     const fmpz_mod_ctx_t ctx);

int fmpz_mod_equal_si(const fmpz_t a, slong b,
                                                     const fmpz_mod_ctx_t ctx);

void fmpz_mod_set_fmpz(fmpz_t a, const fmpz_t b,
                                                     const fmpz_mod_ctx_t ctx);
...
void fmpz_mod_neg(fmpz_t a, const fmpz_t b,
                                                     const fmpz_mod_ctx_t ctx);
...
void fmpz_mod_addmul(fmpz_t a, const fmpz_t b, const fmpz_t c,
...
void fmpz_mod_inv(fmpz_t a, const fmpz_t b,
                                                     const fmpz_mod_ctx_t ctx);
...
void fmpz_mod_rand(fmpz_t a, flint_rand_t state,
                                                     const fmpz_mod_ctx_t ctx);

void fmpz_mod_rand_not_zero(fmpz_t a, flint_rand_t state,
                                                     const fmpz_mod_ctx_t ctx);
...
void fmpz_mod_discrete_log_pohlig_hellman_init(
                    fmpz_mod_discrete_log_pohlig_hellman_t L);

void fmpz_mod_discrete_log_pohlig_hellman_clear(
                    fmpz_mod_discrete_log_pohlig_hellman_t L);

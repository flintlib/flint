...
void fmpz_mod_mat_window_init(
    fmpz_mod_mat_t window,
    const fmpz_mod_mat_t mat,
    slong r1,
    slong c1,
    slong r2,
    slong c2);
...
void fmpz_mod_mat_concat_horizontal(
    fmpz_mod_mat_t res,
...
void _fmpz_mod_mat_mul_classical_threaded_pool_op(
    ...
    slong num_threads);
void fmpz_mod_mat_mul_classical_threaded(
    fmpz_mod_mat_t C,
    const fmpz_mod_mat_t A,
    const fmpz_mod_mat_t B);
...
void fmpz_mod_mat_submul(
    fmpz_mod_mat_t D,
    const fmpz_mod_mat_t C,
    const fmpz_mod_mat_t A,
    const fmpz_mod_mat_t B);

void fmpz_mod_mat_mul_fmpz_vec(
    fmpz * c,
    const fmpz_mod_mat_t A,
    const fmpz * b,
    slong blen);
void fmpz_mod_mat_mul_fmpz_vec_ptr(
    fmpz * const * c,
    const fmpz_mod_mat_t A,
    const fmpz * const * b,
    slong blen);

void fmpz_mod_mat_fmpz_vec_mul(
    fmpz * c,
    const fmpz * a,
    slong alen,
    const fmpz_mod_mat_t B);
void fmpz_mod_mat_fmpz_vec_mul_ptr(
    fmpz * const * c,
    const fmpz * const * a,
    slong alen,
    const fmpz_mod_mat_t B);
...
slong _fmpz_mod_mat_reduce_row(
    fmpz_mod_mat_t A,
    slong * P,
    slong * L,
    slong m,
...
void fmpz_mod_mat_solve_triu(
    fmpz_mod_mat_t X,
    const fmpz_mod_mat_t L,
    const fmpz_mod_mat_t B,
    int unit);
void fmpz_mod_mat_solve_triu_classical(
    fmpz_mod_mat_t X,
    const fmpz_mod_mat_t L,
    const fmpz_mod_mat_t B,
    int unit);
void fmpz_mod_mat_solve_triu_recursive(
    fmpz_mod_mat_t X,
    const fmpz_mod_mat_t L,
    const fmpz_mod_mat_t B,
    int unit);

void fmpz_mod_mat_solve_tril(
    fmpz_mod_mat_t X,
    const fmpz_mod_mat_t L,
    const fmpz_mod_mat_t B,
    int unit);
void fmpz_mod_mat_solve_tril_classical(
    fmpz_mod_mat_t X,
    const fmpz_mod_mat_t L,
    const fmpz_mod_mat_t B,
    int unit);
void fmpz_mod_mat_solve_tril_recursive(
    fmpz_mod_mat_t X,
    const fmpz_mod_mat_t L,
    const fmpz_mod_mat_t B,
    int unit);

int fmpz_mod_mat_can_solve(
    fmpz_mod_mat_t X,
    const fmpz_mod_mat_t A,
    const fmpz_mod_mat_t B);

...
FMPZ_MOD_MAT_INLINE fmpz * fmpz_mod_mat_entry(const fmpz_mod_mat_t mat, slong i, slong j) { return mat->mat->rows[i] + j; }
FMPZ_MOD_MAT_INLINE slong fmpz_mod_mat_nrows(const fmpz_mod_mat_t mat) { return mat->mat->r; }
FMPZ_MOD_MAT_INLINE slong fmpz_mod_mat_ncols(const fmpz_mod_mat_t mat) { return mat->mat->c; }
...
{
    return fmpz_mod_mat_nrows(mat) == 0 || fmpz_mod_mat_ncols(mat) == 0;
}

FMPZ_MOD_MAT_INLINE
int fmpz_mod_mat_is_square(const fmpz_mod_mat_t mat)
{
    return fmpz_mod_mat_nrows(mat) == fmpz_mod_mat_ncols(mat);
}
...
void fmpz_mod_mat_submul(fmpz_mod_mat_t D, const fmpz_mod_mat_t C, const fmpz_mod_mat_t A, const fmpz_mod_mat_t B);
...
slong _fmpz_mod_mat_reduce_row(fmpz_mod_mat_t A, slong * P, slong * L, slong m, const fmpz_mod_ctx_t ctx);
slong fmpz_mod_mat_reduce_row(fmpz_mod_mat_t A, slong * P, slong * L, slong m);
...
void fmpz_mod_mat_solve_triu(fmpz_mod_mat_t X, const fmpz_mod_mat_t L, const fmpz_mod_mat_t B, int unit);
void fmpz_mod_mat_solve_triu_classical(fmpz_mod_mat_t X, const fmpz_mod_mat_t L, const fmpz_mod_mat_t B, int unit);
void fmpz_mod_mat_solve_triu_recursive(fmpz_mod_mat_t X, const fmpz_mod_mat_t L, const fmpz_mod_mat_t B, int unit);

void fmpz_mod_mat_solve_tril(fmpz_mod_mat_t X, const fmpz_mod_mat_t L, const fmpz_mod_mat_t B, int unit);
void fmpz_mod_mat_solve_tril_classical(fmpz_mod_mat_t X, const fmpz_mod_mat_t L, const fmpz_mod_mat_t B, int unit);
void fmpz_mod_mat_solve_tril_recursive(fmpz_mod_mat_t X, const fmpz_mod_mat_t L, const fmpz_mod_mat_t B, int unit);

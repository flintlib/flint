...
TEST_FUNCTION_START(fmpz_poly_evaluate_fmpq, state)
{
    int i, result;
    ...
    for (i = 0; i < 200 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_poly_evaluate_fmpq(y, f, x);
        fmpz_poly_evaluate_fmpq(x, f, x);
    ...
    for (i = 0; i < 200 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_poly_evaluate_fmpq(y, f, x);
        fmpz_poly_evaluate_fmpq(z, g, x);
        fmpq_add(y, y, z);
        fmpz_poly_add(f, f, g);
        fmpz_poly_evaluate_fmpq(z, f, x);

...
TEST_FUNCTION_START(fmpz_poly_sqr_classical, state)
{
    int i, result;
    ...
    for (i = 0; i < 200 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_poly_sqr_classical(a, b);
        fmpz_poly_sqr_classical(b, b);
    ...
    for (i = 0; i < 200 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_poly_sqr_classical(c, b);
        fmpz_poly_mul_classical(b, b, b);

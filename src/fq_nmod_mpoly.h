...
void fq_nmod_mpoly_ctx_init(
    fq_nmod_mpoly_ctx_t ctx,
    slong nvars,
    const ordering_t ord,
    const fq_nmod_ctx_t fqctx);
void fq_nmod_mpoly_ctx_init_deg(
    fq_nmod_mpoly_ctx_t ctx,
    slong nvars,
    const ordering_t ord,
    mp_limb_t p,
    slong deg);
void fq_nmod_mpoly_ctx_init_rand(
    fq_nmod_mpoly_ctx_t ctx,
    flint_rand_t state,
    slong max_nvars,
...
FQ_NMOD_MPOLY_INLINE
void fq_nmod_mpoly_truncate(fq_nmod_mpoly_t A, slong newlen, const fq_nmod_mpoly_ctx_t ctx)
{
...
int fq_nmod_mpoly_set_str_pretty(
    fq_nmod_mpoly_t A,
    const char * str,
    const char ** x,
    const fq_nmod_mpoly_ctx_t ctx);
char * fq_nmod_mpoly_get_str_pretty(
...
int fq_nmod_mpoly_print_pretty(
    const fq_nmod_mpoly_t A,
    const char ** x,
    const fq_nmod_mpoly_ctx_t ctx);
...
void fq_nmod_mpoly_get_coeff_fq_nmod_ui(
    fq_nmod_t c,
    const fq_nmod_mpoly_t A,
    const ulong * exp,
    const fq_nmod_mpoly_ctx_t ctx);
...
void fq_nmod_mpoly_set_coeff_fq_nmod_ui(
    fq_nmod_mpoly_t A,
    const fq_nmod_t c,
    const ulong * exp,
    const fq_nmod_mpoly_ctx_t ctx);
...
void fq_nmod_mpoly_set_coeff_fq_nmod_fmpz(
    ...
    fmpz * const * exp,
    const fq_nmod_mpoly_ctx_t ctx);
void fq_nmod_mpoly_set_coeff_fq_nmod_monomial(
    fq_nmod_mpoly_t A,
    const fq_nmod_t c,
    const fq_nmod_mpoly_t M,
    const fq_nmod_mpoly_ctx_t ctx);
...
FQ_NMOD_MPOLY_INLINE
mp_limb_t * _fq_nmod_mpoly_leadcoeff(const fq_nmod_mpoly_t A, const fq_nmod_mpoly_ctx_t ctx)
{
...
{
    return A->length > 0 && _n_fq_is_one(A->coeffs + 0, fq_nmod_ctx_degree(ctx->fqctx));
}
...
void fq_nmod_mpoly_get_term_coeff_fq_nmod(
    ...
    slong i,
    const fq_nmod_mpoly_ctx_t ctx);
void fq_nmod_mpoly_set_term_coeff_fq_nmod(
    fq_nmod_mpoly_t A,
    slong i,
    const fq_nmod_t c,
    const fq_nmod_mpoly_ctx_t ctx);
...
void fq_nmod_mpoly_get_term_exp_si(
    slong * exp,
    const fq_nmod_mpoly_t A,
    slong i,
    const fq_nmod_mpoly_ctx_t ctx);
void fq_nmod_mpoly_get_term_exp_ui(
    ulong * exp,
    const fq_nmod_mpoly_t A,
    slong i,
    const fq_nmod_mpoly_ctx_t ctx);
void fq_nmod_mpoly_get_term_exp_fmpz(
    fmpz ** exp,
    const fq_nmod_mpoly_t A,
    slong i,
    const fq_nmod_mpoly_ctx_t ctx);

slong fq_nmod_mpoly_get_term_var_exp_si(
    const fq_nmod_mpoly_t A,
    slong i,
    slong var,
    const fq_nmod_mpoly_ctx_t ctx);
ulong fq_nmod_mpoly_get_term_var_exp_ui(
    const fq_nmod_mpoly_t A,
    slong i,
    slong var,
    const fq_nmod_mpoly_ctx_t ctx);

void fq_nmod_mpoly_set_term_exp_ui(
    fq_nmod_mpoly_t A,
    slong i,
    const ulong * exp,
    const fq_nmod_mpoly_ctx_t ctx);
void fq_nmod_mpoly_set_term_exp_fmpz(
    fq_nmod_mpoly_t A,
    slong i,
    fmpz * const * exp,
    const fq_nmod_mpoly_ctx_t ctx);

void fq_nmod_mpoly_get_term(
    fq_nmod_mpoly_t M,
    const fq_nmod_mpoly_t A,
    slong i,
    const fq_nmod_mpoly_ctx_t ctx);
...
void fq_nmod_mpoly_push_term_fq_nmod_fmpz(
    ...
    fmpz * const * exp,
    const fq_nmod_mpoly_ctx_t ctx);
void fq_nmod_mpoly_push_term_fq_nmod_ffmpz(
    fq_nmod_mpoly_t A,
    const fq_nmod_t c,
    const fmpz * exp,
    const fq_nmod_mpoly_ctx_t ctx);
...
void fq_nmod_mpoly_randtest_bound(
    ...
    ulong exp_bound,
    const fq_nmod_mpoly_ctx_t ctx);
void fq_nmod_mpoly_randtest_bounds(
    fq_nmod_mpoly_t A,
    flint_rand_t state,
    slong length,
    ulong * exp_bounds,
...
void _fq_nmod_mpoly_eval_all_fq_nmod(
    ...
    const fq_nmod_ctx_t fqctx);
void fq_nmod_mpoly_evaluate_all_fq_nmod(
    fq_nmod_t ev,
    const fq_nmod_mpoly_t A,
    fq_nmod_struct * const * vals,
    const fq_nmod_mpoly_ctx_t ctx);

int fq_nmod_mpoly_compose_fq_nmod_poly(
    fq_nmod_poly_t A,
    const fq_nmod_mpoly_t B,
    fq_nmod_poly_struct * const * C,
    const fq_nmod_mpoly_ctx_t ctx);
...
int fq_nmod_mpoly_compose_fq_nmod_mpoly_geobucket(
    fq_nmod_mpoly_t A,
    const fq_nmod_mpoly_t B,
    fq_nmod_mpoly_struct * const * C,
    const fq_nmod_mpoly_ctx_t ctxB,
    const fq_nmod_mpoly_ctx_t ctxAC);
int fq_nmod_mpoly_compose_fq_nmod_mpoly_horner(
    fq_nmod_mpoly_t A,
    const fq_nmod_mpoly_t B,
    fq_nmod_mpoly_struct * const * C,
    const fq_nmod_mpoly_ctx_t ctxB,
...
void fq_nmod_mpoly_mul_johnson(
    ...
    const fq_nmod_mpoly_t poly3,
    const fq_nmod_mpoly_ctx_t ctx);
void fq_nmod_mpoly_mul(
    fq_nmod_mpoly_t A,
    const fq_nmod_mpoly_t B,
    const fq_nmod_mpoly_t C,
    const fq_nmod_mpoly_ctx_t ctx);
...
void fq_nmod_mpoly_divrem_ideal_monagan_pearce(
    ...
    fq_nmod_mpoly_t r,
    const fq_nmod_mpoly_t poly2,
    fq_nmod_mpoly_struct * const * poly3,
    slong len,
    const fq_nmod_mpoly_ctx_t ctx);
void fq_nmod_mpoly_divrem_ideal(
    fq_nmod_mpoly_struct ** Q,
    fq_nmod_mpoly_t R,
    const fq_nmod_mpoly_t A,
...
FQ_NMOD_MPOLY_INLINE
void fq_nmod_mpoly_divexact(fq_nmod_mpoly_t Q, const fq_nmod_mpoly_t A, const fq_nmod_mpoly_t B, const fq_nmod_mpoly_ctx_t ctx)
{
    if (fq_nmod_mpoly_divides(Q, A, B, ctx)) return; else flint_throw(FLINT_ERROR, "fq_nmod_mpoly_divexact: nonexact division");
}

/* Square root ***************************************************************/

int fq_nmod_mpoly_sqrt_heap(
    fq_nmod_mpoly_t Q,
    const fq_nmod_mpoly_t A,
    const fq_nmod_mpoly_ctx_t ctx);
FQ_NMOD_MPOLY_INLINE
...
void fq_nmod_mpoly_term_content(
    fq_nmod_mpoly_t M,
    const fq_nmod_mpoly_t A,
    const fq_nmod_mpoly_ctx_t ctx);
...
void fq_nmod_mpoly_univar_fit_length(
    fq_nmod_mpoly_univar_t A,
    slong length,
    const fq_nmod_mpoly_ctx_t ctx);

void fq_nmod_mpoly_univar_print_pretty(
...
FQ_NMOD_MPOLY_INLINE
void fq_nmod_mpoly_univar_zero(fq_nmod_mpoly_univar_t A, const fq_nmod_mpoly_ctx_t ctx)
{
    A->length = 0;
}
...
void _fq_nmod_mpoly_from_univar(
    ...
    slong var,
    const fq_nmod_mpoly_ctx_t ctx);
void fq_nmod_mpoly_from_univar(
    fq_nmod_mpoly_t A,
    const fq_nmod_mpoly_univar_t B,
    slong var,
    const fq_nmod_mpoly_ctx_t ctx);
...
{
    FLINT_ASSERT(i < (ulong) A->length); return fmpz_get_si(A->exps + i);
}
...
{
    FLINT_ASSERT(i < (ulong) A->length); fq_nmod_mpoly_set(c, A->coeffs + i, ctx);
}
...
{
    FLINT_ASSERT(i < (ulong) A->length); fq_nmod_mpoly_swap(c, A->coeffs + i, ctx);
}
...
int fq_nmod_mpoly_discriminant(
    fq_nmod_mpoly_t R,
    const fq_nmod_mpoly_t A,
    slong var,
    const fq_nmod_mpoly_ctx_t ctx);
...
FQ_NMOD_MPOLY_INLINE
void fq_nmod_mpolyu_swap(fq_nmod_mpolyu_t A, fq_nmod_mpolyu_t B, const fq_nmod_mpoly_ctx_t uctx)
{
    FLINT_SWAP(fq_nmod_mpolyu_struct, *A, *B);
}
...
void fq_nmod_mpolyu_print_pretty(
    const fq_nmod_mpolyu_t poly,
    const char ** x,
    const fq_nmod_mpoly_ctx_t ctx);

void fq_nmod_mpolyu_fit_length(
    fq_nmod_mpolyu_t A,
    slong length,
...
void fq_nmod_mpolyu_scalar_mul_fq_nmod(
    fq_nmod_mpolyu_t A,
    fq_nmod_t c,
    const fq_nmod_mpoly_ctx_t ctx);

void fq_nmod_mpolyu_set(
    fq_nmod_mpolyu_t A,
...
void fq_nmod_mpolyu_setform(
    fq_nmod_mpolyu_t A,
    fq_nmod_mpolyu_t B,
    const fq_nmod_mpoly_ctx_t ctx);

fq_nmod_mpoly_struct * _fq_nmod_mpolyu_get_coeff(
    fq_nmod_mpolyu_t A,
    ulong pow,
    const fq_nmod_mpoly_ctx_t uctx);
...
FQ_NMOD_MPOLY_INLINE
mp_limb_t * fq_nmod_mpolyu_leadcoeff(const fq_nmod_mpolyu_t A, const fq_nmod_mpoly_ctx_t ctx)
{
    FLINT_ASSERT(A->length > 0); return _fq_nmod_mpoly_leadcoeff(A->coeffs + 0, ctx);
}

/* mpolyn ********************************************************************/

void fq_nmod_mpolyn_init(
    fq_nmod_mpolyn_t A,
    flint_bitcnt_t bits,
    const fq_nmod_mpoly_ctx_t ctx);
...
void fq_nmod_mpolyn_print_pretty(
    const fq_nmod_mpolyn_t A,
    const char ** x_in,
    const fq_nmod_mpoly_ctx_t ctx);

void fq_nmod_mpolyn_fit_length(
    fq_nmod_mpolyn_t A,
    slong length,
    const fq_nmod_mpoly_ctx_t ctx);

void fq_nmod_mpolyn_fit_bits(
    fq_nmod_mpolyn_t A,
    slong bits,
    const fq_nmod_mpoly_ctx_t ctx);

void fq_nmod_mpolyn_set(
    fq_nmod_mpolyn_t A,
...
FQ_NMOD_MPOLY_INLINE
n_poly_struct * fq_nmod_mpolyn_leadcoeff_poly(const fq_nmod_mpolyn_t A, const fq_nmod_mpoly_ctx_t ctx)
{
    FLINT_ASSERT(A->length > 0); return A->coeffs + 0;
}
...
FQ_NMOD_MPOLY_INLINE
n_poly_struct * fq_nmod_mpolyun_leadcoeff_poly(const fq_nmod_mpolyun_t A, const fq_nmod_mpoly_ctx_t ctx)
{
    FLINT_ASSERT(A->length > 0); return fq_nmod_mpolyn_leadcoeff_poly(A->coeffs + 0, ctx);
}
...
void fq_nmod_mpoly_geobucket_empty(
    fq_nmod_mpoly_t p,
    fq_nmod_mpoly_geobucket_t B,
    const fq_nmod_mpoly_ctx_t ctx);

void fq_nmod_mpoly_geobucket_fit_length(
    fq_nmod_mpoly_geobucket_t B,
    slong i,
    const fq_nmod_mpoly_ctx_t ctx);

void fq_nmod_mpoly_geobucket_set(
    fq_nmod_mpoly_geobucket_t B,
    fq_nmod_mpoly_t p,
    const fq_nmod_mpoly_ctx_t ctx);

void fq_nmod_mpoly_geobucket_add(
    fq_nmod_mpoly_geobucket_t B,
    fq_nmod_mpoly_t p,
    const fq_nmod_mpoly_ctx_t ctx);
void fq_nmod_mpoly_geobucket_sub(
    fq_nmod_mpoly_geobucket_t B,
    fq_nmod_mpoly_t p,
    const fq_nmod_mpoly_ctx_t ctx);
...
void fq_nmod_mpoly_remainder_strongtest(
    const fq_nmod_mpoly_t r,
    const fq_nmod_mpoly_t g,
    const fq_nmod_mpoly_ctx_t ctx);

...
int _fq_zech_ctx_init_conway(
    fq_zech_ctx_t ctx,
    const fmpz_t p,
    slong d,
    const char * var);
void fq_zech_ctx_init_conway(
    fq_zech_ctx_t ctx,
    const fmpz_t p,
    slong d,
    const char * var);

void fq_zech_ctx_init_random(
    fq_zech_ctx_t ctx,
    const fmpz_t p,
    slong d,
    const char * var);

int fq_zech_ctx_init_modulus_check(
    fq_zech_ctx_t ctx,
    const nmod_poly_t modulus,
    const char * var);
void fq_zech_ctx_init_modulus(
    fq_zech_ctx_t ctx,
    const nmod_poly_t modulus,
    const char * var);
...
void fq_zech_randtest_not_zero(
    fq_zech_t rop,
    flint_rand_t state,
    const fq_zech_ctx_t ctx);
...
void fq_zech_bit_pack(
    fmpz_t f,
    const fq_zech_t op,
    flint_bitcnt_t bit_size,
    const fq_zech_ctx_t ctx);
void fq_zech_bit_unpack(
    fq_zech_t rop,
    const fmpz_t f,
    flint_bitcnt_t bit_size,
    const fq_zech_ctx_t ctx);

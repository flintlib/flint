/*
    ...
    Copyright (C) 2015, 2020, 2021 William Hart
...
#include "fq_mat_templates/scalar_mul_fmpz.c"
#include "fq_mat_templates/scalar_mul_si.c"
#include "fq_mat_templates/scalar_mul_ui.c"

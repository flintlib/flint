...
TEST_FUNCTION_START(fq_zech_sub, state)
{
    int j, i, result;
    fq_zech_ctx_t ctx;
    ...
    for (j = 0; j < 10; j++)
    {
        ...
        for (i = 0; i < 200; i++)
        {
            ...
            fq_zech_sub(c, a, b, ctx);
            fq_zech_sub(a, a, b, ctx);
        ...
        for (i = 0; i < 2000; i++)
        {
            ...
            fq_zech_sub(c, a, a, ctx);
            fq_zech_sub(a, a, a, ctx);
        ...
        for (i = 0; i < 2000; i++)
        {
            ...
            fq_zech_sub(c2, b, a, ctx);
            fq_zech_neg(c2, c2, ctx);
        ...
        for (i = 0; i < 2000; i++)
        {
            ...
            fq_zech_sub(lhs, a, b, ctx);
            fq_zech_sub(lhs, lhs, c, ctx);
            fq_zech_add(rhs, b, c, ctx);
            fq_zech_sub(rhs, a, rhs, ctx);

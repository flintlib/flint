...
int
_gr_ore_poly_write(gr_stream_t out, gr_srcptr poly, slong n, const char * d, gr_ore_poly_ctx_t ctx)
{
    return _gr_poly_write(out, poly, n, d, GR_ORE_POLY_ELEM_CTX(ctx));
}

int
gr_ore_poly_write(gr_stream_t out, const gr_ore_poly_t poly, const char * d, gr_ore_poly_ctx_t ctx)
{
    return _gr_poly_write(out, poly->coeffs, poly->length, d, GR_ORE_POLY_ELEM_CTX(ctx));
}

int
_gr_ore_poly_get_str(char ** res, gr_srcptr f, slong len, const char * d, gr_ore_poly_ctx_t ctx)
{
    return _gr_poly_get_str(res, f, len, d, GR_ORE_POLY_ELEM_CTX(ctx));
}

int
gr_ore_poly_get_str(char ** res, const gr_ore_poly_t f, const char * d, gr_ore_poly_ctx_t ctx)
{
    return _gr_poly_get_str(res, f->coeffs, f->length, d, GR_ORE_POLY_ELEM_CTX(ctx));
}
...
int
gr_ore_poly_set_str(gr_ore_poly_t res, const char * s, const char * d, gr_ore_poly_ctx_t ctx)
{
    return gr_poly_set_str((gr_poly_struct *) res, s, d, GR_ORE_POLY_ELEM_CTX(ctx));
}

int
_gr_ore_poly_set_str(gr_ptr res, const char * s, const char * d, slong len, gr_ore_poly_ctx_t ctx)
{
    return _gr_poly_set_str(res, s, d, len, GR_ORE_POLY_ELEM_CTX(ctx));
}

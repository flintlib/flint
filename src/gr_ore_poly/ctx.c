...
void
gr_ore_poly_ctx_init(gr_ore_poly_ctx_t ctx, gr_ctx_t base_ring, const ore_poly_which_operator operator)
{
...
{
    gr_ore_poly_ctx_init(ctx, base_ring, ore_poly_which_operator_randtest(state));
}

...
test_struct tests[] =
{
    TEST_FUNCTION(fq_zech_poly_factor_berlekamp),
    ...
    TEST_FUNCTION(fq_zech_poly_factor_is_irreducible_ben_or),
    TEST_FUNCTION(fq_zech_poly_factor_is_irreducible),
    TEST_FUNCTION(fq_zech_poly_factor_is_irreducible_ddf),
    TEST_FUNCTION(fq_zech_poly_factor_is_squarefree),
    TEST_FUNCTION(fq_zech_poly_factor_iterated_frobenius_preinv),
    TEST_FUNCTION(fq_zech_poly_factor_roots)
};

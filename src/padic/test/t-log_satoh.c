...
TEST_FUNCTION_START(padic_log_satoh, state)
{
    int i, result;
...
/** p == 2 *******************************************************************/
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        ans1 = padic_log_satoh(b, a, ctx);
        ans2 = padic_log_satoh(a, a, ctx);
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        ans1 = padic_log_satoh(d, a, ctx);
        ans2 = padic_log_satoh(e, b, ctx);
        padic_add(f, d, e, ctx);

        ans3 = padic_log_satoh(g, c, ctx);

...
TEST_TEMPLATE_FUNCTION_START(T, poly_compose_mod_brent_kung, state)
{
    int i;
    ...
    for (i = 0; i < 20 * flint_test_multiplier(); i++)
    {
        ...
        TEMPLATE(T, poly_compose_mod_brent_kung) (d, a, b, c, ctx);
    ...
    for (i = 0; i < 20 * flint_test_multiplier(); i++)
    {
        ...
        TEMPLATE(T, poly_rem) (a, a, c, ctx);
        TEMPLATE(T, poly_compose_mod_brent_kung) (d, a, b, c, ctx);
        TEMPLATE(T, poly_compose_mod_brent_kung) (a, a, b, c, ctx);
    ...
    for (i = 0; i < 20 * flint_test_multiplier(); i++)
    {
        ...
        TEMPLATE(T, poly_rem) (a, a, c, ctx);
        TEMPLATE(T, poly_compose_mod_brent_kung) (d, a, b, c, ctx);
        TEMPLATE(T, poly_compose_mod_brent_kung) (b, a, b, c, ctx);
    ...
    for (i = 0; i < 20 * flint_test_multiplier(); i++)
    {
        ...
        TEMPLATE(T, poly_rem) (a, a, c, ctx);
        TEMPLATE(T, poly_compose_mod_brent_kung) (d, a, b, c, ctx);
        TEMPLATE(T, poly_compose_mod_brent_kung) (c, a, b, c, ctx);

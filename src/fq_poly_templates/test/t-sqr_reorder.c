...
TEST_TEMPLATE_FUNCTION_START(T, poly_sqr_reorder, state)
{
    int i, result;
    ...
    for (i = 0; i < 200 * flint_test_multiplier(); i++)
    {
        ...
        TEMPLATE(T, poly_sqr_reorder) (c, a, ctx);
        TEMPLATE(T, poly_sqr_reorder) (a, a, ctx);
    ...
    for (i = 0; i < 200 * flint_test_multiplier(); i++)
    {
        ...
        TEMPLATE(T, poly_sqr_reorder) (b, a, ctx);

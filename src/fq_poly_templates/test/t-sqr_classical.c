...
TEST_TEMPLATE_FUNCTION_START(T, poly_sqr_classical, state)
{
    int i, result;
    ...
    for (i = 0; i < 200 * flint_test_multiplier(); i++)
    {
        ...
        TEMPLATE(T, poly_sqr_classical) (c, a, ctx);
        TEMPLATE(T, poly_sqr_classical) (a, a, ctx);
    ...
    for (i = 0; i < 200 * flint_test_multiplier(); i++)
    {
        ...
        TEMPLATE(T, poly_sqr_classical) (b, a, ctx);

...
TEST_TEMPLATE_FUNCTION_START(T, poly_scalar_submul_fq, state)
{
    int i, result;
    ...
    for (i = 0; i < 200 * flint_test_multiplier(); i++)
    {
        ...
        TEMPLATE(T, TEMPLATE(poly_scalar_submul, T)) (b, a, x, ctx);
        TEMPLATE(T, TEMPLATE(poly_scalar_submul, T)) (a, a, x, ctx);

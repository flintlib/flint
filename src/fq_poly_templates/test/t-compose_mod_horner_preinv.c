...
TEST_TEMPLATE_FUNCTION_START(T, poly_compose_mod_horner_preinv, state)
{
    int i;
    ...
    for (i = 0; i < 20 * flint_test_multiplier(); i++)
    {
        ...
        TEMPLATE(T, poly_compose_mod_horner_preinv) (d, a, b, c, cinv, ctx);
    ...
    for (i = 0; i < 20 * flint_test_multiplier(); i++)
    {
        ...
        TEMPLATE(T, poly_rem) (a, a, c, ctx);
        TEMPLATE(T, poly_compose_mod_horner_preinv) (d, a, b, c, cinv, ctx);
        TEMPLATE(T, poly_compose_mod_horner_preinv) (a, a, b, c, cinv, ctx);
    ...
    for (i = 0; i < 20 * flint_test_multiplier(); i++)
    {
        ...
        TEMPLATE(T, poly_rem) (a, a, c, ctx);
        TEMPLATE(T, poly_compose_mod_horner_preinv) (d, a, b, c, cinv, ctx);
        TEMPLATE(T, poly_compose_mod_horner_preinv) (b, a, b, c, cinv, ctx);
    ...
    for (i = 0; i < 20 * flint_test_multiplier(); i++)
    {
        ...
        TEMPLATE(T, poly_rem) (a, a, c, ctx);
        TEMPLATE(T, poly_compose_mod_horner_preinv) (d, a, b, c, cinv, ctx);
        TEMPLATE(T, poly_compose_mod_horner_preinv) (c, a, b, c, cinv, ctx);

...
void
_arb_poly_cot_series(arb_ptr g, arb_srcptr h, slong hlen, slong n, slong prec)
{
...
void
arb_poly_cot_series(arb_poly_t g, const arb_poly_t h, slong n, slong prec)
{
    ...
    if (h->length == 0 || n == 0)
        ...
        _arb_poly_cot_series(g->coeffs, h->coeffs, h->length, n, prec);

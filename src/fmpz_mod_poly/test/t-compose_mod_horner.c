...
TEST_FUNCTION_START(fmpz_mod_poly_compose_mod_horner, state)
{
    int i;
    fmpz_mod_ctx_t ctx;
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_mod_poly_compose_mod_horner(d, a, b, c, ctx);
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_mod_poly_compose_mod_horner(d, a, b, c, ctx);
        fmpz_mod_poly_compose_mod_horner(a, a, b, c, ctx);
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_mod_poly_compose_mod_horner(d, a, b, c, ctx);
        fmpz_mod_poly_compose_mod_horner(b, a, b, c, ctx);
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_mod_poly_compose_mod_horner(d, a, b, c, ctx);
        fmpz_mod_poly_compose_mod_horner(c, a, b, c, ctx);

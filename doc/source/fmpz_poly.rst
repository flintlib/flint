...
.. function:: void _fmpz_poly_bit_pack(ulong_ptr arr, const fmpz * poly, slong len, flint_bitcnt_t bit_size, int negate)
...
.. function:: int _fmpz_poly_bit_unpack(fmpz * poly, slong len, ulong_srcptr arr, flint_bitcnt_t bit_size, int negate)
...
.. function:: void _fmpz_poly_bit_unpack_unsigned(fmpz * poly, slong len, ulong_srcptr_t arr, flint_bitcnt_t bit_size)
...
.. function:: void _fmpz_poly_CRT_ui_precomp(fmpz * res, const fmpz * poly1, slong len1, const fmpz_t m1, ulong_srcptr poly2, slong len2, ulong m2, ulong m2inv, fmpz_t m1m2, ulong c, int sign)
...
.. function:: void _fmpz_poly_CRT_ui(fmpz * res, const fmpz * poly1, slong len1, const fmpz_t m1, ulong_srcptr poly2, slong len2, ulong m2, ulong m2inv, int sign)
...
.. function:: void _fmpz_poly_cyclotomic(fmpz * a, ulong n, ulong_ptr factors, slong num_factors, ulong phi)

...
Building FLINT2 with Microsoft Visual Studio requires Visual Studio 2019 and:
...
FLINT2 depends on the MPIR, MPFR and PTHREADS libraries that have to be
installed and built using Visual Studio before FLINT2 can be built.

...
html_theme_options = {
    ...
    'headfont': "'roboto', 'arial', sans-serif",
    'sidebarbtncolor': '#666',
    'sidebarbgcolor': '#444',
...
latex_documents = [
    (master_doc, 'calcium.tex', u'Calcium Documentation',
...
man_pages = [
    (master_doc, 'calcium', u'Calcium Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'calcium', u'Calcium Documentation',
     author, 'Calcium', 'One line description of project.',
     'Miscellaneous'),
]

...
.. function:: void fmpz_factor_ecm_addmod(ulong_ptr a, ulong_ptr b, ulong_ptr c, ulong_ptr n, ulong n_size)
...
.. function:: void fmpz_factor_ecm_submod(ulong_ptr x, ulong_ptr a, ulong_ptr b, ulong_ptr n, ulong n_size)
...
.. function:: void fmpz_factor_ecm_double(ulong_ptr x, ulong_ptr z, ulong_ptr x0, ulong_ptr z0, ulong_ptr n, ecm_t ecm_inf)
    ...
    ``ecm_inf`` is used just to use temporary ``ulong_ptr``'s in the
    structure. This group doubling is valid only for points expressed in
    Montgomery projective coordinates.

.. function:: void fmpz_factor_ecm_add(ulong_ptr x, ulong_ptr z, ulong_ptr x1, ulong_ptr z1, ulong_ptr x2, ulong_ptr z2, ulong_ptr x0, ulong_ptr z0, ulong_ptr n, ecm_t ecm_inf)
...
.. function:: void fmpz_factor_ecm_mul_montgomery_ladder(ulong_ptr x, ulong_ptr z, ulong_ptr x0, ulong_ptr z0, ulong k, ulong_ptr n, ecm_t ecm_inf)
...
.. function:: int fmpz_factor_ecm_select_curve(ulong_ptr f, ulong_ptr sigma, ulong_ptr n, ecm_t ecm_inf)
...
.. function:: int fmpz_factor_ecm_stage_I(ulong_ptr f, const ulong *prime_array, ulong num, ulong B1, ulong_ptr n, ecm_t ecm_inf)
...
.. function:: int fmpz_factor_ecm_stage_II(ulong_ptr f, ulong B1, ulong B2, ulong P, ulong_ptr n, ecm_t ecm_inf)
...
.. function:: int fmpz_factor_ecm(fmpz_t f, ulong curves, ulong B1, ulong B2, flint_rand_t state, fmpz_t n_in)

...
.. function:: int signed_mpn_sub_n(ulong_ptr res, ulong_srcptr op1, ulong_srcptr op2, slong n)
...
.. function:: void _nmod_poly_reverse(ulong_ptr output, ulong_srcptr input, slong len, slong m)
...
.. function:: void _nmod_poly_shift_left(ulong_ptr res, ulong_srcptr poly, slong len, slong k)
...
.. function:: void _nmod_poly_shift_right(ulong_ptr res, ulong_srcptr poly, slong len, slong k)
...
.. function:: void _nmod_poly_add(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, nmod_t mod)
...
.. function:: void _nmod_poly_sub(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, nmod_t mod)
...
.. function:: void _nmod_poly_make_monic(ulong_ptr output, ulong_srcptr input, slong len, nmod_t mod)
...
.. function:: void _nmod_poly_bit_pack(ulong_ptr res, ulong_srcptr poly, slong len, flint_bitcnt_t bits)
...
.. function:: void _nmod_poly_bit_unpack(ulong_ptr res, slong len, ulong_srcptr mpn, ulong bits, nmod_t mod)
...
.. function:: void _nmod_poly_KS2_pack1(ulong_ptr res, ulong_srcptr op, slong n, slong s, ulong b, ulong k, slong r)

    Same as ``_nmod_poly_KS2_pack``, but requires ``b <= FLINT_BITS``.

.. function:: void _nmod_poly_KS2_pack(ulong_ptr res, ulong_srcptr op, slong n, slong s, ulong b, ulong k, slong r)

    Bit packing routine used by KS2 and KS4 multiplication.

.. function:: void _nmod_poly_KS2_unpack1(ulong_ptr res, ulong_srcptr op, slong n, ulong b, ulong k)

    Same as ``_nmod_poly_KS2_unpack``, but requires ``b <= FLINT_BITS``
    (i.e. writes one word per coefficient).

.. function:: void _nmod_poly_KS2_unpack2(ulong_ptr res, ulong_srcptr op, slong n, ulong b, ulong k)

    Same as ``_nmod_poly_KS2_unpack``, but requires
    ``FLINT_BITS < b <= 2 * FLINT_BITS`` (i.e. writes two words per
    coefficient).

.. function:: void _nmod_poly_KS2_unpack3(ulong_ptr res, ulong_srcptr op, slong n, ulong b, ulong k)

    Same as ``_nmod_poly_KS2_unpack``, but requires
    ``2 * FLINT_BITS < b < 3 * FLINT_BITS`` (i.e. writes three words per
    coefficient).

.. function:: void _nmod_poly_KS2_unpack(ulong_ptr res, ulong_srcptr op, slong n, ulong b, ulong k)
...
.. function:: void _nmod_poly_KS2_reduce(ulong_ptr res, slong s, ulong_srcptr op, slong n, ulong w, nmod_t mod)

    Reduction code used by KS2 and KS4 multiplication.

.. function:: void _nmod_poly_KS2_recover_reduce1(ulong_ptr res, slong s, ulong_srcptr op1, ulong_srcptr op2, slong n, ulong b, nmod_t mod)

    Same as ``_nmod_poly_KS2_recover_reduce``, but requires
    ``0 < 2 * b <= FLINT_BITS``.

.. function:: void _nmod_poly_KS2_recover_reduce2(ulong_ptr res, slong s, ulong_srcptr op1, ulong_srcptr op2, slong n, ulong b, nmod_t mod)

    Same as ``_nmod_poly_KS2_recover_reduce``, but requires
    ``FLINT_BITS < 2 * b < 2*FLINT_BITS``.

.. function:: void _nmod_poly_KS2_recover_reduce2b(ulong_ptr res, slong s, ulong_srcptr op1, ulong_srcptr op2, slong n, ulong b, nmod_t mod)

    Same as ``_nmod_poly_KS2_recover_reduce``, but requires
    ``b == FLINT_BITS``.

.. function:: void _nmod_poly_KS2_recover_reduce3(ulong_ptr res, slong s, ulong_srcptr op1, ulong_srcptr op2, slong n, ulong b, nmod_t mod)

    Same as ``_nmod_poly_KS2_recover_reduce``, but requires
    ``2 * FLINT_BITS < 2 * b <= 3 * FLINT_BITS``.

.. function:: void _nmod_poly_KS2_recover_reduce(ulong_ptr res, slong s, ulong_srcptr op1, ulong_srcptr op2, slong n, ulong b, nmod_t mod)
...
.. function:: void _nmod_poly_mul_classical(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, nmod_t mod)
...
.. function:: void _nmod_poly_mullow_classical(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, slong trunc, nmod_t mod)
...
.. function:: void _nmod_poly_mulhigh_classical(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, slong start, nmod_t mod)
...
.. function:: void _nmod_poly_mul_KS(ulong_ptr out, ulong_srcptr in1, slong len1, ulong_srcptr in2, slong len2, flint_bitcnt_t bits, nmod_t mod)
...
.. function:: void _nmod_poly_mul_KS2(ulong_ptr res, ulong_srcptr op1, slong n1, ulong_srcptr op2, slong n2, nmod_t mod)
...
.. function:: void _nmod_poly_mul_KS4(ulong_ptr res, ulong_srcptr op1, slong n1, ulong_srcptr op2, slong n2, nmod_t mod)
...
.. function:: void _nmod_poly_mullow_KS(ulong_ptr out, ulong_srcptr in1, slong len1, ulong_srcptr in2, slong len2, flint_bitcnt_t bits, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_mul(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, nmod_t mod)
...
.. function:: void _nmod_poly_mullow(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_mulhigh(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_mulmod(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, ulong_srcptr f, slong lenf, nmod_t mod)
...
.. function:: void _nmod_poly_mulmod_preinv(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, ulong_srcptr f, slong lenf, ulong_srcptr finv, slong lenfinv, nmod_t mod)
...
.. function:: void _nmod_poly_pow_binexp(ulong_ptr res, ulong_srcptr poly, slong len, ulong e, nmod_t mod)
...
.. function:: void _nmod_poly_pow(ulong_ptr res, ulong_srcptr poly, slong len, ulong e, nmod_t mod)
...
.. function:: void _nmod_poly_pow_trunc_binexp(ulong_ptr res, ulong_srcptr poly, ulong e, slong trunc, nmod_t mod)
...
.. function:: void _nmod_poly_pow_trunc(ulong_ptr res, ulong_srcptr poly, ulong e, slong trunc, nmod_t mod)
...
.. function:: void _nmod_poly_powmod_ui_binexp(ulong_ptr res, ulong_srcptr poly, ulong e, ulong_srcptr f, slong lenf, nmod_t mod)
...
.. function:: void _nmod_poly_powmod_mpz_binexp(ulong_ptr res, ulong_srcptr poly, mpz_srcptr e, ulong_srcptr f, slong lenf, nmod_t mod)
...
.. function:: void _nmod_poly_powmod_fmpz_binexp(ulong_ptr res, ulong_srcptr poly, fmpz_t e, ulong_srcptr f, slong lenf, nmod_t mod)
...
.. function:: void _nmod_poly_powmod_ui_binexp_preinv (ulong_ptr res, ulong_srcptr poly, ulong e, ulong_srcptr f, slong lenf, ulong_srcptr finv, slong lenfinv, nmod_t mod)
...
.. function:: void _nmod_poly_powmod_mpz_binexp_preinv (ulong_ptr res, ulong_srcptr poly, mpz_srcptr e, ulong_srcptr f, slong lenf, ulong_srcptr finv, slong lenfinv, nmod_t mod)
...
.. function:: void _nmod_poly_powmod_fmpz_binexp_preinv (ulong_ptr res, ulong_srcptr poly, fmpz_t e, ulong_srcptr f, slong lenf, ulong_srcptr finv, slong lenfinv, nmod_t mod)
...
.. function:: void _nmod_poly_powmod_x_ui_preinv (ulong_ptr res, ulong e, ulong_srcptr f, slong lenf, ulong_srcptr finv, slong lenfinv, nmod_t mod)
...
.. function:: void _nmod_poly_powmod_x_fmpz_preinv (ulong_ptr res, fmpz_t e, ulong_srcptr f, slong lenf, ulong_srcptr finv, slong lenfinv, nmod_t mod)
...
.. function:: void _nmod_poly_powers_mod_preinv_naive(ulong_ptr * res, ulong_srcptr f, slong flen, slong n, ulong_srcptr g, slong glen, ulong_srcptr ginv, slong ginvlen, const nmod_t mod)
...
.. function:: void _nmod_poly_powers_mod_preinv_threaded_pool(ulong_ptr * res, ulong_srcptr f, slong flen, slong n, ulong_srcptr g, slong glen, ulong_srcptr ginv, slong ginvlen, const nmod_t mod, thread_pool_handle * threads, slong num_threads)
...
.. function:: void _nmod_poly_powers_mod_preinv_threaded(ulong_ptr * res, ulong_srcptr f, slong flen, slong n, ulong_srcptr g, slong glen, ulong_srcptr ginv, slong ginvlen, const nmod_t mod)   
...
.. function:: void _nmod_poly_divrem_basecase(ulong_ptr Q, ulong_ptr R, ulong_ptr W, ulong_srcptr A, slong A_len, ulong_srcptr B, slong B_len, nmod_t mod)
...
.. function:: void _nmod_poly_div_basecase(ulong_ptr Q, ulong_ptr W, ulong_srcptr A, slong A_len, ulong_srcptr B, slong B_len, nmod_t mod)
...
.. function:: void _nmod_poly_divrem_divconquer_recursive(ulong_ptr Q, ulong_ptr BQ, ulong_ptr W, ulong_ptr V, ulong_srcptr A, ulong_srcptr B, slong lenB, nmod_t mod)
...
.. function:: void _nmod_poly_divrem_divconquer(ulong_ptr Q, ulong_ptr R, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, nmod_t mod)
...
.. function:: void _nmod_poly_divrem_q0(ulong_ptr Q, ulong_ptr R, ulong_srcptr A, ulong_srcptr B, slong lenA, nmod_t mod)
...
.. function:: void _nmod_poly_divrem_q1(ulong_ptr Q, ulong_ptr R, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, nmod_t mod)
...
.. function:: void _nmod_poly_divrem(ulong_ptr Q, ulong_ptr R, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, nmod_t mod)
...
.. function:: void _nmod_poly_div_divconquer_recursive(ulong_ptr Q, ulong_ptr W, ulong_ptr V, ulong_srcptr A, ulong_srcptr B, slong lenB, nmod_t mod)
...
.. function:: void _nmod_poly_div_divconquer(ulong_ptr Q, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, nmod_t mod)
...
.. function:: void _nmod_poly_div(ulong_ptr Q, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, nmod_t mod)
...
.. function:: void _nmod_poly_rem_basecase(ulong_ptr R, ulong_ptr W, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, nmod_t mod)
              void nmod_poly_rem_basecase(nmod_poly_t R, const nmod_poly_t A, const nmod_poly_t B)
              void _nmod_poly_rem_q1(ulong_ptr R, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, nmod_t mod)
...
.. function:: void _nmod_poly_rem(ulong_ptr R, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, nmod_t mod)
...
.. function:: void _nmod_poly_inv_series_basecase(ulong_ptr Qinv, ulong_srcptr Q, slong Qlen, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_inv_series_newton(ulong_ptr Qinv, ulong_srcptr Q, slong Qlen, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_inv_series(ulong_ptr Qinv, ulong_srcptr Q, slong Qlen, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_div_series_basecase(ulong_ptr Q, ulong_srcptr A, slong Alen, ulong_srcptr B, slong Blen, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_div_series(ulong_ptr Q, ulong_srcptr A, slong Alen, ulong_srcptr B, slong Blen, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_div_newton(ulong_ptr Q, ulong_srcptr A, slong Alen, ulong_srcptr B, slong Blen, nmod_t mod)
...
.. function:: void _nmod_poly_div_newton_n_preinv (ulong_ptr Q, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, ulong_srcptr Binv, slong lenBinv, nmod_t mod)
...
.. function:: void _nmod_poly_divrem_newton(ulong_ptr Q, ulong_ptr R, ulong_srcptr A, slong Alen, ulong_srcptr B, slong Blen, nmod_t mod)
...
.. function:: void _nmod_poly_divrem_newton_n_preinv (ulong_ptr Q, ulong_ptr R, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, ulong_srcptr Binv, slong lenBinv, nmod_t mod)
...
.. function:: ulong _nmod_poly_div_root(ulong_ptr Q, ulong_srcptr A, slong len, ulong c, nmod_t mod)
...
.. function:: int _nmod_poly_divides_classical(ulong_ptr Q, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, nmod_t mod)
...
.. function:: int _nmod_poly_divides(ulong_ptr Q, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, nmod_t mod)
...
.. function:: void _nmod_poly_derivative(ulong_ptr x_prime, ulong_srcptr x, slong len, nmod_t mod)
...
.. function:: void _nmod_poly_integral(ulong_ptr x_int, ulong_srcptr x, slong len, nmod_t mod)
...
.. function:: ulong _nmod_poly_evaluate_nmod(ulong_srcptr poly, slong len, ulong c, nmod_t mod)
...
.. function:: ulong nmod_poly_evaluate_nmod(nmod_poly_t poly, ulong c)
...
.. function:: void _nmod_poly_evaluate_nmod_vec_iter(ulong_ptr ys, ulong_srcptr poly, slong len, ulong_srcptr xs, slong n, nmod_t mod)
...
.. function:: void nmod_poly_evaluate_nmod_vec_iter(ulong_ptr ys, const nmod_poly_t poly, ulong_srcptr xs, slong n)
...
.. function:: void _nmod_poly_evaluate_nmod_vec_fast_precomp(ulong_ptr vs, ulong_srcptr poly, slong plen, const ulong_ptr * tree, slong len, nmod_t mod)

    Evaluates (``poly``, ``plen``) at the ``len`` values given
    by the precomputed subproduct tree ``tree``.

.. function:: void _nmod_poly_evaluate_nmod_vec_fast(ulong_ptr ys, ulong_srcptr poly, slong len, ulong_srcptr xs, slong n, nmod_t mod)
...
.. function:: void nmod_poly_evaluate_nmod_vec_fast(ulong_ptr ys, const nmod_poly_t poly, ulong_srcptr xs, slong n)
...
.. function:: void _nmod_poly_evaluate_nmod_vec(ulong_ptr ys, ulong_srcptr poly, slong len, ulong_srcptr xs, slong n, nmod_t mod)
...
.. function:: void nmod_poly_evaluate_nmod_vec(ulong_ptr ys, const nmod_poly_t poly, ulong_srcptr xs, slong n)
...
.. function:: void _nmod_poly_interpolate_nmod_vec(ulong_ptr poly, ulong_srcptr xs, ulong_srcptr ys, slong n, nmod_t mod)
...
.. function:: void nmod_poly_interpolate_nmod_vec(nmod_poly_t poly, ulong_srcptr xs, ulong_srcptr ys, slong n)
...
.. function:: void _nmod_poly_interpolation_weights(ulong_ptr w, const ulong_ptr * tree, slong len, nmod_t mod)

    Sets ``w`` to the barycentric interpolation weights for fast
    Lagrange interpolation with respect to a given subproduct tree.

.. function:: void _nmod_poly_interpolate_nmod_vec_fast_precomp(ulong_ptr poly, ulong_srcptr ys, const ulong_ptr * tree, ulong_srcptr weights, slong len, nmod_t mod)
...
.. function:: void _nmod_poly_interpolate_nmod_vec_fast(ulong_ptr poly, ulong_srcptr xs, ulong_srcptr ys, slong n, nmod_t mod)

    Performs interpolation using the fast Lagrange interpolation
    algorithm, generating a temporary subproduct tree.

.. function:: void nmod_poly_interpolate_nmod_vec_fast(nmod_poly_t poly, ulong_srcptr xs, ulong_srcptr ys, slong n)

    Performs interpolation using the fast Lagrange interpolation algorithm,
    generating a temporary subproduct tree.

.. function:: void _nmod_poly_interpolate_nmod_vec_newton(ulong_ptr poly, ulong_srcptr xs, ulong_srcptr ys, slong n, nmod_t mod)

    Forms the interpolating polynomial in the Newton basis using
    the method of divided differences and then converts it to
    monomial form.

.. function:: void nmod_poly_interpolate_nmod_vec_newton(nmod_poly_t poly, ulong_srcptr xs, ulong_srcptr ys, slong n)

    Forms the interpolating polynomial in the Newton basis using
    the method of divided differences and then converts it to
    monomial form.

.. function:: void _nmod_poly_interpolate_nmod_vec_barycentric(ulong_ptr poly, ulong_srcptr xs, ulong_srcptr ys, slong n, nmod_t mod)

    Forms the interpolating polynomial using a naive implementation
    of the barycentric form of Lagrange interpolation.

.. function:: void nmod_poly_interpolate_nmod_vec_barycentric(nmod_poly_t poly, ulong_srcptr xs, ulong_srcptr ys, slong n)
...
.. function:: void _nmod_poly_compose_horner(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, nmod_t mod)
...
.. function:: void _nmod_poly_compose_divconquer(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, nmod_t mod)
...
.. function:: void _nmod_poly_compose(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, nmod_t mod)
...
.. function:: void _nmod_poly_taylor_shift_horner(ulong_ptr poly, ulong c, slong len, nmod_t mod)
...
.. function:: void _nmod_poly_taylor_shift_convolution(ulong_ptr poly, ulong c, slong len, nmod_t mod)
...
.. function:: void _nmod_poly_taylor_shift(ulong_ptr poly, ulong c, slong len, nmod_t mod)
...
.. function:: void _nmod_poly_compose_mod_horner(ulong_ptr res, ulong_srcptr f, slong lenf, ulong_srcptr g, ulong_srcptr h, slong lenh, nmod_t mod)
...
.. function:: void _nmod_poly_compose_mod_brent_kung(ulong_ptr res, ulong_srcptr f, slong lenf, ulong_srcptr g, ulong_srcptr h, slong lenh, nmod_t mod)
...
.. function:: void _nmod_poly_compose_mod_brent_kung_preinv(ulong_ptr res, ulong_srcptr f, slong lenf, ulong_srcptr g, ulong_srcptr h, slong lenh, ulong_srcptr hinv, slong lenhinv, nmod_t mod)
...
.. function:: void _nmod_poly_precompute_matrix (nmod_mat_t A, ulong_srcptr f, ulong_srcptr g, slong leng, ulong_srcptr ginv, slong lenginv, nmod_t mod)
...
.. function:: void _nmod_poly_compose_mod_brent_kung_precomp_preinv(ulong_ptr res, ulong_srcptr f, slong lenf, const nmod_mat_t A, ulong_srcptr h, slong lenh, ulong_srcptr hinv, slong lenhinv, nmod_t mod)
...
.. function:: void _nmod_poly_compose_mod_brent_kung_vec_preinv(nmod_poly_struct * res, const nmod_poly_struct * polys, slong len1, slong l, ulong_srcptr g, slong leng, ulong_srcptr h, slong lenh, ulong_srcptr hinv, slong lenhinv, nmod_t mod)
...
.. function:: void _nmod_poly_compose_mod_brent_kung_vec_preinv_threaded_pool(nmod_poly_struct * res, const nmod_poly_struct * polys, slong lenpolys, slong l, ulong_srcptr g, slong glen, ulong_srcptr poly, slong len, ulong_srcptr polyinv, slong leninv, nmod_t mod, thread_pool_handle * threads, slong num_threads)
...
.. function:: void _nmod_poly_compose_mod(ulong_ptr res, ulong_srcptr f, slong lenf, ulong_srcptr g, ulong_srcptr h, slong lenh, nmod_t mod)
...
.. function:: slong _nmod_poly_gcd_euclidean(ulong_ptr G, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, nmod_t mod)
...
.. function:: slong _nmod_poly_hgcd(ulong_ptr *M, slong *lenM, ulong_ptr A, slong *lenA, ulong_ptr B, slong *lenB, ulong_srcptr a, slong lena, ulong_srcptr b, slong lenb, nmod_t mod)
...
.. function:: slong _nmod_poly_gcd_hgcd(ulong_ptr G, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, nmod_t mod)
...
.. function:: slong _nmod_poly_gcd(ulong_ptr G, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, nmod_t mod)
...
.. function:: slong _nmod_poly_xgcd_euclidean(ulong_ptr G, ulong_ptr S, ulong_ptr T, ulong_srcptr A, slong A_len, ulong_srcptr B, slong B_len, nmod_t mod)
...
.. function:: slong _nmod_poly_xgcd_hgcd(ulong_ptr G, ulong_ptr S, ulong_ptr T, ulong_srcptr A, slong A_len, ulong_srcptr B, slong B_len, nmod_t mod)
...
.. function:: slong _nmod_poly_xgcd(ulong_ptr G, ulong_ptr S, ulong_ptr T, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, nmod_t mod)
...
.. function:: ulong _nmod_poly_resultant_euclidean(ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, nmod_t mod)
...
.. function:: ulong _nmod_poly_resultant_hgcd(ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, nmod_t mod)
...
.. function:: ulong _nmod_poly_resultant(ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, nmod_t mod)
...
.. function:: slong _nmod_poly_gcdinv(ulong_ptr G, ulong_ptr S, ulong_srcptr A, slong lenA, ulong_srcptr B, slong lenB, const nmod_t mod)
...
.. function:: int _nmod_poly_invmod(ulong_ptr A, ulong_srcptr B, slong lenB, ulong_srcptr P, slong lenP, const nmod_t mod)
...
.. function:: ulong _nmod_poly_discriminant(ulong_srcptr poly, slong len, nmod_t mod)
...
.. function:: void _nmod_poly_compose_series_horner(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, slong n)
...
.. function:: void _nmod_poly_compose_series_brent_kung(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, slong n)
...
.. function:: void _nmod_poly_compose_series_divconquer(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, slong N, nmod_t mod)
...
.. function:: void _nmod_poly_compose_series(ulong_ptr res, ulong_srcptr poly1, slong len1, ulong_srcptr poly2, slong len2, slong n)
...
.. function:: void _nmod_poly_revert_series_lagrange(ulong_ptr Qinv, ulong_srcptr Q, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_revert_series_lagrange_fast(ulong_ptr Qinv, ulong_srcptr Q, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_revert_series_newton(ulong_ptr Qinv, ulong_srcptr Q, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_revert_series(ulong_ptr Qinv, ulong_srcptr Q, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_invsqrt_series(ulong_ptr g, ulong_srcptr h, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_sqrt_series(ulong_ptr g, ulong_srcptr h, slong n, nmod_t mod)
...
.. function:: int _nmod_poly_sqrt(ulong_ptr s, ulong_srcptr p, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_power_sums_naive(ulong_ptr res, ulong_srcptr poly, slong len, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_power_sums_schoenhage(ulong_ptr res, ulong_srcptr poly, slong len, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_power_sums(ulong_ptr res, ulong_srcptr poly, slong len, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_power_sums_to_poly_naive(ulong_ptr res, ulong_srcptr poly, slong len, nmod_t mod)
...
.. function:: void _nmod_poly_power_sums_to_poly_schoenhage(ulong_ptr res, ulong_srcptr poly, slong len, nmod_t mod)
...
.. function:: void _nmod_poly_power_sums_to_poly(ulong_ptr res, ulong_srcptr poly, slong len, nmod_t mod)
...
.. function:: void _nmod_poly_log_series_monomial_ui(ulong_ptr g, ulong c, ulong r, slong n, nmod_t mod)

    Set `g = \log(1+cx^r) + O(x^n)`. Assumes `n > 0`, `r > 0`, and that
    the coefficient is reduced by the modulus. Works efficiently in linear
    time.

.. function:: void nmod_poly_log_series_monomial_ui(nmod_poly_t g, ulong c, ulong r, slong n)

    Set `g = \log(1+cx^r) + O(x^n)`. Works efficiently in linear time.

.. function:: void _nmod_poly_log_series(ulong_ptr g, ulong_srcptr h, slong hlen, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_exp_series_monomial_ui(ulong_ptr g, ulong c, ulong r, slong n, nmod_t mod)

    Set `g = \exp(cx^r) + O(x^n)`. Assumes `n > 0`, `r > 0`, and that
    the coefficient is reduced by the modulus. Works efficiently
    in linear time.

.. function:: void nmod_poly_exp_series_monomial_ui(nmod_poly_t g, ulong c, ulong r, slong n)

    Set `g = \exp(cx^r) + O(x^n)`. Works efficiently in linear time.

.. function:: void _nmod_poly_exp_series_basecase(ulong_ptr g, ulong_srcptr h, slong hlen, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_exp_series(ulong_ptr f, ulong_srcptr h, slong hlen, slong n, nmod_t mod)
...
.. function:: void  _nmod_poly_exp_expinv_series(ulong_ptr f, ulong_ptr g, ulong_srcptr h, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_atan_series(ulong_ptr g, ulong_srcptr h, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_atanh_series(ulong_ptr g, ulong_srcptr h, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_asin_series(ulong_ptr g, ulong_srcptr h, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_asinh_series(ulong_ptr g, ulong_srcptr h, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_sin_series(ulong_ptr g, ulong_srcptr h, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_cos_series(ulong_ptr g, ulong_srcptr h, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_tan_series(ulong_ptr g, ulong_srcptr h, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_sinh_series(ulong_ptr g, ulong_srcptr h, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_cosh_series(ulong_ptr g, ulong_srcptr h, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_tanh_series(ulong_ptr g, ulong_srcptr h, slong n, nmod_t mod)
...
.. function:: void _nmod_poly_product_roots_nmod_vec(ulong_ptr poly, ulong_srcptr xs, slong n, nmod_t mod)
...
.. function:: void nmod_poly_product_roots_nmod_vec(nmod_poly_t poly, ulong_srcptr xs, slong n)
...
.. function:: ulong_ptr * _nmod_poly_tree_alloc(slong len)
...
.. function:: void _nmod_poly_tree_free(ulong_ptr * tree, slong len)

    Free the allocated space for the subproduct.

.. function:: void _nmod_poly_tree_build(ulong_ptr * tree, ulong_srcptr roots, slong len, nmod_t mod)

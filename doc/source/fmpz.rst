...
.. function:: int fmpz_get_mpn(ulong_ptr * n, fmpz_t n_in)

    Sets the ``ulong_ptr`` `n` to the same value as `n_{in}`. Returned
...
.. function:: int fmpz_bit_pack(ulong * arr, flint_bitcnt_t shift, flint_bitcnt_t bits, fmpz_t coeff, int negate, int borrow)
...
.. function:: void fmpz_multi_CRT_ui(fmpz_t output, ulong_srcptr residues, const fmpz_comb_t comb, fmpz_comb_temp_t ctemp, int sign)
...
.. function:: void fmpz_comb_init(fmpz_comb_t comb, ulong_srcptr primes, slong num_primes)
...
.. function:: int fmpz_is_prime_pocklington(fmpz_t F, fmpz_t R, const fmpz_t n, ulong_ptr pm1, slong num_pm1)
...
.. function:: void _fmpz_nm1_trial_factors(const fmpz_t n, ulong_ptr pm1, slong * num_pm1, ulong limit)
...
.. function:: int fmpz_is_prime_morrison(fmpz_t F, fmpz_t R, const fmpz_t n, ulong_ptr pp1, slong num_pp1)
...
.. function:: void _fmpz_np1_trial_factors(const fmpz_t n, ulong_ptr pp1, slong * num_pp1, ulong limit)

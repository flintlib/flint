...
\chapter{Building FLINT with MSVC}

Dr. Brian Gladman has kindly provided build solutions for MSVC on Windows.

For instructions on building FLINT using MSVC, see the readme.txt file in the relevant directory of the FLINT source tree, e.g. build.vc12 for MSVC 2013.

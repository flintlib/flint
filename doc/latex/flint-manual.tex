...
of version 2.0, FLINT required GCC version 2.96 or later, MPIR 2.1.1 or 
later and MPFR 3.0.0 or later. It is also required that the platform 
...
FLINT requires MPIR version 2.1.1 or later and MPFR 3.0.0 or later and
a pthread implementation. Some of the input/output tests require 
...
your program, linking against the FLINT library, MPIR, MPFR and
...
Kulakova, Thomas de Buisson, Jean-Pierre Flori, Frithjof Schulze, Curtis 
Bright.

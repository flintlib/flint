...
By default, FLINT uses thread local storage (\code{--enable-tls}).
...
If you wish to run tests for the FLINT C$++$ wrapper \code{flintxx}
you must pass \code{--enable-cxx} to configure. The C$++$ wrapper
is always available, but tests will only run if this option is
selected. It is disabled by default (\code{--disable-cxx} because
some C$++$ compilers internally segfault when compiling the tests,
or exhaust memory due to the complexity of the C$++$ code.
...
The \code{--with-gc} option can be used with the \code{--reentrant}
option, but not the \code{--enable-tls} option. In fact, configure
will switch this off automatically and print a warning if it is
selected in addition to \code{--with-gc}.
...
polynomial arithmetic over \code{\Z/n\Z}, \code{mpz_poly}, profiling and
...
$\bullet$ Further patches and bug reports have been made by Michael Abshoff,
...
by \code{flint_cleanup()}. This is done by passing a pointer
...
The \code{fmpz_factor} module is included automatically when one includes
...
The \code{fmpz_poly_factor} module is included automatically when one includes
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Factorisation of olynomials over Z / nZ for word-sized moduli                %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\chapter{nmod\_poly\_factor}
\epigraph{Factorisation of polynomials over $\Z / n \Z$ for word-sized moduli}{}

The \code{nmod_poly_factor} module is included automatically when one includes
...
We represent an element of the finite field $\mathbb{F}_{p^n} \cong
\mathbb{F}_p[X]/(f(X))$, where $f(X) \in \mathbb{F}_p[X]$ is a monic,
irreducible polynomial of degree~$n$, as a polynomial in
$\mathbb{F}_p[X]$ of degree less than $n$. The underlying data
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{fq\_poly}
\epigraph{Polynoimals over finite fields of arbitrary characteristic}
...
% fq_poly_factor                                                               %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{fq\_poly\_factor}
\epigraph{Factorisation of polynoimals over finite fields of arbitrary
  characteristic}
...
% fq_nmod_poly                                                                 %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{fq\_nmod\_poly}
\epigraph{Polynoimals over finite fields of word-sized characteristic}
...
% fq_nmod_poly_factor                                                          %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{fq\_nmod\_poly\_factor}
\epigraph{Factorisation of polynoimals over finite fields of
...
use a root of $f(x))$, where $f(X) \in \mathbb{F}_p[X]$ is a monic,
irreducible polynomial of degree~$n$, as a polynomial in
$\mathbb{F}_p[X]$ of degree less than $n$.  The underlying data
...
% fq_zech_poly                                                                 %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{fq\_zech\_poly}
\epigraph{Polynoimals over finite fields in Zech logarithm representation}
...
% fq_zech_poly_factor                                                          %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{fq\_zech\_poly\_factor}
\epigraph{Factorisation of polynoimals over finite fields in Zech

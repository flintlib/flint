...
main(void)
{
    fmpz_mat_t A, B, ker, ker2;
    slong i, m, n, b, d, r, nullity, nulrank;

    FLINT_TEST_INIT(state);

    flint_printf("nullspace_dixon....");
    fflush(stdout);    
    ...
    for (i = 0; i < 1000 * flint_test_multiplier(); i++)
    {
        ...
        for (r = 0; r <= FLINT_MIN(m,n); r++)
        {
            ...
            nullity = fmpz_mat_nullspace_dixon(ker, A);
            /*fmpz_mat_nullspace(ker2, A);*/

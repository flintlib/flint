...
static const mp_limb_t qsieve_tune[][6] =
{
   {10,   50,   100,  5,   2 *  1500,  18}, /* */
   {20,   50,   120,  6,   2 *  1600,  18}, /* */
   {30,   50,   150,  6,   2 *  1800,  19}, /* */
   {40,   50,   150,  8,   2 *  2000,  20}, /* 12 digits */
   {50,   50,   150,  8,   2 *  2500,  22}, /* 15 digits */
   {60,   50,   100,  9,   2 *  3000,  24}, /* 18 digits */

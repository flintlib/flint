...
main(void)
{
    ...
    for (i = 0; i < 500; i++)
    {
        ...
        fmpz_poly_init(b);
        fmpz_poly_init(c);
        fmpz_poly_randtest(b, state, n_randint(50), n_randint(100));
        fmpz_poly_randtest(c, state, n_randint(50), n_randint(100));
    ...
    for (i = 0; i < 500; i++)
    {
        ...
        fmpz_poly_init(q);
        fmpz_poly_init(r);
        fmpz_poly_randtest_not_zero(a, state, n_randint(24) + 1, n_randint(24) + 1);
        fmpz_poly_randtest(f, state, n_randint(50), n_randint(100));
        fmpz_poly_randtest(g, state, n_randint(50), n_randint(100));

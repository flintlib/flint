...
main(void)
{
    ...
    for (i = 0; i < 1000; i++)
    {
        ...
        fmpz_poly_randtest(a, state, n_randint(50), 100);
        fmpz_poly_randtest_not_zero(b, state, n_randint(a->length + 1) + 1, 100);
    ...
    for (i = 0; i < 1000; i++)
    {
        ...
        fmpz_poly_init(r);
        fmpz_poly_randtest(a, state, n_randint(50), 100);
        fmpz_poly_randtest_not_zero(b, state, n_randint(50) + 1, 100);

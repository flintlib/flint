...
{
    _fmpz_poly_reverse_series_lagrange_fast(Qinv, Q, n);
}
...
fmpz_poly_reverse_series(fmpz_poly_t Qinv, const fmpz_poly_t Q, long n)
{
    ...
    {
        printf("exception: fmpz_poly_reverse_series: input must have "
    ...
    if (Qinv != Q)
    {
        ...
        _fmpz_poly_reverse_series(Qinv->coeffs, Qcopy, n);
    }
    else
    {
        fmpz_poly_t t;
        fmpz_poly_init2(t, n);
        _fmpz_poly_reverse_series(t->coeffs, Qcopy, n);

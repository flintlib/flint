...
void
_fmpq_poly_asin_series(fmpz * g, fmpz_t gden, 
...
void
fmpq_poly_asin_series(fmpq_poly_t res, const fmpq_poly_t f, len_t n)
{
    fmpz * f_coeffs;
    len_t flen = f->length;
    ...
    {
        printf("Exception (fmpq_poly_asin_series): Constant term != 0.\n");
        abort();
    }
    ...
    _fmpq_poly_asin_series(res->coeffs, res->den, f_coeffs, f->den, n);

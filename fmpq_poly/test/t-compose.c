...
main(void)
{
    ...
    for (i = 0; i < 100; i++)
    {
        ...
        fmpq_poly_init(g);
        fmpq_poly_init(h);
        fmpq_poly_randtest(g, n_randint(50), n_randint(100));
        fmpq_poly_randtest(h, n_randint(20), n_randint(50));
    ...
    for (i = 0; i < 100; i++)
    {
        ...
        fmpq_poly_init(u);
        mpq_init(c);
        fmpq_poly_randtest(g, n_randint(20), n_randint(65));
        fmpq_poly_randtest(h, n_randint(20), n_randint(65));

...
void
_fmpq_poly_reverse_series_newton(fmpz * Qinv, fmpz_t den,
        const fmpz * Q, const fmpz_t Qden, long n)
{
    ...
    else
    {
        ...
        _fmpq_poly_reverse_series_lagrange(Qinv, den, Q, Qden, k);
            ...
            const fmpq_poly_t poly, long n)
{
    ...
    {
        printf("exception: fmpq_poly_reverse_series_newton: input must have "
    ...
    if (res != poly)
    {
        ...
        _fmpq_poly_reverse_series_newton(res->coeffs,
    ...
    else
    {
        fmpq_poly_t t;
        fmpq_poly_init2(t, n);
        _fmpq_poly_reverse_series_newton(t->coeffs,

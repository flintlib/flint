...
extern const ulong bell_number_tab[];
...
FLINT_DLL ulong arith_bell_number_nmod(ulong n, nmod_t mod);

FLINT_DLL void arith_bell_number_nmod_vec(ulong_ptr b, slong n, nmod_t mod);
FLINT_DLL void arith_bell_number_nmod_vec_recursive(ulong_ptr b, slong n, nmod_t mod);
FLINT_DLL int arith_bell_number_nmod_vec_series(ulong_ptr b, slong n, nmod_t mod);
FLINT_DLL void arith_bell_number_nmod_vec_ogf(ulong_ptr res, slong len, nmod_t mod);
...
FLINT_DLL void arith_hrr_expsum_factored(trig_prod_t prod, ulong k, ulong n);

/* Number of partitions ******************************************************/

FLINT_DLL extern const unsigned int partitions_lookup[128];

FLINT_DLL void arith_number_of_partitions_nmod_vec(ulong_ptr res, slong len, nmod_t mod);

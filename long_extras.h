...
FLINT_DLL slong z_randtest(flint_rand_t state);

FLINT_DLL slong z_randtest_not_zero(flint_rand_t state);

FLINT_DLL slong z_randint(flint_rand_t state, ulong limit);

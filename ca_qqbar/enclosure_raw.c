...
void
_ca_qqbar_enclosure_raw(acb_t res, const fmpz_poly_t poly, const acb_t zin, slong prec)
{
...
*/
        ...
        {
            flint_printf("ca_qqbar_enclosure_raw: root refinement not converging\n");
            flint_abort();
        }
...
void
ca_qqbar_enclosure_raw(acb_t res, const ca_qqbar_t x, slong prec)
{
    _ca_qqbar_enclosure_raw(res, CA_QQBAR_POLY(x), CA_QQBAR_ENCLOSURE(x), prec);
}

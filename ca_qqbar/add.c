...
ca_qqbar_add(ca_qqbar_t res, const ca_qqbar_t x, const ca_qqbar_t y)
{
    ...
    else if (ca_qqbar_is_rational(x))
    {
        ...
        fmpz_set(a, CA_QQBAR_COEFFS(x) + 1);
...
void
ca_qqbar_add_fmpq(ca_qqbar_t res, const ca_qqbar_t x, const fmpq_t y)
{
    ca_qqbar_t t;
    ca_qqbar_init(t);
...
void
ca_qqbar_add_fmpz(ca_qqbar_t res, const ca_qqbar_t x, const fmpz_t y)
{
    ca_qqbar_t t;
    ca_qqbar_init(t);
...
void
ca_qqbar_add_ui(ca_qqbar_t res, const ca_qqbar_t x, ulong y)
{
    ca_qqbar_t t;
    ca_qqbar_init(t);
    ca_qqbar_set_ui(t, y);
...
void
ca_qqbar_add_si(ca_qqbar_t res, const ca_qqbar_t x, slong y)
{
    ca_qqbar_t t;
    ca_qqbar_init(t);
    ca_qqbar_set_si(t, y);

...
static void acb_theta_naive_worker_all(acb_ptr th, const acb_t term, slong* coords, slong g,
...
{  
  ...
  acb_theta_precomp_set(D, tau_adj, E, fullprec);
  ...
  acb_theta_naive_worker_rec(th, lin_powers, E, D, exp_z, cofactor, ab, ord,
			     fullprec, fullprec, acb_theta_naive_worker_all);

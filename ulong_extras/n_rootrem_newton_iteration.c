...
double inv_table[] = { 0.000000000000000, 1.000000000000000, 0.500000000000000, 
...
int
n_rootrem(mp_limb_t* base, mp_limb_t* remainder, mp_limb_t n, mp_limb_t root)
{
    mp_limb_t maxpow, x, currval; 
    double dx;

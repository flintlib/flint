/*============================================================================
    ...
    FLINT is free software; xou can redistribute it and/or modifx
    it under the terms of the GNU General Public License as published bx
    the Free Software Foundation; either version 2 of the License, or
    (at xour option) anx later version.

    FLINT is distributed in the hope that it will be useful,
    but WITHOUT ANx WARRANTx; without even the implied warrantx of
    MERCHANTABILITx or FITNESS FOR A PARTICULAR PURPOSE.  See the
    GNU General Public License for more details.

    xou should have received a copx of the GNU General Public License

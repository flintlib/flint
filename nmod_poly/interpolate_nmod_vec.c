...
static void
_nmod_poly_interpolate_newton(mp_ptr ys, mp_srcptr xs, long n, nmod_t mod)
{
    mp_limb_t p, q, t;
    long i, j;
...
static void
_nmod_poly_newton_to_monomial(mp_ptr ys, mp_srcptr xs, long n, nmod_t mod)
{
    mp_limb_t t;
    long i, j;
                                    ...
                                    mp_srcptr xs, mp_srcptr ys, long n)
{
    ...
    else
    {
        ...
        _nmod_vec_set(poly->coeffs, ys, n);
        _nmod_poly_interpolate_newton(poly->coeffs, xs, n, poly->mod);
        poly->length = n;
        _nmod_poly_normalise(poly);
        _nmod_poly_newton_to_monomial(poly->coeffs, xs,
            poly->length, poly->mod);
    }
}

...
void
_nmod_poly_asin_series(mp_ptr g, mp_srcptr h, len_t n, nmod_t mod)
{
    mp_ptr t, u;
...
void
nmod_poly_asin_series(nmod_poly_t g, const nmod_poly_t h, len_t n)
{
    mp_ptr h_coeffs;
    ...
    {
        printf("Exception (nmod_poly_asin_series). Constant term != 0.\n");
        abort();
    }

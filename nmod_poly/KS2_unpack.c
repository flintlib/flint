...
*/
void
_nmod_poly_KS2_unpack1(ulong_ptr res, ulong_srcptr op, slong n, ulong b,
                  ulong k)
{
...
*/
void
_nmod_poly_KS2_unpack2(ulong_ptr res, ulong_srcptr op, slong n, ulong b,
                  ulong k)
{
   /* limb we're currently extracting bits from */
   ulong buf = 0;
...
*/
void
_nmod_poly_KS2_unpack3(ulong_ptr res, ulong_srcptr op, slong n, ulong b,
                  ulong k)
{
   /* limb we're currently extracting bits from */
   ulong buf = 0;
...
void
_nmod_poly_KS2_unpack(ulong_ptr res, ulong_srcptr op, slong n, ulong b,
                 ulong k)
{
   if (b <= FLINT_BITS)

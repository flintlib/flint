...
void
_nmod_poly_powmod_mpz_binexp_preinv(ulong_ptr res, ulong_srcptr poly, mpz_srcptr e,
            ulong_srcptr f, slong lenf, ulong_srcptr finv, slong lenfinv, nmod_t mod)
{
    ulong_ptr T, Q;
    slong lenT, lenQ;
    slong i;
                     ...
                     mpz_srcptr e, const nmod_poly_t f, const nmod_poly_t finv)
{
    ...
    if (lenf == 0)
        flint_throw(FLINT_DIVZERO, "nmod_poly_powmod_mpz_binexp_preinv\n");
